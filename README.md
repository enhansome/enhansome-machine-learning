...
* For a list of free machine learning books available for download, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/books.md) ⭐ 74,313 | 🐛 29 | 🌐 Python | 📅 2026-09-12.

* For a list of professional machine learning events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/events.md) ⭐ 74,313 | 🐛 29 | 🌐 Python | 📅 2026-09-12.

* For a list of (mostly) free machine learning courses available online, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/courses.md) ⭐ 74,313 | 🐛 29 | 🌐 Python | 📅 2026-09-12.

* For a list of blogs and newsletters on data science and machine learning, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/blogs.md) ⭐ 74,313 | 🐛 29 | 🌐 Python | 📅 2026-09-12.

* For a list of free-to-attend meetups and local events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/meetups.md) ⭐ 74,313 | 🐛 29 | 🌐 Python | 📅 2026-09-12.
...
* [Darknet](https://github.com/pjreddie/darknet) ⭐ 26,497 | 🐛 1,978 | 🌐 C | 📅 2024-05-03 - Darknet is an open source neural network framework written in C and CUDA. It is fast, easy to install, and supports CPU and GPU computation.
* [libonnx](https://github.com/xboot/libonnx) ⭐ 652 | 🐛 16 | 🌐 C | 📅 2026-07-07 - A lightweight, portable pure C99 onnx inference engine for embedded devices with hardware acceleration support.
...
* [qwen3.8-27b-in-c](https://github.com/shyringo/qwen3.8-27b-in-c) ⭐ 13 | 🐛 0 | 🌐 C | 📅 2026-09-09 - A native C inference engine for running Qwen3.8-27B locally on a single laptop CPU, with direct GGUF loading and a tested 8 GB memory path.
...
* [YOLOv8](https://github.com/ultralytics/ultralytics) ⭐ 61,536 | 🐛 74 | 🌐 Python | 📅 2026-09-12 - Ultralytics' YOLOv8 implementation with C++ support for real-time object detection and tracking, optimized for edge devices.
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,240 | 🐛 80 | 🌐 C++ | 📅 2026-09-12 - C-based/Cached/Core Computer Vision Library, A Modern Computer Vision Library.
...
* [VoxRT](https://github.com/VoxRT/voxrt-asr-linux) ⭐ 9 | 🐛 0 | 🌐 C | 📅 2026-07-17 - On-device streaming speech recognition runtime with C API for Linux (aarch64/x86\_64). Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Companion Silero VAD, wake-word, and 14-command KWS via same runtime.
...
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,440 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
* [CosmoEdge](https://github.com/cosmo-wander-ai/cosmo-edge) ⭐ 889 | 🐛 10 | 🌐 C | 📅 2026-09-11 - A C++ edge video AI engine for RTSP ingestion, CV/VLM inference, visual pipeline orchestration, alarms, and event delivery on Sophon and Rockchip NPUs.
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,553 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind. \[DEEP LEARNING]
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,756 | 🐛 436 | 🌐 C++ | 📅 2026-09-11 - A parallelized optimized general purpose gradient boosting library.
* [Opik](https://www.comet.com/site/products/opik/) - Open source engineering platform to debug, evaluate, and monitor your LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards. ([Source Code](https://github.com/comet-ml/opik/) ⭐ 21,966 | 🐛 249 | 🌐 Python | 📅 2026-09-12)
...
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,761 | 🐛 512 | 🌐 C++ | 📅 2026-09-12 - Microsoft's fast, distributed, high performance gradient boosting (GBDT, GBRT, GBM or MART) framework based on decision tree algorithms, used for ranking, classification and many other machine learning tasks.
...
* [PyCaret](https://github.com/pycaret/pycaret) ⭐ 9,837 | 🐛 33 | 🌐 Python | 📅 2026-07-23 - An open-source, low-code machine learning library in Python that automates machine learning workflows.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,099 | 🐛 723 | 🌐 C++ | 📅 2026-09-12 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, contains fast inference implementation and supports CPU and GPU (even multi-GPU) computation.
* [Vowpal Wabbit (VW)](https://github.com/VowpalWabbit/vowpal_wabbit) ⭐ 8,718 | 🐛 3 | 🌐 C++ | 📅 2026-09-12 - A fast out-of-core learning system.
...
* [Featuretools](https://github.com/featuretools/featuretools) ⭐ 7,674 | 🐛 171 | 🌐 Python | 📅 2026-09-11 - A library for automated feature engineering. It excels at transforming transactional and relational datasets into feature matrices for machine learning using reusable feature engineering "primitives".
* [Feast](https://github.com/gojek/feast) ⭐ 7,262 | 🐛 440 | 🌐 Python | 📅 2026-09-11 - A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.
...
* [oneDNN](https://github.com/oneapi-src/oneDNN) ⭐ 4,044 | 🐛 173 | 🌐 C++ | 📅 2026-09-12 - An open-source cross-platform performance library for deep learning applications.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,729 | 🐛 125 | 🌐 MDX | 📅 2026-09-12 - A platform for reproducible and scalable machine learning and deep learning.
...
* [DeepDetect](https://github.com/jolibrain/deepdetect) ⭐ 2,551 | 🐛 98 | 🌐 C++ | 📅 2026-08-28 - A machine learning API and server written in C++11. It makes state of the art machine learning easy to work with and integrate into existing applications.
* [nndeploy](https://github.com/nndeploy/nndeploy) ⭐ 1,877 | 🐛 23 | 🌐 C++ | 📅 2026-08-15 - An Easy-to-Use and High-Performance AI deployment framework.
...
* [Hopsworks](https://github.com/logicalclocks/hopsworks) ⭐ 1,305 | 🐛 16 | 🌐 Java | 📅 2025-02-10 - A data-intensive platform for AI with the industry's first open-source feature store. The Hopsworks Feature Store provides both a feature warehouse for training and batch based on Apache Hive and a feature serving database, based on MySQL Cluster, for online applications.
...
* [Intel® oneAPI Data Analytics Library](https://github.com/oneapi-src/oneDAL) ⭐ 651 | 🐛 95 | 🌐 C++ | 📅 2026-09-12 - A high performance software library developed by Intel and optimized for Intel's architectures. Library provides algorithmic building blocks for all stages of data analytics and allows to process data in batch, online and distributed modes.
* [Fido](https://github.com/FidoProject/Fido) ⭐ 463 | 🐛 15 | 🌐 C++ | 📅 2020-01-05 - A highly-modular C++ machine learning library for embedded electronics and robotics.
* [XAD](https://github.com/auto-differentiation/XAD) ⭐ 428 | 🐛 4 | 🌐 C++ | 📅 2026-09-08 - Comprehensive backpropagation tool for C++.
* [N2D2](https://github.com/CEA-LIST/N2D2) ⭐ 161 | 🐛 6 | 🌐 C | 📅 2024-07-03 - CEA-List's CAD framework for designing and simulating Deep Neural Network, and building full DNN-based applications on embedded platforms
...
* [MCGrad](https://github.com/facebookincubator/MCGrad/) ⭐ 47 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-09-07 - A production-ready library for multicalibration, fairness, and bias correction in machine learning models.
...
* [Ombre](https://github.com/pypl0/Ombre) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-05-01 - Open source AI infrastructure layer. Eight agents run automatically: security, caching, memory, hallucination detection, and tamper-proof audit trail. Runs locally.
  * [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 306 | 🐛 20 | 🌐 Fortran | 📅 2026-06-25 - A general-purpose library with C/C++ interface for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* [MiaIA](https://github.com/Agosillo/MiaIA) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-09-11 - An open-source C++20 neural-network engine and Unreal Engine 5 Studio for building, training, visualizing, inspecting, and debugging observable feed-forward networks.
* * [Agentic Context Engine](https://github.com/kayba-ai/agentic-context-engine) ⭐ 2,571 | 🐛 8 | 🌐 Python | 📅 2026-09-11 -In-context learning framework that allows agents to learn from execution feedback.
...
* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,072 | 🐛 6 | 🌐 C++ | 📅 2026-09-12 - A C++ library for unsupervised text tokenization and detokenization, widely used in modern NLP models.
* [MIT Information Extraction Toolkit](https://github.com/mit-nlp/MITIE) ⭐ 2,960 | 🐛 19 | 🌐 C++ | 📅 2025-09-28 - C, C++, and Python tools for named entity recognition and relation extraction
* [MeTA](https://github.com/meta-toolkit/meta) ⭐ 717 | 🐛 56 | 🌐 C++ | 📅 2023-04-17 - [MeTA : ModErn Text Analysis](https://meta-toolkit.org/) is a C++ Data Sciences Toolkit that facilitates mining big text data.
...
* [colibri-core](https://github.com/proycon/colibri-core) ⭐ 133 | 🐛 9 | 🌐 C++ | 📅 2026-02-05 - C++ library, command line tools, and Python binding for extracting and working with basic linguistic constructions such as n-grams and skipgrams in a quick and memory-efficient way.
...
* [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,481 | 🐛 262 | 🌐 Shell | 📅 2025-09-22 - Kaldi is a toolkit for speech recognition written in C++ and licensed under the Apache License v2.0. Kaldi is intended for use by speech recognition researchers.
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,126 | 🐛 604 | 🌐 Jupyter Notebook | 📅 2026-08-09 - An offline speech recognition toolkit with C++ support, designed for low-resource devices and multiple languages.
...
* [grt](https://github.com/nickgillian/grt) ⭐ 894 | 🐛 87 | 🌐 C++ | 📅 2019-11-01 - The Gesture Recognition Toolkit (GRT) is a cross-platform, open-source, C++ machine learning library designed for real-time gesture recognition.

<a name="cpp-reinforcement-learning"></a>

#### Reinforcement Learning

* [RLtools](https://github.com/rl-tools/rl-tools) ⭐ 1,034 | 🐛 20 | 🌐 C++ | 📅 2026-09-10 - The fastest deep reinforcement learning library for continuous control, implemented header-only in pure, dependency-free C++ (Python bindings available as well).
...
* [mgl](https://github.com/melisgl/mgl/) ⭐ 650 | 🐛 6 | 🌐 Common Lisp | 📅 2026-06-27 - Neural networks (boltzmann machines, feed-forward and recurrent nets), Gaussian Processes.
* [mgl-gpr](https://github.com/melisgl/mgl-gpr/) ⭐ 65 | 🐛 0 | 🌐 Common Lisp | 📅 2026-07-27 - Evolutionary algorithms. **\[Deprecated]**
* [cl-random-forest](https://github.com/masatoi/cl-random-forest) ⭐ 62 | 🐛 9 | 🌐 Common Lisp | 📅 2026-08-07 - Implementation of Random Forest in Common Lisp.
* [cl-online-learning](https://github.com/masatoi/cl-online-learning) ⭐ 49 | 🐛 0 | 🌐 Common Lisp | 📅 2026-08-06 - Online learning algorithms (Perceptron, AROW, SCW, Logistic Regression).
...
* [Clojush](https://github.com/lspector/Clojush) ⭐ 340 | 🐛 53 | 🌐 Clojure | 📅 2023-05-06 - The Push programming language and the PushGP genetic programming system implemented in Clojure.
* [scicloj.ml](https://github.com/scicloj/scicloj.ml) ⚠️ Archived -  A idiomatic Clojure machine learning library based on tech.ml.dataset with a unique approach for immutable data processing pipelines.
* [clortex](https://github.com/htm-community/clortex) ⭐ 182 | 🐛 11 | 🌐 Clojure | 📅 2015-12-02 - General Machine Learning library using Numenta’s Cortical Learning Algorithm. **\[Deprecated]**
* [Infer](https://github.com/aria42/infer) ⭐ 177 | 🐛 2 | 🌐 Clojure | 📅 2015-12-29 - Inference and machine learning in Clojure. **\[Deprecated]**
* [comportex](https://github.com/htm-community/comportex) ⭐ 153 | 🐛 6 | 🌐 Clojure | 📅 2016-09-23 - Functionally composable Machine Learning library using Numenta’s Cortical Learning Algorithm. **\[Deprecated]**
* [Touchstone](https://github.com/ptaoussanis/touchstone) ⭐ 139 | 🐛 1 | 🌐 Clojure | 📅 2024-03-19 - Clojure A/B testing library.
* [Encog](https://github.com/jimpil/enclog) ⭐ 136 | 🐛 0 | 🌐 Clojure | 📅 2016-05-04 - Clojure wrapper for Encog (v3) (Machine-Learning framework that specializes in neural-nets). **\[Deprecated]**
* [clj-ml](https://github.com/joshuaeckroth/clj-ml/) ⭐ 134 | 🐛 3 | 🌐 Clojure | 📅 2021-12-05 - A machine learning library for Clojure built on top of Weka and friends.
* [Fungp](https://github.com/vollmerm/fungp) ⭐ 100 | 🐛 0 | 🌐 Clojure | 📅 2014-05-19 - A genetic programming library for Clojure. **\[Deprecated]**
* [lambda-ml](https://github.com/cloudkj/lambda-ml) ⭐ 78 | 🐛 0 | 🌐 Clojure | 📅 2018-11-03 - Simple, concise implementations of machine learning techniques and utilities in Clojure.
...
* [cortex](https://github.com/originrose/cortex) ⭐ 1,271 | 🐛 29 | 🌐 Clojure | 📅 2018-09-10 - Neural networks, regression and feature learning in Clojure.
* [Deep Diamond](https://github.com/uncomplicate/deep-diamond) ⭐ 467 | 🐛 2 | 🌐 Clojure | 📅 2026-08-19 - A fast Clojure Tensor & Deep Learning library
* [Flare](https://github.com/aria42/flare) ⭐ 287 | 🐛 1 | 🌐 Clojure | 📅 2019-06-28 - Dynamic Tensor Graph library in Clojure (think PyTorch, DynNet, etc.)
* [jutsu.ai](https://github.com/hswick/jutsu.ai) ⭐ 101 | 🐛 3 | 🌐 Clojure | 📅 2018-06-08 - Clojure wrapper for deeplearning4j with some added syntactic sugar.
* [dl4clj](https://github.com/yetanalytics/dl4clj) ⭐ 99 | 🐛 1 | 🌐 Clojure | 📅 2018-07-17 - Clojure wrapper for Deeplearning4j.
...
* [tech.ml.dataset](https://github.com/techascent/tech.ml.dataset) ⭐ 760 | 🐛 30 | 🌐 Clojure | 📅 2026-09-04 - Clojure dataframe library and pipeline for data processing and machine learning
* [PigPen](https://github.com/Netflix/PigPen) ⭐ 564 | 🐛 19 | 🌐 Clojure | 📅 2023-04-10 - Map-Reduce for Clojure.
* [Tablecloth](https://github.com/scicloj/tablecloth) ⭐ 368 | 🐛 49 | 🌐 Clojure | 📅 2026-08-05 - A dataframe grammar wrapping tech.ml.dataset, inspired by several R libraries
* [Geni](https://github.com/zero-one-group/geni) ⭐ 294 | 🐛 18 | 🌐 Clojure | 📅 2023-11-28 - a Clojure dataframe library that runs on Apache Spark
...
* [clojupyter](https://github.com/clojupyter/clojupyter) ⭐ 867 | 🐛 13 | 🌐 Clojure | 📅 2025-03-18 -  A Jupyter kernel for Clojure - run Clojure code in Jupyter Lab, Notebook and Console.
* [Oz](https://github.com/metasoarous/oz) ⭐ 834 | 🐛 66 | 🌐 Clojure | 📅 2024-04-02 - Data visualisation using Vega/Vega-Lite and Hiccup, and a live-reload platform for literate-programming
* [Hanami](https://github.com/jsa-aerial/hanami) ⭐ 410 | 🐛 8 | 🌐 Clojure | 📅 2025-07-02 - Clojure(Script) library and framework for creating interactive visualization applications based in Vega-Lite (VGL) and/or Vega (VG) specifications. Automatic framing and layouts along with a powerful templating system for abstracting visualization specs
...
* [notespace](https://github.com/scicloj/notespace) ⭐ 148 | 🐛 21 | 🌐 Clojure | 📅 2024-01-03 - Notebook experience in your Clojure namespace
* [Saite](https://github.com/jsa-aerial/saite) ⭐ 140 | 🐛 2 | 🌐 Clojure | 📅 2025-07-02 -  Clojure(Script) client/server application for dynamic interactive explorations and the creation of live shareable documents capturing them using Vega/Vega-Lite, CodeMirror, markdown, and LaTeX
* [Pink Gorilla Notebook](https://github.com/pink-gorilla/gorilla-notebook) ⭐ 107 | 🐛 5 | 🌐 Clojure | 📅 2021-06-27 - A Clojure/Clojurescript notebook application/-library based on Gorilla-REPL
...
* [Libpython-clj](https://github.com/clj-python/libpython-clj) ⭐ 1,208 | 🐛 37 | 🌐 Clojure | 📅 2026-08-10 - Interop with Python
...
* [kixistats](https://github.com/MastodonC/kixi.stats) ⭐ 369 | 🐛 0 | 🌐 Clojure | 📅 2026-06-19 - A library of statistical distribution sampling and transducing functions
* [fastmath](https://github.com/generateme/fastmath) ⭐ 287 | 🐛 34 | 🌐 Clojure | 📅 2026-09-11 - A collection of functions for mathematical and statistical computing, macine learning, etc., wrapping several JVM libraries
...
* [crystal-fann](https://github.com/NeuraLegion/crystal-fann) ⭐ 88 | 🐛 4 | 🌐 Crystal | 📅 2026-01-15 - FANN (Fast Artificial Neural Network) binding.
...
* [Knowledge3D (K3D)](https://github.com/danielcamposramos/Knowledge3D) ⭐ 38 | 🐛 3 | 🌐 Python | 📅 2026-05-17 - Sovereign GPU-native spatial AI architecture with PTX-first cognitive engine (RPN/TRM reasoning), tri-modal fusion (text/visual/audio), and 3D persistent memory ("Houses"). Features sub-100µs inference, procedural knowledge compression (69:1 ratio), and multi-agent swarm architecture. Zero external dependencies for core inference paths.
...
* [Simple Bayes](https://github.com/fredwu/simple_bayes) ⭐ 395 | 🐛 1 | 🌐 Elixir | 📅 2017-09-25 - A Simple Bayes / Naive Bayes implementation in Elixir.
* [Tensorflex](https://github.com/anshuman23/tensorflex) ⭐ 307 | 🐛 5 | 🌐 C | 📅 2019-07-02 - Tensorflow bindings for the Elixir programming language.
...
* [Stemmer](https://github.com/fredwu/stemmer) ⭐ 153 | 🐛 0 | 🌐 Elixir | 📅 2024-01-14 - An English (Porter2) stemming implementation in Elixir.
...
* [neural-fortran](https://github.com/modern-fortran/neural-fortran) ⭐ 474 | 🐛 47 | 🌐 Fortran | 📅 2026-03-04 - A parallel neural net microframework.
...
* [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 306 | 🐛 20 | 🌐 Fortran | 📅 2026-06-25 - A general-purpose Fortran library for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* [word-embedding](https://github.com/ynqa/word-embedding) ⭐ 507 | 🐛 5 | 🌐 Go | 📅 2023-04-02 - Word Embeddings: the full implementation of word2vec, GloVe in Go.
* [sentences](https://github.com/neurosnap/sentences) ⭐ 474 | 🐛 5 | 🌐 Go | 📅 2024-02-28 - Golang implementation of Punkt sentence tokenizer.
* [Cybertron](https://github.com/nlpodyssey/cybertron) ⭐ 330 | 🐛 25 | 🌐 Go | 📅 2024-06-08 - Cybertron: the home planet of the Transformers in Go.
* [go-porterstemmer](https://github.com/reiver/go-porterstemmer) ⭐ 193 | 🐛 6 | 🌐 Go | 📅 2021-06-23 - A native Go clean room implementation of the Porter Stemming algorithm. **\[Deprecated]**
...
* [golearn](https://github.com/sjwhitworth/golearn) ⭐ 9,437 | 🐛 89 | 🌐 Go | 📅 2024-01-15 - Machine learning for Go.
...
* [leaves](https://github.com/dmitryikh/leaves) ⭐ 485 | 🐛 37 | 🌐 Go | 📅 2024-07-03 - A pure Go implementation of the prediction part of GBRTs, including XGBoost and LightGBM.
* [goro](https://github.com/aunum/goro) ⭐ 373 | 🐛 1 | 🌐 Go | 📅 2024-03-04 - A high-level machine learning library in the vein of Keras.
...
* [go-galib](https://github.com/thoj/go-galib) ⭐ 202 | 🐛 0 | 🌐 Go | 📅 2015-12-28 - Genetic Algorithms library written in Go / Golang. **\[Deprecated]**
...
* [go-ml-benchmarks](https://github.com/nikolaydubina/go-ml-benchmarks) ⚠️ Archived — benchmarks of machine learning inference for Go.
* [anneal](https://github.com/georgebuilds/anneal) ⭐ 33 | 🐛 0 | 🌐 Go | 📅 2026-06-26 - From-scratch Go port of tinygrad: a graph-rewrite ML compiler with reverse-mode autodiff and a WebGPU backend.
...
* [gogeo](https://github.com/golang/geo) ⭐ 1,853 | 🐛 37 | 🌐 Go | 📅 2026-08-31 - Spherical geometry in Go.
* [go-geom](https://github.com/twpayne/go-geom) ⭐ 973 | 🐛 9 | 🌐 Go | 📅 2026-08-19 - Go library to handle geometries.
...
* [SVGo](https://github.com/ajstarks/svgo) ⭐ 2,250 | 🐛 16 | 🌐 Go | 📅 2022-12-09 - The Go Language library for SVG generation.
* [globe](https://github.com/mmcloughlin/globe) ⭐ 1,594 | 🐛 6 | 🌐 Go | 📅 2024-02-09 - Globe wireframe visualization.
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) ⭐ 1,292 | 🐛 18 | 🌐 Go | 📅 2022-04-02 - Dataframes for machine-learning and statistics (similar to pandas).
* [glot](https://github.com/arafatk/glot) ⭐ 404 | 🐛 16 | 🌐 Go | 📅 2025-05-20 - Glot is a plotting library for Golang built on top of gnuplot.
...
* [GoCV](https://github.com/hybridgroup/gocv) ⭐ 7,496 | 🐛 356 | 🌐 Go | 📅 2026-05-28 - Package for computer vision using OpenCV 4 and beyond.

<a name="go-speech-recognition"></a>

#### Speech Recognition

* [VoxRT](https://github.com/VoxRT/voxrt-asr-linux) ⭐ 9 | 🐛 0 | 🌐 C | 📅 2026-07-17 - On-device streaming speech recognition runtime with Go bindings. Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Ships alongside C/C++, PyPI, and npm packages for Linux (aarch64/x86\_64).

<a name="go-reinforcement-learning"></a>

#### Reinforcement learning

* [stable-baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 13,787 | 🐛 89 | 🌐 Python | 📅 2026-09-09 - PyTorch implementations of Stable Baselines (deep) reinforcement learning algorithms.
...
* [HLearn](https://github.com/mikeizbicki/HLearn) ⭐ 1,650 | 🐛 23 | 🌐 Haskell | 📅 2016-05-29 - a suite of libraries for interpreting machine learning models according to their algebraic structure. **\[Deprecated]**
* [DNNGraph](https://github.com/ajtulloch/dnngraph) ⭐ 710 | 🐛 9 | 🌐 Haskell | 📅 2015-12-07 - A DSL for deep neural networks. **\[Deprecated]**
...
* [haskell-ml](https://github.com/ajtulloch/haskell-ml) ⭐ 59 | 🐛 0 | 🌐 Haskell | 📅 2014-05-29 - Haskell implementations of various ML algorithms. **\[Deprecated]**
...
* [Twitter Text Java](https://github.com/twitter/twitter-text/tree/master/java) ⭐ 3,136 | 🐛 93 | 🌐 HTML | 📅 2024-04-26 - A Java implementation of Twitter's text processing library.
...
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,504 | 🐛 2,881 | 🌐 Jupyter Notebook | 📅 2026-09-08 - ML engine that supports distributed learning on Hadoop, Spark or your laptop via APIs in R, Python, Scala, REST/JSON.
...
* [Mahout](https://github.com/apache/mahout) ⭐ 2,308 | 🐛 82 | 🌐 Rust | 📅 2026-09-10 - Distributed machine learning.
...
* [SystemML](https://github.com/apache/systemml) ⭐ 1,097 | 🐛 90 | 🌐 Java | 📅 2026-09-11 - flexible, scalable machine learning (ML) language.
...
* [rapaio](https://github.com/padreati/rapaio) ⭐ 79 | 🐛 7 | 🌐 Java | 📅 2026-03-16 - statistics, data mining and machine learning toolbox in Java.
* [Chips-n-Salsa](https://github.com/cicirello/Chips-n-Salsa) ⭐ 78 | 🐛 2 | 🌐 Java | 📅 2026-09-11 - A Java library for genetic algorithms, evolutionary computation, and stochastic local search, with a focus on self-adaptation / self-tuning, as well as parallel execution.
* [jSciPy](https://github.com/hissain/jscipy) ⭐ 23 | 🐛 0 | 🌐 Java | 📅 2026-06-21 - A Java port of SciPy's signal processing module, offering filters, transformations, and other scientific computing utilities.
...
* [Spark](https://github.com/apache/spark) ⭐ 43,983 | 🐛 551 | 🌐 Scala | 📅 2026-09-12 - Spark is a fast and general engine for large-scale data processing.
* [Hadoop](https://github.com/apache/hadoop) ⭐ 15,656 | 🐛 225 | 🌐 Java | 📅 2026-09-12 - Hadoop/HDFS.
...
* [Deeplearning4j](https://github.com/deeplearning4j/deeplearning4j) ⭐ 14,255 | 🐛 59 | 🌐 Java | 📅 2026-09-12 - Scalable deep learning for industry with parallel GPUs.
* [deepjavalibrary/djl](https://github.com/deepjavalibrary/djl) ⭐ 4,854 | 🐛 226 | 🌐 Java | 📅 2026-09-10 - Deep Java Library (DJL) is an open-source, high-level, engine-agnostic Java framework for deep learning, designed to be easy to get started with and simple to use for Java developers.
...
* [NLP Compromise](https://github.com/spencermountain/compromise) ⭐ 12,156 | 🐛 119 | 🌐 JavaScript | 📅 2026-09-11 - Natural Language processing in the browser.
* [natural](https://github.com/NaturalNode/natural) ⭐ 10,880 | 🐛 88 | 🌐 JavaScript | 📅 2026-02-22 - General natural language facilities for node.
* [nlp.js](https://github.com/axa-group/nlp.js) ⭐ 6,588 | 🐛 114 | 🌐 JavaScript | 📅 2025-01-09 - An NLP library built in node over Natural, with entity extraction, sentiment analysis, automatic language identify, and so more.
* [Knwl.js](https://github.com/loadfive/Knwl.js) ⭐ 5,250 | 🐛 13 | 🌐 JavaScript | 📅 2023-09-28 - A Natural Language Processor in JS.
* [Twitter-text](https://github.com/twitter/twitter-text) ⭐ 3,136 | 🐛 93 | 🌐 HTML | 📅 2024-04-26 - A JavaScript implementation of Twitter's text processing library.
...
* [Glyph](https://github.com/Koda-OSS/Glyph) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-12 - Framework-agnostic TypeScript library for generating, searching, and comparing MinHash fingerprints for fast text similarity, deduplication, and retrieval.

<a name="javascript-data-analysis--data-visualization"></a>

#### Data Analysis / Data Visualization

* [science.js](https://github.com/jasondavies/science.js/) ⭐ 896 | 🐛 13 | 🌐 JavaScript | 📅 2026-03-06 - Scientific and statistical computing in JavaScript. **\[Deprecated]**
* [D3xter](https://github.com/NathanEpstein/D3xter) ⭐ 335 | 🐛 0 | 🌐 JavaScript | 📅 2020-10-13 - Straight forward plotting built on D3. **\[Deprecated]**
* [datakit](https://github.com/nathanepstein/datakit) ⭐ 286 | 🐛 0 | 🌐 JavaScript | 📅 2017-04-09 - A lightweight framework for data analysis in JavaScript
...
* [cheminfo](https://www.cheminfo.org/) - Platform for data visualization and analysis, using the [visualizer](https://github.com/npellet/visualizer) ⭐ 53 | 🐛 190 | 🌐 JavaScript | 📅 2026-06-26 project.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,475 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-12 - Visualizer for machine learning models.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Brain.js](https://github.com/BrainJS/brain.js) ⭐ 14,864 | 🐛 90 | 🌐 TypeScript | 📅 2024-09-26 - Neural networks in JavaScript - continued community fork of [Brain](https://github.com/harthur/brain) ⚠️ Archived.
...
* [ml5](https://github.com/ml5js/ml5-library) ⭐ 6,585 | 🐛 287 | 🌐 JavaScript | 📅 2024-10-11 - Friendly machine learning for the web!
...
* [ml.js](https://github.com/mljs/ml) ⭐ 2,719 | 🐛 27 | 🌐 JavaScript | 📅 2024-10-21 - Machine learning and numerical analysis tools for Node.js and the Browser!
* [WebDNN](https://github.com/mil-tokyo/webdnn) ⭐ 2,000 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10 - Fast Deep Neural Network JavaScript Framework. WebDNN uses next generation JavaScript API, WebGPU for GPU execution, and WebAssembly for CPU execution.
* [Auto ML](https://github.com/ClimbsRocks/auto_ml) ⭐ 1,652 | 🐛 187 | 🌐 Python | 📅 2021-02-10 - Automated machine learning, data formatting, ensembling, and hyperparameter optimization for competitions and exploration- just give it a .csv file! **\[Deprecated]**
...
* [Pavlov.js](https://github.com/NathanEpstein/Pavlov.js) ⭐ 496 | 🐛 0 | 🌐 C++ | 📅 2018-04-14 - Reinforcement learning using Markov Decision Processes.
* [DN2A](https://github.com/antoniodeluca/dn2a.js) ⭐ 462 | 🐛 6 | 🌐 TypeScript | 📅 2023-10-07 - Digital Neural Networks Architecture. **\[Deprecated]**
...
* [Catniff](https://github.com/nguyenphuminh/catniff) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-27 - Torch-like deep learning framework for Javascript with support for tensors, autograd, optimizers, and other neural net constructs.
...
* [VoxRT](https://github.com/VoxRT/voxrt-asr-linux) ⭐ 9 | 🐛 0 | 🌐 C | 📅 2026-07-17 - On-device streaming speech recognition runtime with npm bindings. Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Ships alongside C/C++, Python (PyPI), and Go packages for Linux (aarch64/x86\_64).

<a name="javascript-misc"></a>

#### Misc

* [stdlib](https://github.com/stdlib-js/stdlib) ⭐ 5,959 | 🐛 1,487 | 🌐 JavaScript | 📅 2026-09-12 - A standard library for JavaScript and Node.js, with an emphasis on numeric computing. The library provides a collection of robust, high performance libraries for mathematics, statistics, streams, utilities, and more.
* [simple-statistics](https://github.com/simple-statistics/simple-statistics) ⭐ 3,520 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-08 - A JavaScript implementation of descriptive, regression, and inference statistics. Implemented in literate JavaScript with no dependencies, designed to work in all modern browsers (including IE) as well as in Node.js.
* [Pipcook](https://github.com/alibaba/pipcook) ⭐ 2,596 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-12 - A JavaScript application framework for machine learning and its engineering.
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [MLJ](https://github.com/alan-turing-institute/MLJ.jl) ⭐ 1,939 | 🐛 82 | 🌐 Julia | 📅 2026-09-07 - A Julia machine learning framework.
* [Knet](https://github.com/denizyuret/Knet.jl) ⭐ 1,431 | 🐛 153 | 🌐 Jupyter Notebook | 📅 2024-11-15 - Koç University Deep Learning Framework.
* [Mocha](https://github.com/pluskid/Mocha.jl) ⭐ 1,284 | 🐛 36 | 🌐 Julia | 📅 2018-12-06 - Deep Learning framework for Julia inspired by Caffe. **\[Deprecated]**
* [GLM](https://github.com/JuliaStats/GLM.jl) ⭐ 637 | 🐛 82 | 🌐 Julia | 📅 2026-06-23 - Generalized linear models in Julia.
* [ScikitLearn](https://github.com/cstjean/ScikitLearn.jl) ⭐ 560 | 🐛 38 | 🌐 Julia | 📅 2025-05-28 - Julia implementation of the scikit-learn API.
* [Distances](https://github.com/JuliaStats/Distances.jl) ⭐ 472 | 🐛 42 | 🌐 Julia | 📅 2025-03-28 - Julia module for Distance evaluation.
...
* [MultivariateStats](https://github.com/JuliaStats/MultivariateStats.jl) ⭐ 388 | 🐛 53 | 🌐 Julia | 📅 2026-08-25 - Methods for dimensionality reduction.
* [Clustering](https://github.com/JuliaStats/Clustering.jl) ⭐ 376 | 🐛 47 | 🌐 Julia | 📅 2025-11-24 - Basic functions for clustering data: k-means, dp-means, etc.
...
* [XGBoost](https://github.com/dmlc/XGBoost.jl) ⭐ 307 | 🐛 33 | 🌐 Julia | 📅 2026-08-28 - eXtreme Gradient Boosting Package in Julia.
...
* [Kernel Density](https://github.com/JuliaStats/KernelDensity.jl) ⭐ 210 | 🐛 35 | 🌐 Julia | 📅 2026-06-22 - Kernel density estimators for Julia.
...
* [Text Analysis](https://github.com/JuliaText/TextAnalysis.jl) ⭐ 384 | 🐛 38 | 🌐 Julia | 📅 2026-04-08 - Julia package for text analysis.
...
* [Embeddings](https://github.com/JuliaText/Embeddings.jl) ⭐ 84 | 🐛 10 | 🌐 Julia | 📅 2024-03-08 - Functions and data dependencies for loading various word embeddings
* [Languages](https://github.com/JuliaText/Languages.jl) ⭐ 57 | 🐛 7 | 🌐 Julia | 📅 2025-10-25 - Julia package for working with various human languages
...
* [DataFrames](https://github.com/JuliaData/DataFrames.jl) ⭐ 1,831 | 🐛 161 | 🌐 Julia | 📅 2026-09-12 - library for working with tabular data in Julia.
* [Distributions](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,199 | 🐛 479 | 🌐 Julia | 📅 2026-09-11 - A Julia package for probability distributions and associated functions.
...
* [Time Series](https://github.com/JuliaStats/TimeSeries.jl) ⭐ 370 | 🐛 48 | 🌐 Julia | 📅 2026-03-30 - Time series toolkit for Julia.
* [Hypothesis Tests](https://github.com/JuliaStats/HypothesisTests.jl) ⭐ 318 | 🐛 90 | 🌐 Julia | 📅 2026-09-10 - Hypothesis tests for Julia.
* [RDataSets](https://github.com/johnmyleswhite/RDatasets.jl) ⭐ 167 | 🐛 18 | 🌐 R | 📅 2026-09-08 - Julia package for loading many of the data sets available in R.
* [Stats](https://github.com/JuliaStats/StatsKit.jl) ⭐ 144 | 🐛 3 | 🌐 Julia | 📅 2022-10-17 - Statistical tests for Julia.
* [Data Read](https://github.com/queryverse/ReadStat.jl) ⭐ 79 | 🐛 12 | 🌐 Julia | 📅 2026-09-01 - Read files from Stata, SAS, and SPSS.
...
* [Sampling](https://github.com/lindahua/Sampling.jl) ⭐ 2 | 🐛 1 | 🌐 Julia | 📅 2014-06-19 - Basic sampling algorithms for Julia.
...
* [DSP](https://github.com/JuliaDSP/DSP.jl) ⭐ 423 | 🐛 85 | 🌐 Julia | 📅 2026-08-25 - Digital Signal Processing (filtering, periodograms, spectrograms, window functions).
* [SignalProcessing](https://github.com/JuliaDSP/DSP.jl) ⭐ 423 | 🐛 85 | 🌐 Julia | 📅 2026-08-25 - Signal Processing tools for Julia.
* [DataDeps](https://github.com/oxinabox/DataDeps.jl) ⭐ 160 | 🐛 40 | 🌐 Julia | 📅 2026-07-30 - Reproducible data setup for reproducible science.
...
* [KotlinDL](https://github.com/JetBrains/KotlinDL) ⭐ 1,576 | 🐛 82 | 🌐 Kotlin | 📅 2024-05-31 - Deep learning framework written in Kotlin.

<a name="kotlin-speech-recognition"></a>

#### Speech Recognition

* [VoxRT](https://github.com/VoxRT/voxrt-asr-android) ⭐ 18 | 🐛 0 | 🌐 Kotlin | 📅 2026-07-02 - On-device streaming speech recognition SDK for Android with Kotlin bindings (JitPack). Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Companion Silero VAD, wake-word, and 14-command KWS via same runtime.
...
* [Torch7](http://torch.ch/)
  ...
  * [rnn](https://github.com/Element-Research/rnn) ⭐ 941 | 🐛 78 | 🌐 Lua | 📅 2017-12-21 - A Recurrent Neural Network library that extends Torch's nn. RNNs, LSTMs, GRUs, BRNNs, BLSTMs, etc.
  * [OverFeat](https://github.com/sermanet/OverFeat) ⭐ 602 | 🐛 34 | 🌐 C | 📅 2014-08-12 - A state-of-the-art generic dense feature extractor. **\[Deprecated]**
  ...
  * [cutorch](https://github.com/torch/cutorch) ⭐ 340 | 🐛 144 | 🌐 Cuda | 📅 2017-09-11 - Torch CUDA Implementation.
  ...
  * [nngraph](https://github.com/torch/nngraph) ⭐ 299 | 🐛 29 | 🌐 Lua | 📅 2017-08-01 - This package provides graphical computation for nn library in Torch7.
  * [cunn](https://github.com/torch/cunn) ⭐ 213 | 🐛 57 | 🌐 Cuda | 📅 2019-08-27 - Torch CUDA Neural Network Implementation.
  * [optim](https://github.com/torch/optim) ⭐ 197 | 🐛 31 | 🌐 Lua | 📅 2017-11-27 - An optimization library for Torch. SGD, Adagrad, Conjugate-Gradient, LBFGS, RProp and more.
  * [dpnn](https://github.com/Element-Research/dpnn) ⭐ 192 | 🐛 16 | 🌐 Lua | 📅 2017-05-26 - Many useful features that aren't part of the main nn package.
  * [manifold](https://github.com/clementfarabet/manifold) ⭐ 143 | 🐛 7 | 🌐 Lua | 📅 2017-07-03 - A package to manipulate manifolds.
  * [nnx](https://github.com/clementfarabet/lua---nnx) ⭐ 97 | 🐛 12 | 🌐 Lua | 📅 2017-05-30 - A completely unstable and experimental package that extends Torch's builtin nn library.
  ...
  * [signal](https://github.com/soumith/torch-signal) ⭐ 50 | 🐛 5 | 🌐 Lua | 📅 2017-07-02 - A signal processing toolbox for Torch-7. FFT, DCT, Hilbert, cepstrums, stft.
  ...
  * [randomkit](https://github.com/deepmind/torch-randomkit) ⭐ 35 | 🐛 9 | 🌐 Lua | 📅 2019-04-23 - Numpy's randomkit, wrapped for Torch. **\[Deprecated]**
  * [imgraph](https://github.com/clementfarabet/lua---imgraph) ⭐ 23 | 🐛 5 | 🌐 C | 📅 2017-10-27 - An image/graph library for Torch. This package provides routines to construct graphs on images, segment them, build trees out of them, and convert them back to images. **\[Deprecated]**
  * [videograph](https://github.com/clementfarabet/videograph) ⭐ 10 | 🐛 0 | 🌐 C | 📅 2013-07-04 - A video/graph library for Torch. This package provides routines to construct graphs on videos, segment them, build trees out of them, and convert them back to videos. **\[Deprecated]**
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,553 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [MXNet](https://github.com/apache/incubator-mxnet/) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Pattern Recognition and Machine Learning](https://github.com/PRML/PRMLT) ⭐ 6,202 | 🐛 1 | 🌐 MATLAB | 📅 2020-03-04 - This package contains the matlab implementation of the algorithms described in the book Pattern Recognition and Machine Learning by C. Bishop.
* [ThunderSVM](https://github.com/Xtra-Computing/thundersvm) ⭐ 1,622 | 🐛 87 | 🌐 C++ | 📅 2024-04-01 - An Open-Source SVM Library on GPUs and CPUs
* [Machine Learning in MatLab/Octave](https://github.com/trekhleb/machine-learning-octave) ⭐ 897 | 🐛 0 | 🌐 MATLAB | 📅 2025-11-23 - Examples of popular machine learning algorithms (neural networks, linear/logistic regressions, K-Means, etc.) with code examples and mathematics behind them being explained.
* [Machine Learning Module](https://github.com/josephmisiti/machine-learning-module) ⭐ 477 | 🐛 0 | 🌐 Objective-C | 📅 2011-04-28 - Class on machine w/ PDF, lectures, code
* [Pattern Recognition Toolbox](https://github.com/covartech/PRT) ⭐ 146 | 🐛 19 | 🌐 MATLAB | 📅 2025-10-28 - A complete object-oriented environment for machine learning in Matlab.
...
* [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 306 | 🐛 20 | 🌐 Fortran | 📅 2026-06-25 - A general-purpose MATLAB library for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* [Stanford.NLP for .NET](https://github.com/sergey-tihon/Stanford.NLP.NET/) ⭐ 608 | 🐛 1 | 🌐 C# | 📅 2024-03-22 - A full port of Stanford NLP packages to .NET and also available precompiled as a NuGet package.

<a name="net-general-purpose-machine-learning"></a>

#### General-Purpose Machine Learning

* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,358 | 🐛 753 | 🌐 C# | 📅 2026-09-11 - ML.NET is a cross-platform open-source machine learning framework which makes machine learning accessible to .NET developers. ML.NET was originally developed in Microsoft Research and evolved into a significant framework over the last decade and is used across many product groups in Microsoft like Windows, Bing, PowerPoint, Excel and more.
...
* [MLPNeuralNet](https://github.com/nikolaypavlov/MLPNeuralNet) ⭐ 898 | 🐛 1 | 🌐 Objective-C | 📅 2016-09-30 - Fast multilayer perceptron neural network library for iOS and Mac OS X. MLPNeuralNet predicts new examples by trained neural networks. It is built on top of the Apple's Accelerate Framework, using vectorized operations and hardware acceleration if available. **\[Deprecated]**
...
* [TensorFlow](https://github.com/LaurentMazare/tensorflow-ocaml) ⭐ 288 | 🐛 5 | 🌐 OCaml | 📅 2019-07-06 - OCaml bindings for TensorFlow.
* [Oml](https://github.com/rleonid/oml) ⭐ 120 | 🐛 24 | 🌐 OCaml | 📅 2018-02-01 - A general statistics and machine learning library.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,809 | 🐛 2,764 | 🌐 C++ | 📅 2026-09-11 - A OpenSource Computer Vision Library
...
* [Support Vector Machines](https://github.com/titsuki/p6-Algorithm-LibSVM) ⭐ 8 | 🐛 0 | 🌐 C++ | 📅 2026-08-30
...
* [jieba-php](https://github.com/fukuball/jieba-php) ⭐ 1,378 | 🐛 4 | 🌐 PHP | 📅 2025-12-16 - Chinese Words Segmentation Utilities.
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,736 | 🐛 832 | 🌐 Python | 📅 2026-06-25 - Face recognition library that recognizes and manipulates faces from Python or from the command line.
* [timm](https://github.com/rwightman/pytorch-image-models) ⭐ 37,138 | 🐛 59 | 🌐 Python | 📅 2026-09-12 - PyTorch image models, scripts, pretrained weights -- ResNet, ResNeXT, EfficientNet, EfficientNetV2, NFNet, Vision Transformer, MixNet, MobileNet-V3/V2, RegNet, DPN, CSPNet, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,706 | 🐛 591 | 🌐 Python | 📅 2026-08-19 - FAIR's next-generation research platform for object detection and segmentation. It is a ground-up rewrite of the previous version, Detectron, and is powered by the PyTorch deep learning framework.
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,440 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
* [MLX](https://github.com/ml-explore/mlx) ⭐ 28,397 | 🐛 124 | 🌐 C++ | 📅 2026-09-12- MLX is an array framework for machine learning on Apple silicon, developed by Apple machine learning research.
...
* [deepface](https://github.com/serengil/deepface) ⭐ 23,414 | 🐛 8 | 🌐 Python | 📅 2026-09-01 - A lightweight face recognition and facial attribute analysis (age, gender, emotion and race) framework for Python covering cutting-edge models such as VGG-Face, FaceNet, OpenFace, DeepFace, DeepID, Dlib and ArcFace.
...
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,735 | 🐛 82 | 🌐 Python | 📅 2026-09-11 - A PyTorch-based toolkit that offers pre-trained segmentation models for computer vision tasks. It simplifies the development of image segmentation applications by providing a collection of popular architecture implementations, such as UNet and PSPNet, along with pre-trained weights, making it easier for researchers and developers to achieve high-quality pixel-level object segmentation in images.
* [Exadel CompreFace](https://github.com/exadel-inc/CompreFace) ⭐ 8,313 | 🐛 234 | 🌐 Java | 📅 2024-10-05 - face recognition system that can be easily integrated into any system without prior machine learning skills. CompreFace provides REST API for face recognition, face verification, face detection, face mask detection, landmark detection, age, and gender recognition and is easily deployed with docker.
* [Scikit-Opt](https://github.com/guofei9987/scikit-opt) ⭐ 6,716 | 🐛 71 | 🌐 Python | 📅 2026-03-25 - Swarm Intelligence in Python (Genetic Algorithm, Particle Swarm Optimization, Simulated Annealing, Ant Colony Algorithm, Immune Algorithm, Artificial Fish Swarm Algorithm in Python)
* [Scikit-Image](https://github.com/scikit-image/scikit-image) ⭐ 6,585 | 🐛 951 | 🌐 Python | 📅 2026-09-09 - A collection of algorithms for image processing in Python.
* [pytessarct](https://github.com/madmaze/pytesseract) ⭐ 6,384 | 🐛 21 | 🌐 Python | 📅 2026-07-13 - Python-tesseract is an optical character recognition (OCR) tool for python. That is, it will recognize and "read" the text embedded in images. Python-tesseract is a wrapper for [Google's Tesseract-OCR Engine](https://github.com/tesseract-ocr/tesseract) ⭐ 76,466 | 🐛 484 | 🌐 C++ | 📅 2026-09-11.
...
* [imutils](https://github.com/jrosebr1/imutils) ⭐ 4,586 | 🐛 162 | 🌐 Python | 📅 2024-06-24 - A library containing Convenience functions to make basic image processing operations such as translation, rotation, resizing, skeletonization, and displaying Matplotlib images easier with OpenCV and Python.
* [Deep High-Resolution-Net](https://github.com/leoxiaobin/deep-high-resolution-net.pytorch) ⭐ 4,476 | 🐛 209 | 🌐 Cuda | 📅 2024-08-30 - A PyTorch implementation of CVPR2019 paper "Deep High-Resolution Representation Learning for Human Pose Estimation"
* [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,806 | 🐛 106 | 🌐 Python | 📅 2026-09-11 - Lightly is a computer vision framework for self-supervised learning.
* [computer-vision-in-action](https://github.com/Charmve/computer-vision-in-action) ⭐ 2,861 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-05-27 - as known as `L0CV`, is a new generation of computer vision open source online learning media, a cross-platform interactive learning framework integrating graphics, source code and HTML. the L0CV ecosystem — Notebook, Datasets, Source Code, and from Diving-in to Advanced — as well as the L0CV Hub.
* [retinaface](https://github.com/serengil/retinaface) ⭐ 2,035 | 🐛 1 | 🌐 Python | 📅 2026-06-01 - deep learning based cutting-edge facial detector for Python coming with facial landmarks
* [PCV](https://github.com/jesolem/PCV) ⭐ 1,960 | 🐛 26 | 🌐 Python | 📅 2020-12-28 - Open source Python module for computer vision. **\[Deprecated]**
* [LightlyTrain](https://github.com/lightly-ai/lightly-train) ⭐ 1,661 | 🐛 81 | 🌐 Python | 📅 2026-08-31 - Pretrain computer vision models on unlabeled data for industrial applications
...
* [neural-style-pt](https://github.com/ProGamerGov/neural-style-pt) ⭐ 855 | 🐛 25 | 🌐 Python | 📅 2022-10-15 - A PyTorch implementation of Justin Johnson's neural-style (neural style transfer).
...
* [Detecto](https://github.com/alankbi/detecto) ⭐ 625 | 🐛 48 | 🌐 Python | 📅 2024-07-25 - Train and run a computer vision model with 5-10 lines of code.
* [Vigranumpy](https://github.com/ukoethe/vigra) ⭐ 442 | 🐛 99 | 🌐 C++ | 📅 2026-04-25 - Python bindings for the VIGRA C++ computer vision library.
* [joliGEN](https://github.com/jolibrain/joliGEN) ⭐ 288 | 🐛 40 | 🌐 Python | 📅 2026-09-11 - Generative AI Image Toolset with GANs and Diffusion for Real-World Applications.
...
* [Learnergy](https://github.com/gugarosa/learnergy) ⭐ 74 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - Energy-based machine learning models built upon PyTorch.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 165,199 | 🐛 2,416 | 🌐 Python | 📅 2026-09-12 - A deep learning library containing thousands of pre-trained models on different tasks. The goto place for anything related to Large Language Models.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 35,151 | 🐛 700 | 🌐 Python | 📅 2024-08-21 - Chinese Words Segmentation Utilities.
* [spaCy](https://github.com/explosion/spaCy) ⭐ 33,894 | 🐛 240 | 🌐 Python | 📅 2026-08-24 - Industrial strength NLP with Python and Cython.
* [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,490 | 🐛 136 | 🌐 Python | 📅 2026-09-12 - A framework for building industrial-strength applications with Transformer models and LLMs.
* [CometLLM](https://github.com/comet-ml/comet-llm) ⭐ 21,966 | 🐛 249 | 🌐 Python | 📅 2026-09-12 - Track, log, visualize and evaluate your LLM prompts and prompt chains.
* [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,322 | 🐛 154 | 🌐 Python | 📅 2026-07-24 - A "machine learning framework to automate text-and voice-based conversations."
* [Fuzzy Wuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived - Fuzzy String Matching in Python.
* [Pattern](https://github.com/clips/pattern) ⭐ 8,862 | 🐛 179 | 🌐 Python | 📅 2026-08-05 - A web mining module for the Python programming language. It has tools for natural language processing, machine learning, among others.
* [DeepPavlov](https://github.com/deepmipt/DeepPavlov/) ⭐ 6,988 | 🐛 56 | 🌐 Python | 📅 2025-08-06 - conversational AI library with many pre-trained Russian NLP models.
* [pkuseg-python](https://github.com/lancopku/pkuseg-python) ⭐ 6,706 | 🐛 135 | 🌐 Python | 📅 2022-11-05 - A better version of Jieba, developed by Peking University.
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,632 | 🐛 44 | 🌐 Python | 📅 2020-01-19 - A library for processing Chinese text.
* [Dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,512 | 🐛 92 | 🌐 Python | 📅 2025-07-29 - A python library for accurate and scalable fuzzy matching, record deduplication and entity-resolution.
...
* [Polyglot](https://github.com/aboSamoor/polyglot) ⭐ 2,362 | 🐛 170 | 🌐 Python | 📅 2023-11-10 - Multilingual text (NLP) processing toolkit.
* [textacy](https://github.com/chartbeat-labs/textacy) ⭐ 2,240 | 🐛 35 | 🌐 Python | 📅 2023-09-22 - higher-level NLP built on Spacy.
* [jellyfish](https://github.com/jamesturk/jellyfish) ⭐ 2,232 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-07-24 - a python library for doing approximate and phonetic matching of strings.
* [NeuroNER](https://github.com/Franck-Dernoncourt/NeuroNER) ⭐ 1,724 | 🐛 91 | 🌐 Python | 📅 2023-03-24 - Named-entity recognition using neural networks providing state-of-the-art-results
...
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) ⭐ 1,107 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 - The simplest way to run an LLM locally. Supports tool calling and grammar constrained sampling.
* [CLTK](https://github.com/cltk/cltk) ⭐ 919 | 🐛 4 | 🌐 Python | 📅 2026-08-01 - The Classical Language Toolkit.
* [BigARTM](https://github.com/bigartm/bigartm) ⭐ 674 | 🐛 136 | 🌐 C++ | 📅 2026-02-05 - topic modelling platform.
* [stanford-corenlp-python](https://github.com/dasmith/stanford-corenlp-python) ⭐ 610 | 🐛 47 | 🌐 Python | 📅 2018-03-14 - Python wrapper for [Stanford CoreNLP](https://github.com/stanfordnlp/CoreNLP) ⭐ 10,115 | 🐛 182 | 🌐 Java | 📅 2026-09-11 **\[Deprecated]**
...
* [VeritasGraph](https://github.com/bibinprathap/VeritasGraph) ⭐ 321 | 🐛 2 | 🌐 Python | 📅 2026-09-12 - Enterprise-Grade Graph RAG for Secure, On-Premise AI with Verifiable Attribution.
...
* [colibri-core](https://github.com/proycon/colibri-core) ⭐ 133 | 🐛 9 | 🌐 C++ | 📅 2026-02-05 - Python binding to C++ library for extracting and working with basic linguistic constructions such as n-grams and skipgrams in a quick and memory-efficient way.
* [YAlign](https://github.com/machinalis/yalign) ⭐ 131 | 🐛 11 | 🌐 Python | 📅 2016-05-19 - A sentence aligner, a friendly tool for extracting parallel sentences from comparable corpora. **\[Deprecated]**
...
* [TensorFlow](https://github.com/tensorflow/tensorflow/) ⭐ 199,737 | 🐛 3,110 | 🌐 C++ | 📅 2026-09-12 - Open source software library for numerical computation using data flow graphs.
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,956 | 🐛 17,741 | 🌐 Python | 📅 2026-09-12 - Tensors and Dynamic neural networks in Python with strong GPU acceleration
* [keras](https://github.com/keras-team/keras) ⭐ 64,317 | 🐛 185 | 🌐 Python | 📅 2026-09-12 - High-level neural networks frontend for [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 199,737 | 🐛 3,110 | 🌐 C++ | 📅 2026-09-12, [CNTK](https://github.com/Microsoft/CNTK) ⚠️ Archived and [Theano](https://github.com/Theano/Theano) ⭐ 10,000 | 🐛 699 | 🌐 Python | 📅 2024-01-15.
* [Streamlit](https://github.com/streamlit/streamlit) ⭐ 45,736 | 🐛 1,163 | 🌐 Python | 📅 2026-09-12: Streamlit is an framework to create beautiful data apps in hours, not weeks.
* [Gradio](https://github.com/gradio-app/gradio) ⭐ 43,525 | 🐛 129 | 🌐 Python | 📅 2026-09-12 - A Python library for quickly creating and sharing demos of models. Debug models interactively in your browser, get feedback from collaborators, and generate public links without deploying anything.
* [Colossal-AI](https://github.com/hpcaitech/ColossalAI) ⭐ 41,438 | 🐛 504 | 🌐 Python | 📅 2026-08-31: An open-source deep learning system for large-scale model training and inference with high efficiency and low cost.
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,731 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11 - Open Source framework to streamline use of neural networks.
* [JAX](https://github.com/google/jax) ⭐ 36,297 | 🐛 2,549 | 🌐 Python | 📅 2026-09-12 - JAX is Autograd and XLA, brought together for high-performance machine learning research.
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,553 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch) ⭐ 32,842 | 🐛 78 | 🌐 Python | 📅 2023-10-15 - Implementations of Machine Learning models from scratch in Python with a focus on transparency. Aims to showcase the nuts and bolts of ML in an accessible way.
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,338 | 🐛 1,087 | 🌐 Python | 📅 2026-09-12 - The lightweight PyTorch wrapper for high-performance AI research.
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,756 | 🐛 436 | 🌐 C++ | 📅 2026-09-11 - Python bindings for eXtreme Gradient Boosting (Tree) Library.
* [Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,181 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 - Book/iPython notebooks on Probabilistic Programming in Python.
* [Fastai](https://github.com/fastai/fastai) ⭐ 28,133 | 🐛 269 | 🌐 Jupyter Notebook | 📅 2026-09-09 - High-level wrapper built on the top of Pytorch which supports vision, text, tabular data and collaborative filtering.
* [PyTorch Geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,075 | 🐛 1,332 | 🌐 Python | 📅 2026-09-01 -> Graph Neural Network Library for PyTorch.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,966 | 🐛 249 | 🌐 Python | 📅 2026-09-12: Evaluate, trace, test, and ship LLM applications across your dev and production lifecycles.
* [Microsoft Recommenders](https://github.com/Microsoft/Recommenders) ⭐ 21,884 | 🐛 181 | 🌐 Python | 📅 2026-09-05: Examples and best practices for building recommendation systems, provided as Jupyter notebooks. The repo contains some of the latest state of the art algorithms from Microsoft Research as well as from other companies and institutions.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Neural Networks and Deep Learning](https://github.com/mnielsen/neural-networks-and-deep-learning) ⭐ 17,928 | 🐛 7 | 🌐 Python | 📅 2024-06-02 - Code samples for my book "Neural Networks and Deep Learning" \[DEEP LEARNING].
...
* [gensim](https://github.com/RaRe-Technologies/gensim) ⭐ 16,482 | 🐛 440 | 🌐 Python | 📅 2025-11-01 - Topic Modelling for Humans.
...
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,784 | 🐛 22 | 🌐 Python | 📅 2026-09-11: Optuna is an automatic hyperparameter optimization software framework, particularly designed for machine learning.
* [Annoy](https://github.com/spotify/annoy) ⭐ 14,298 | 🐛 86 | 🌐 C++ | 📅 2025-10-29 - Approximate nearest neighbours implementation.
...
* [TPOT](https://github.com/EpistasisLab/tpot) ⭐ 10,051 | 🐛 312 | 🌐 Jupyter Notebook | 📅 2025-09-11 - Tool that automatically creates and optimizes machine learning pipelines using genetic programming. Consider it your personal data science assistant, automating a tedious part of machine learning.
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 10,031 | 🐛 12 | 🌐 Python | 📅 2026-09-11 - A Python library for secure and private Deep Learning built on PyTorch and TensorFlow.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 10,005 | 🐛 2,467 | 🌐 Python | 📅 2026-09-12 - A unified framework for machine learning with time series
* [PyOD](https://github.com/yzhao062/pyod) ⭐ 10,000 | 🐛 244 | 🌐 Python | 📅 2026-09-08 -> Python Outlier Detection, comprehensive and scalable Python toolkit for detecting outlying objects in multivariate data. Featured for Advanced models, including Neural Networks/Deep Learning and Outlier Ensembles.
* [Theano](https://github.com/Theano/Theano/) ⭐ 10,000 | 🐛 699 | 🌐 Python | 📅 2024-01-15 - Optimizing GPU-meta-programming code generating array oriented optimizing math compiler in Python.
* [einops](https://github.com/arogozhnikov/einops) ⭐ 9,594 | 🐛 40 | 🌐 Python | 📅 2026-08-26 - Deep learning operations reinvented (for pytorch, tensorflow, jax and others).
...
* [Hub](https://github.com/activeloopai/Hub) ⭐ 9,233 | 🐛 67 | 🌐 C++ | 📅 2026-05-21 - Fastest unstructured dataset management for TensorFlow/PyTorch. Stream & version-control data. Store even petabyte-scale data in a single numpy-like array on the cloud accessible on any machine. Visit [activeloop.ai](https://activeloop.ai) for more info.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,099 | 🐛 723 | 🌐 C++ | 📅 2026-09-12 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, well documented and supports CPU and GPU (even multi-GPU) computation.
* [pattern](https://github.com/clips/pattern) ⭐ 8,862 | 🐛 179 | 🌐 Python | 📅 2026-08-05 - Web mining module for Python.
* [BentoML](https://github.com/bentoml/bentoml) ⭐ 8,837 | 🐛 217 | 🌐 Python | 📅 2026-09-07: Toolkit for package and deploy machine learning models for serving in production
...
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,912 | 🐛 302 | 🌐 Jupyter Notebook | 📅 2026-09-11: Interactive reports to analyze machine learning models during validation or production monitoring.
...
* [ClearML](https://github.com/clearml/clearml) ⭐ 6,863 | 🐛 526 | 🌐 Python | 📅 2026-09-09 -  Auto-Magical CI/CD to streamline your AI workload. Experiment Management, Data Management, Pipeline, Orchestration, Scheduling & Serving in one MLOps/LLMOps solution.
* [deap](https://github.com/deap/deap) ⭐ 6,438 | 🐛 281 | 🌐 Python | 📅 2026-04-17 - Evolutionary algorithm framework.
* [NuPIC](https://github.com/numenta/nupic) ⭐ 6,350 | 🐛 465 | 🌐 Python | 📅 2024-12-03 - Numenta Platform for Intelligent Computing.
* [Aim](https://github.com/aimhubio/aim) ⭐ 6,250 | 🐛 474 | 🌐 Python | 📅 2026-09-11 -> An easy-to-use & supercharged open-source AI metadata tracker.
* [skorch](https://github.com/skorch-dev/skorch) ⭐ 6,179 | 🐛 63 | 🌐 Jupyter Notebook | 📅 2026-09-08 - A scikit-learn compatible neural network library that wraps PyTorch.
* [River](https://github.com/online-ml/river) ⭐ 6,093 | 🐛 77 | 🌐 Python | 📅 2026-09-03: A framework for general purpose online machine learning.
* [Chainer](https://github.com/chainer/chainer) ⭐ 5,919 | 🐛 15 | 🌐 Python | 📅 2023-08-28 - Flexible neural network framework.
* [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) ⭐ 5,246 | 🐛 147 | 🌐 Scala | 📅 2026-09-10 -> A distributed machine learning framework Apache Spark
* [mlxtend](https://github.com/rasbt/mlxtend) ⭐ 5,174 | 🐛 139 | 🌐 Python | 📅 2026-09-08 - A library consisting of useful tools for data science and machine learning tasks.
...
* [Deepchecks](https://github.com/deepchecks/deepchecks) ⭐ 4,053 | 🐛 267 | 🌐 Python | 📅 2025-12-28: Validation & testing of machine learning models and data during model development, deployment, and production. This includes checks and suites related to various types of issues, such as model performance, data integrity, distribution mismatches, and more.
* [neon](https://github.com/NervanaSystems/neon) ⚠️ Archived - Nervana's [high-performance](https://github.com/soumith/convnet-benchmarks) ⭐ 2,685 | 🐛 34 | 🌐 Python | 📅 2017-06-09 Python-based Deep Learning framework \[DEEP LEARNING]. **\[Deprecated]**
...
* [pomegranate](https://github.com/jmschrei/pomegranate) ⭐ 3,543 | 🐛 44 | 🌐 Python | 📅 2025-03-06 - Hidden Markov Models for Python, implemented in Cython for speed and efficiency.
* [PyBroker](https://github.com/edtechre/pybroker) ⭐ 3,537 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - Algorithmic Trading with Machine Learning.
* [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,383 | 🐛 5 | 🌐 Python | 📅 2026-07-08 - High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing. Being able to research/develop something new, rather than write another regular train loop.
...
* [mljar-supervised](https://github.com/mljar/mljar-supervised) ⭐ 3,292 | 🐛 129 | 🌐 Python | 📅 2026-07-27 - An Automated Machine Learning (AutoML) python package for tabular data. It can handle: Binary Classification, MultiClass Classification and Regression. It provides explanations and markdown reports.
* [Shapash](https://github.com/MAIF/shapash) ⭐ 3,254 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2026-09-11 : Shapash is a Python library that provides several types of visualization that display explicit labels that everyone can understand.
* [Determined](https://github.com/determined-ai/determined) ⭐ 3,239 | 🐛 108 | 🌐 Go | 📅 2025-03-20 - Scalable deep learning training platform, including integrated support for distributed training, hyperparameter tuning, experiment tracking, and model management.
...
* [Pylearn2](https://github.com/lisa-lab/pylearn2) ⭐ 2,766 | 🐛 201 | 🌐 Python | 📅 2021-08-20 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano) ⭐ 10,000 | 🐛 699 | 🌐 Python | 📅 2024-01-15. **\[Deprecated]**
* [modAL](https://github.com/modAL-python/modAL) ⭐ 2,364 | 🐛 108 | 🌐 Python | 📅 2024-02-26 - A modular active learning framework for Python, built on top of scikit-learn.
* [Karate Club](https://github.com/benedekrozemberczki/karateclub) ⭐ 2,286 | 🐛 12 | 🌐 Python | 📅 2024-07-17 -> An unsupervised machine learning extension library for NetworkX with a Scikit-Learn like API.
* [Feature-engine](https://github.com/feature-engine/feature_engine) ⭐ 2,279 | 🐛 98 | 🌐 Python | 📅 2026-08-30 - Open source library with an exhaustive battery of feature engineering and selection methods based on pandas and scikit-learn.
* [MCP Memory Service](https://github.com/doobidoo/mcp-memory-service) ⭐ 1,940 | 🐛 42 | 🌐 Python | 📅 2026-09-12 - Universal memory service with semantic search, autonomous consolidation, and multi-client support for AI applications.
...
* [auto\_ml](https://github.com/ClimbsRocks/auto_ml) ⭐ 1,652 | 🐛 187 | 🌐 Python | 📅 2021-02-10 - Automated machine learning for production and analytics. Lets you focus on the fun parts of ML, while outputting production-ready code, and detailed analytics of your dataset and results. Includes support for NLP, XGBoost, CatBoost, LightGBM, and soon, deep learning.
* [skrub](https://github.com/skrub-data/skrub) ⭐ 1,651 | 🐛 140 | 🌐 Python | 📅 2026-09-11 - Skrub is a Python library that eases preprocessing and feature engineering for machine learning on dataframes.
...
* [skforecast](https://github.com/skforecast/skforecast) ⭐ 1,533 | 🐛 12 | 🌐 Python | 📅 2026-09-11 - Python library for time series forecasting using machine learning models. It works with any regressor compatible with the scikit-learn API, including popular options like LightGBM, XGBoost, CatBoost, Keras, and many others.
...
* [metric-learn](https://github.com/metric-learn/metric-learn) ⭐ 1,432 | 🐛 51 | 🌐 Python | 📅 2026-03-19 - A Python module for metric learning.
* [nilearn](https://github.com/nilearn/nilearn) ⭐ 1,431 | 🐛 290 | 🌐 Python | 📅 2026-09-11 - Machine learning for NeuroImaging in Python.
* [pydeep](https://github.com/andersbll/deeppy) ⭐ 1,371 | 🐛 22 | 🌐 Python | 📅 2020-12-28 - Deep Learning In Python. **\[Deprecated]**
* [Intel(R) Extension for Scikit-learn](https://github.com/intel/scikit-learn-intelex) ⭐ 1,357 | 🐛 85 | 🌐 Python | 📅 2026-09-10 - A seamless way to speed up your Scikit-learn applications with no accuracy loss and code changes.
...
* [Xcessiv](https://github.com/reiinakano/xcessiv) ⭐ 1,264 | 🐛 22 | 🌐 Python | 📅 2018-06-06 - A web-based application for quick, scalable, and automated hyperparameter tuning and stacked ensembling.
* [dtaidistance](https://github.com/wannesm/dtaidistance) ⭐ 1,241 | 🐛 21 | 🌐 Python | 📅 2026-09-11 - High performance library for time series distances (DTW) and time series clustering.
* [Crab](https://github.com/muricoca/crab) ⭐ 1,175 | 🐛 46 | 🌐 Python | 📅 2020-12-30 - A flexible, fast recommender engine. **\[Deprecated]**
...
* [Cornac](https://github.com/PreferredAI/cornac) ⭐ 1,055 | 🐛 27 | 🌐 Python | 📅 2026-08-27 - A comparative framework for multimodal recommender systems with a focus on models leveraging auxiliary data.
* [OpenMetricLearning](https://github.com/OML-Team/open-metric-learning) ⭐ 998 | 🐛 37 | 🌐 Python | 📅 2025-11-26 - A PyTorch-based framework to train and validate the models producing high-quality embeddings.
* [SimpleAI](https://github.com/simpleai-team/simpleai) ⭐ 994 | 🐛 13 | 🌐 Python | 📅 2023-11-06 Python implementation of many of the artificial intelligence algorithms described in the book "Artificial Intelligence, a Modern Approach". It focuses on providing an easy to use, well documented and tested library.
...
* [Couler](https://github.com/couler-proj/couler) ⭐ 943 | 🐛 21 | 🌐 Python | 📅 2024-10-08 - Unified interface for constructing and managing machine learning workflows on different workflow engines, such as Argo Workflows, Tekton Pipelines, and Apache Airflow.
* [mlens](https://github.com/flennerhag/mlens) ⭐ 865 | 🐛 27 | 🌐 Python | 📅 2023-11-13 - A high performance, memory efficient, maximally parallelized ensemble learning, integrated with scikit-learn.
* [PyTorch Frame](https://github.com/pyg-team/pytorch-frame) ⭐ 797 | 🐛 23 | 🌐 Python | 📅 2026-09-07 -> A Modular Framework for Multi-Modal Tabular Learning.
* [scikit-multiflow](https://github.com/scikit-multiflow/scikit-multiflow) ⭐ 797 | 🐛 73 | 🌐 Python | 📅 2023-11-02 - A machine learning framework for multi-output/multi-label and stream data.
...
* [Little Ball of Fur](https://github.com/benedekrozemberczki/littleballoffur) ⭐ 715 | 🐛 7 | 🌐 Python | 📅 2025-12-20 -> A graph sampling extension library for NetworkX with a Scikit-Learn like API.
* [FEDOT](https://github.com/nccr-itmo/FEDOT) ⭐ 712 | 🐛 83 | 🌐 Python | 📅 2026-09-12: An AutoML framework for the automated design of composite modelling pipelines. It can handle classification, regression, and time series forecasting tasks on different types of data (including multi-modal datasets).
* [REP](https://github.com/yandex/rep) ⭐ 700 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2024-07-31 - an IPython-based environment for conducting data-driven research in a consistent and reproducible way. REP is not trying to substitute scikit-learn, but extends it and provides better user experience. **\[Deprecated]**
...
* [pyhsmm](https://github.com/mattjj/pyhsmm) ⭐ 580 | 🐛 46 | 🌐 Python | 📅 2025-01-25 - library for approximate unsupervised inference in Bayesian Hidden Markov Models (HMMs) and explicit-duration Hidden semi-Markov Models (HSMMs), focusing on the Bayesian Nonparametric extensions, the HDP-HMM and HDP-HSMM, mostly with weak-limit approximations.
* [SKLL](https://github.com/EducationalTestingService/skll) ⭐ 561 | 🐛 22 | 🌐 Python | 📅 2025-06-12 - A wrapper around scikit-learn that makes it simpler to conduct experiments.
...
* [skbayes](https://github.com/AmazaspShumik/sklearn-bayes) ⭐ 520 | 🐛 20 | 🌐 Jupyter Notebook | 📅 2021-09-22 - Python package for Bayesian Machine Learning with scikit-learn API.
* [Lightwood](https://github.com/mindsdb/lightwood) ⭐ 510 | 🐛 17 | 🌐 Python | 📅 2026-08-28 - A Pytorch based framework that breaks down machine learning problems into smaller blocks that can be glued together seamlessly with objective to build predictive models with one line of code.
* [ChefBoost](https://github.com/serengil/chefboost) ⭐ 487 | 🐛 0 | 🌐 Python | 📅 2026-05-13 - a lightweight decision tree framework for Python with categorical feature support covering regular decision tree algorithms such as ID3, C4.5, CART, CHAID and regression tree; also some advanced bagging and boosting techniques such as gradient boosting, random forest and adaboost.
...
* [Sklearn-genetic-opt](https://github.com/rodrigo-arenas/Sklearn-genetic-opt) ⭐ 390 | 🐛 15 | 🌐 Python | 📅 2026-08-05: An AutoML package for hyperparameters tuning using evolutionary algorithms, with built-in callbacks, plotting, remote logging and more.
...
* [fuku-ml](https://github.com/fukuball/fuku-ml) ⭐ 285 | 🐛 14 | 🌐 Python | 📅 2025-08-07 - Simple machine learning library, including Perceptron, Regression, Support Vector Machine, Decision Tree and more, it's easy to use and easy to learn for beginners.
* [RexMex](https://github.com/AstraZeneca/rexmex) ⭐ 277 | 🐛 3 | 🌐 Python | 📅 2023-08-22 -> A general purpose recommender metrics library for fair evaluation.
* [evostra](https://github.com/alirezamika/evostra) ⭐ 271 | 🐛 8 | 🌐 Python | 📅 2020-04-27 - A fast Evolution Strategy implementation in Python.
* [Frouros](https://github.com/IFCA/frouros) ⭐ 261 | 🐛 16 | 🌐 Python | 📅 2026-04-23: Frouros is an open source Python library for drift detection in machine learning systems.
* [machine learning](https://github.com/jeff1evesque/machine-learning) ⭐ 258 | 🐛 78 | 🌐 JavaScript | 📅 2021-02-17 - automated build consisting of a [web-interface](https://github.com/jeff1evesque/machine-learning#web-interface) ⭐ 258 | 🐛 78 | 🌐 JavaScript | 📅 2021-02-17, and set of [programmatic-interface](https://github.com/jeff1evesque/machine-learning#programmatic-interface) ⭐ 258 | 🐛 78 | 🌐 JavaScript | 📅 2021-02-17 API, for support vector machines. Corresponding dataset(s) are stored into a SQL database, then generated model(s) used for prediction(s), are stored into a NoSQL datastore.
...
* [CometML](https://github.com/comet-ml/comet-examples) ⭐ 176 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2026-08-12: The best-in-class MLOps platform with experiment tracking, model production monitoring, a model registry, and data lineage from training straight through to production.
...
* [Neurolink](https://github.com/juspay/neurolink) ⭐ 133 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-12 - Enterprise-grade LLM integration framework for building production-ready AI applications with built-in hallucination prevention, RAG, and MCP support.
...
* [bayeso](https://github.com/jungtaekkim/bayeso) ⭐ 97 | 🐛 1 | 🌐 Python | 📅 2026-01-12 - A simple, but essential Bayesian optimization package, written in Python.
* [breze](https://github.com/breze-no-salt/breze) ⭐ 96 | 🐛 29 | 🌐 Jupyter Notebook | 📅 2016-09-02 - Theano based library for deep and recurrent neural networks.
* [topik](https://github.com/ContinuumIO/topik) ⚠️ Archived - Topic modelling toolkit. **\[Deprecated]**
* [Bolt](https://github.com/pprett/bolt) ⭐ 88 | 🐛 0 | 🌐 C | 📅 2011-10-05 - Bolt Online Learning Toolbox. **\[Deprecated]**
...
* [Synthia](https://github.com/dmey/synthia) ⭐ 69 | 🐛 2 | 🌐 Python | 📅 2023-09-28 - Multidimensional synthetic data generation in Python.
...
* [neonrvm](https://github.com/siavashserver/neonrvm) ⚠️ Archived - neonrvm is an open source machine learning library based on RVM technique. It's written in C programming language and comes with Python programming language bindings.
* [OPFython](https://github.com/gugarosa/opfython) ⭐ 38 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - A Python-inspired implementation of the Optimum-Path Forest classifier.
...
* [SKBEL](https://github.com/robinthibaut/skbel) ⭐ 30 | 🐛 1 | 🌐 Python | 📅 2026-09-10: A Python library for Bayesian Evidential Learning (BEL) in order to estimate the uncertainty of a prediction.
...
* [autobatcher](https://github.com/doublewordai/autobatcher) ⭐ 22 | 🐛 14 | 🌐 Python | 📅 2026-09-12 - Drop-in AsyncOpenAI replacement that transparently batches requests via the Batch API for cheaper LLM inference.
...
* [Leanpass](https://github.com/Terminay/LeanPass) ⭐ 16 | 🐛 27 | 🌐 Python | 📅 2026-09-11 - A lightweight, NumPy-only autodiff library for small ML projects and learning how backpropagation works. It is 700x times lighter than Pytorch and 900x times lighter than TensorFlow.
...
* [PhilanthroPy](https://github.com/PhilanthroPy-Project/PhilanthroPy) ⭐ 11 | 🐛 15 | 🌐 Python | 📅 2026-09-12 - A scikit-learn native toolkit for nonprofit and academic-medical-center fundraising analytics: leakage-safe donor propensity, lapse, planned-giving, wealth-screening and revenue-forecasting estimators.
...
* [pyinterpret](https://github.com/mowne67/pyinterpret) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Unified API for SHAP, LIME, permutation importance, and partial dependence explanations.
...
* [Superset](https://github.com/apache/incubator-superset) ⭐ 74,737 | 🐛 609 | 🌐 Python | 📅 2026-09-12 - A data exploration platform designed to be visual, intuitive, and interactive.
* [Dash](https://github.com/plotly/dash) ⭐ 24,404 | 🐛 486 | 🌐 Python | 📅 2026-09-11 - A framework for creating analytical web applications built on top of Plotly.js, React, and Flask
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,446 | 🐛 854 | 🌐 Python | 📅 2026-09-12 - Interactive Web Plotting for Python.
* [zipline](https://github.com/quantopian/zipline) ⭐ 20,091 | 🐛 368 | 🌐 Python | 📅 2024-02-13 - A Pythonic algorithmic trading library.
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,920 | 🐛 5,987 | 🌐 Python | 📅 2026-09-12 - A Python library for symbolic mathematics.
* [lime](https://github.com/marcotcr/lime) ⭐ 12,162 | 🐛 133 | 🌐 JavaScript | 📅 2024-07-25 - Lime is about explaining what machine learning classifiers (or models) are doing. It is able to explain any black box classifier, with two or more classes.
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,623 | 🐛 2,808 | 🌐 Python | 📅 2026-09-09 - Statistical modelling and econometrics in Python.
* [altair](https://github.com/altair-viz/altair) ⭐ 10,472 | 🐛 148 | 🌐 Python | 📅 2026-09-12 - A Python to Vega translator.
* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,749 | 🐛 493 | 🌐 Python | 📅 2026-09-10 - Markov Chain Monte Carlo sampling toolkit.
* [Vaex](https://github.com/vaexio/vaex) ⭐ 8,509 | 🐛 552 | 🌐 Python | 📅 2026-04-01 - A high performance Python library for lazy Out-of-Core DataFrames (similar to Pandas), to visualize and explore big tabular datasets. Documentation can be found [here](https://vaex.io/docs/index.html).
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) ⭐ 4,415 | 🐛 497 | 🌐 Python | 📅 2026-09-11 - A pure-python graphics and GUI library built on PyQt4 / PySide and NumPy.
...
* [vispy](https://github.com/vispy/vispy) ⭐ 3,595 | 🐛 387 | 🌐 Python | 📅 2026-09-08 - GPU-based high-performance interactive OpenGL 2D/3D data visualization library.
...
* [Mars](https://github.com/mars-project/mars) ⭐ 2,742 | 🐛 215 | 🌐 Python | 📅 2024-01-02 - A tensor-based framework for large-scale data computation which is often regarded as a parallel and distributed version of NumPy.
...
* [ggfortify](https://github.com/sinhrks/ggfortify) ⭐ 541 | 🐛 16 | 🌐 R | 📅 2026-09-10 - Unified interface to ggplot2 popular R packages.
...
* [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 306 | 🐛 20 | 🌐 Fortran | 📅 2026-06-25 - A general-purpose Python library for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
* [Flama](https://github.com/vortico/flama) ⭐ 297 | 🐛 10 | 🌐 Python | 📅 2026-09-11 - Ignite your models into blazing-fast machine learning APIs with a modern framework.
...
* [windML](https://github.com/cigroup-ol/windml) ⭐ 130 | 🐛 13 | 📅 2024-01-28 - A Python Framework for Wind Energy Analysis and Prediction.
...
* [NuPIC Studio](https://github.com/htm-community/nupic.studio) ⭐ 95 | 🐛 16 | 🌐 Python | 📅 2020-07-26 An all-in-one NuPIC Hierarchical Temporal Memory visualization and debugging super-tool! **\[Deprecated]**
...
* [dowel](https://github.com/rlworkgroup/dowel) ⭐ 35 | 🐛 19 | 🌐 Python | 📅 2023-08-30 - A little logger for machine learning research. Output any object to the terminal, CSV, TensorBoard, text logs on disk, and more with just one call to `logger.log()`.
...
* [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) ⭐ 29,344 | 🐛 48 | 🌐 Python | 📅 2024-03-20 - Continually updated Data Science Python Notebooks: Spark, Hadoop MapReduce, HDFS, AWS, Kaggle, scikit-learn, matplotlib, pandas, NumPy, SciPy, and various command lines.
...
* [Pydata book](https://github.com/wesm/pydata-book) ⭐ 24,906 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2025-10-17 - Materials and IPython notebooks for "Python for Data Analysis" by Wes McKinney, published by O'Reilly Media
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,782 | 🐛 30 | 🌐 Jupyter Notebook | 📅 2025-11-23 - Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
* [A gallery of interesting IPython notebooks](https://github.com/jupyter/jupyter/wiki/A-gallery-of-interesting-Jupyter-Notebooks) ⭐ 15,349 | 🐛 46 | 🌐 Python | 📅 2026-07-09
...
* [Introduction to Machine Learning with Python](https://github.com/amueller/introduction_to_ml_with_python) ⭐ 8,180 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2024-03-14 - Notebooks and code for the book "Introduction to Machine Learning with Python"
* [pandas cookbook](https://github.com/jvns/pandas-cookbook) ⭐ 7,115 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-10-24 - Recipes for using Python's pandas library.
* [numpic](https://github.com/numenta/nupic) ⭐ 6,350 | 🐛 465 | 🌐 Python | 📅 2024-12-03
* [pattern\_classification](https://github.com/rasbt/pattern_classification) ⭐ 4,209 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-11-26
* [Introduction to machine learning with scikit-learn](https://github.com/justmarkham/scikit-learn-videos) ⭐ 3,811 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-03-05 - IPython notebooks from Data School's video tutorials on scikit-learn.
* [Keras Tuner](https://github.com/keras-team/keras-tuner) ⭐ 2,922 | 🐛 239 | 🌐 Python | 📅 2025-12-01 - An easy-to-use, scalable hyperparameter optimization framework that solves the pain points of hyperparameter search.
* [Allen Downey’s Think Bayes Code](https://github.com/AllenDowney/ThinkBayes) ⭐ 1,702 | 🐛 12 | 🌐 TeX | 📅 2021-03-12 - Code repository for Think Bayes.
...
* [Hyperparameter-Optimization-of-Machine-Learning-Algorithms](https://github.com/LiYangHart/Hyperparameter-Optimization-of-Machine-Learning-Algorithms) ⭐ 1,345 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-09-22 - Code for hyperparameter tuning/optimization of machine learning and deep learning algorithms.
...
* [the-elements-of-statistical-learning](https://github.com/maitbayev/the-elements-of-statistical-learning) ⭐ 431 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-02-10 - This repository contains Jupyter notebooks implementing the algorithms found in the book and summary of the textbook.
* [climin](https://github.com/BRML/climin) ⭐ 185 | 🐛 22 | 🌐 Python | 📅 2026-01-16 - Optimization library focused on machine learning, pythonic implementations of gradient descent, LBFGS, rmsprop, adadelta and others.
...
* [jProcessing](https://github.com/kevincobain2000/jProcessing) ⭐ 147 | 🐛 4 | 🌐 OpenEdge ABL | 📅 2020-09-09 - Kanji / Hiragana / Katakana to Romaji Converter. Edict Dictionary & parallel sentences Search. Sentence Similarity between two JP Sentences. Sentiment Analysis of Japanese Text. Run Cabocha(ISO--8859-1 configured) in Python.
* [scikit-learn tutorials](https://github.com/GaelVaroquaux/scikit-learn-tutorial) ⭐ 134 | 🐛 0 | 🌐 Python | 📅 2011-12-06 - Series of notebooks for learning scikit-learn.
* [Allen Downey’s Think Complexity Code](https://github.com/AllenDowney/ThinkComplexity) ⭐ 117 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2024-10-01 - Code for Allen Downey's book Think Complexity.
* [BayesPy](https://github.com/maxsklar/BayesPy) ⭐ 110 | 🐛 1 | 🌐 HTML | 📅 2023-06-05 - Bayesian Inference Tools in Python.
* [MiniGrad](https://github.com/kennysong/minigrad) ⭐ 101 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2021-08-24 – A minimal, educational, Pythonic implementation of autograd (\~100 loc).
...
* [sentiment-analyzer](https://github.com/madhusudancs/sentiment-analyzer) ⭐ 50 | 🐛 0 | 🌐 JavaScript | 📅 2012-03-30 - Tweets Sentiment Analyzer
...
* [CAEs for Data Assimilation](https://github.com/julianmack/Data_Assimilation) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2021-01-07 - Convolutional autoencoders for 3D image/field compression applied to reduced order [Data Assimilation](https://en.wikipedia.org/wiki/Data_assimilation).
...
* [minidiff](https://github.com/ahoynodnarb/minidiff) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - A slightly larger, somewhat feature-complete, PyTorch-inspired, NumPy implementation of a tensor reverse-mode automatic differentiation engine.
...
* [NeuralTalk](https://github.com/karpathy/neuraltalk2) ⭐ 5,594 | 🐛 142 | 🌐 Jupyter Notebook | 📅 2017-11-07 - NeuralTalk is a Python+numpy project for learning Multimodal Recurrent Neural Networks that describe images with sentences. **\[Deprecated]**
* [NeuralTalk](https://github.com/karpathy/neuraltalk) ⭐ 5,504 | 🐛 30 | 🌐 Python | 📅 2020-12-22 - NeuralTalk is a Python+numpy project for learning Multimodal Recurrent Neural Networks that describe images with sentences.
...
* [TResNet: Simple and powerful neural network library for python](https://github.com/zueve/neurolab) ⭐ 169 | 🐛 16 | 🌐 Python | 📅 2020-06-02 - Variety of supported types of Artificial Neural Network and learning algorithms.
...
* [fenn](https://github.com/pyfenn/fenn) ⭐ 81 | 🐛 23 | 🌐 Python | 📅 2026-08-10 - A simple Python framework for building ML/DL workflows and LLM agents faster, with prebuilt trainers, agent templates, logging, configuration management, and much more.
...
* [zij](https://github.com/junaidaliop/zij) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-06-18 - A canon of deep learning optimization algorithms.
* [ANEE](https://github.com/abkmystery/ANEE) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2025-11-30 - Adaptive Neural Execution Engine for transformers. Per-token sparse inference with dynamic layer skipping, profiler-based gating, and KV-cache-safe compute reduction.
* [HypercubeESN](https://github.com/dliptak001/HypercubeESN) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-09-11 - Echo State Network on a Boolean hypercube reservoir: XOR Hamming-1 connectivity, no stored adjacency, C++23 + Python (`pip install hypercube-esn`).
* [HypercubeWTF](https://github.com/dliptak001/HypercubeWTF) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-09-11 - Frozen hypercube reservoir for static fields (synthetic-time orbit + thin CNN readout). Sibling of HypercubeESN.
* [HypercubeCascade](https://github.com/dliptak001/HypercubeCascade) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-09-11 - Etalon transit then WTF orbit on one cube, then a thin HypercubeCNN readout.
* [HypercubeHopfield](https://github.com/dliptak001/HypercubeHopfield) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-09-11 - Modern Hopfield associative memory on a hypercube graph with sparse local-attention retrieval (C++23 + Python).
...
* [Tonic](https://github.com/neuromorphs/tonic) ⭐ 296 | 🐛 34 | 🌐 Python | 📅 2026-07-17 - A library that makes downloading publicly available neuromorphic datasets a breeze and provides event-based data transformation/augmentation pipelines.
* [Sinabs](https://github.com/synsense/sinabs) ⭐ 124 | 🐛 27 | 🌐 Python | 📅 2026-02-05 - A deep learning library for spiking neural networks which is based on PyTorch, focuses on fast training and supports inference on neuromorphic hardware.
* [Rockpool](https://github.com/synsense/rockpool) ⭐ 90 | 🐛 3 | 🌐 Python | 📅 2026-07-03 - A machine learning library for spiking neural networks. Supports training with both torch and jax pipelines, and deployment to neuromorphic hardware.

<a name="python-survival-analysis"></a>

#### Python Survival Analysis

* [lifelines](https://github.com/CamDavidsonPilon/lifelines) ⭐ 2,606 | 🐛 300 | 🌐 Python | 📅 2026-03-07 - lifelines is a complete survival analysis library, written in pure Python
* [Scikit-Survival](https://github.com/sebp/scikit-survival) ⭐ 1,321 | 🐛 29 | 🌐 Python | 📅 2026-09-12 - scikit-survival is a Python module for survival analysis built on top of scikit-learn. It allows doing survival analysis while utilizing the power of scikit-learn, e.g., for pre-processing or doing cross-validation.

<a name="python-federated-learning"></a>

#### Federated Learning

* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 10,031 | 🐛 12 | 🌐 Python | 📅 2026-09-11 - A Python library for secure and private Deep Learning.
...
* [Kaggle Galaxy Challenge](https://github.com/benanne/kaggle-galaxies) ⭐ 500 | 🐛 0 | 🌐 Python | 📅 2014-08-13 - Winning solution for the Galaxy Challenge on Kaggle.
...
* [kaggle\_acquire-valued-shoppers-challenge](https://github.com/MLWave/kaggle_acquire-valued-shoppers-challenge) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2014-04-17 - Code for the Kaggle acquire valued shoppers challenge.
* [kaggle\_acquire-valued-shoppers-challenge](https://github.com/MLWave/kaggle_acquire-valued-shoppers-challenge) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2014-04-17 - Code for the Kaggle acquire valued shoppers challenge.
...
* [kaggle-advertised-salaries](https://github.com/zygmuntz/kaggle-advertised-salaries) ⭐ 54 | 🐛 0 | 🌐 Python | 📅 2014-06-21 - Predicting job salaries from ads - a Kaggle competition.
...
* [Kaggle Stackoverflow](https://github.com/zygmuntz/kaggle-stackoverflow) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2017-11-24 - Predicting closed questions on Stack Overflow.
...
* [RLlib](https://github.com/ray-project/ray) ⭐ 43,785 | 🐛 3,601 | 🌐 Python | 📅 2026-09-12 - RLlib is an industry level, highly scalable RL library for tf and torch, based on Ray. It's used by companies like Amazon and Microsoft to solve real-world decision making problems at scale.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 12,526 | 🐛 86 | 🌐 Python | 📅 2026-09-10 - A library for developing and comparing reinforcement learning algorithms (successor of \[gym])(<https://github.com/openai/gym> ⚠️ Archived).
* [DeepMind Lab](https://github.com/deepmind/lab) ⭐ 7,377 | 🐛 67 | 🌐 C | 📅 2023-01-04 - DeepMind Lab is a 3D learning environment based on id Software's Quake III Arena via ioquake3 and other open source software. Its primary purpose is to act as a testbed for research in artificial intelligence, especially deep reinforcement learning.
...
* [ViZDoom](https://github.com/mwydmuch/ViZDoom) ⭐ 2,069 | 🐛 40 | 🌐 C++ | 📅 2026-09-12 - ViZDoom allows developing AI bots that play Doom using only the visual information (the screen buffer). It is primarily intended for research in machine visual learning, and deep reinforcement learning, in particular.
* [metaworld](https://github.com/rlworkgroup/metaworld) ⭐ 1,880 | 🐛 16 | 🌐 Python | 📅 2026-09-12 - An open source robotics benchmark for meta- and multi-task reinforcement learning
* [SLM Lab](https://github.com/kengz/SLM-Lab) ⭐ 1,361 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - Modular Deep Reinforcement Learning framework in PyTorch.
* [Maze](https://github.com/enlite-ai/maze) ⭐ 293 | 🐛 2 | 🌐 Python | 📅 2026-06-01 - Application-oriented deep reinforcement learning framework addressing real-world decision problems.
...
* [EspNet](https://github.com/espnet/espnet) ⭐ 9,956 | 🐛 54 | 🌐 Python | 📅 2026-09-12 - ESPnet is an end-to-end speech processing toolkit for tasks like speech recognition, translation, and enhancement, using PyTorch and Kaldi-style data processing.
...
* [Twitter-text-rb](https://github.com/twitter/twitter-text/tree/master/rb) ⭐ 3,136 | 🐛 93 | 🌐 HTML | 📅 2024-04-26 - A library that does auto linking and extraction of usernames, lists and hashtags in tweets.
...
* [Awesome Machine Learning with Ruby](https://github.com/arbox/machine-learning-with-ruby) ⭐ 2,223 | 🐛 6 | 🌐 Ruby | 📅 2024-12-26 - Curated list of ML related resources for Ruby.
* [rumale](https://github.com/yoshoku/rumale) ⭐ 918 | 🐛 0 | 🌐 Ruby | 📅 2026-09-05 - Rumale is a machine learning library in Ruby
* [CardMagic-Classifier](https://github.com/cardmagic/classifier) ⭐ 741 | 🐛 10 | 🌐 Ruby | 📅 2026-09-05 - A general classifier module to allow Bayesian and other types of classifications.
...
* [Bioruby](https://github.com/bioruby/bioruby) ⭐ 382 | 🐛 15 | 🌐 Ruby | 📅 2026-07-02
* [rsruby](https://github.com/alexgutteridge/rsruby) ⭐ 333 | 🐛 15 | 🌐 Ruby | 📅 2018-10-06 - Ruby - R bridge.
* [Arel](https://github.com/nkallen/arel) ⭐ 271 | 🐛 7 | 🌐 Ruby | 📅 2009-05-21 **\[Deprecated]**
...
* [candle](https://github.com/huggingface/candle) ⭐ 21,026 | 🐛 901 | 🌐 Rust | 📅 2026-09-11 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use.
...
* [linfa](https://github.com/rust-ml/linfa) ⭐ 4,747 | 🐛 75 | 🌐 Rust | 📅 2026-08-22 - a comprehensive toolkit to build Machine Learning applications with Rust
* [linfa](https://github.com/rust-ml/linfa) ⭐ 4,747 | 🐛 75 | 🌐 Rust | 📅 2026-08-22 - `linfa` aims to provide a comprehensive toolkit to build Machine Learning applications with Rust
* [rusty-machine](https://github.com/AtheMathmo/rusty-machine) ⚠️ Archived - a pure-rust machine learning library.
* [smartcore](https://github.com/smartcorelib/smartcore) ⭐ 952 | 🐛 54 | 🌐 Rust | 📅 2026-08-26 - "The Most Advanced Machine Learning Library In Rust."
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,905 | 🐛 306 | 🌐 Rust | 📅 2026-09-11 - Burn is a new comprehensive dynamic Deep Learning Framework built using Rust with extreme flexibility, compute efficiency and portability as its primary goals
...
* [huggingface/tokenizers](https://github.com/huggingface/tokenizers) ⭐ 11,031 | 🐛 260 | 🌐 Rust | 📅 2026-09-11 - Fast State-of-the-Art Tokenizers optimized for Research and Production
* [shimmy](https://github.com/Michael-A-Kuykendall/shimmy) ⭐ 5,867 | 🐛 10 | 🌐 Rust | 📅 2026-08-30 - Python-free Rust inference server for NLP models with OpenAI API compatibility and hot model swapping.
...
* [shimmytok](https://github.com/Michael-A-Kuykendall/shimmytok) ⭐ 25 | 🐛 1 | 🌐 Rust | 📅 2026-08-30 - Pure-Rust tokenizer for GGUF models, compatible with llama.cpp tokenization.
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,099 | 🐛 723 | 🌐 C++ | 📅 2026-09-12 - General purpose gradient boosting on decision trees library with categorical features support out of the box for R.
* [Machine Learning For Hackers](https://github.com/johnmyleswhite/ML_for_Hackers) ⭐ 3,730 | 🐛 36 | 🌐 R | 📅 2019-05-26
* [XGBoost.R](https://github.com/tqchen/xgboost/tree/master/R-package) ⭐ 581 | 🐛 0 | 🌐 C++ | 📅 2018-07-04 - R binding for eXtreme Gradient Boosting (Tree) Library.
...
* [SuperLearner](https://github.com/ecpolley/SuperLearner) ⭐ 294 | 🐛 20 | 🌐 R | 📅 2026-08-16 - Multi-algorithm ensemble learning packages.
...
* [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,158 | 🐛 34 | 🌐 Scala | 📅 2026-09-12 - Natural language processing library built on top of Apache Spark ML to provide simple, performant, and accurate NLP annotations for machine learning pipelines, that scale easily in a distributed environment.
...
* [NDScala](https://github.com/SciScala/NDScala) ⭐ 48 | 🐛 0 | 🌐 Scala | 📅 2022-12-22 - N-dimensional arrays in Scala 3. Think NumPy ndarray, but with compile-time type-checking/inference over shapes, tensor/axis labels & numeric data types
...
* [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) ⭐ 5,246 | 🐛 147 | 🌐 Scala | 📅 2026-09-10 -> A distributed machine learning framework Apache Spark
* [adam](https://github.com/bigdatagenomics/adam) ⭐ 1,059 | 🐛 43 | 🌐 Scala | 📅 2026-03-17 - A genomics processing engine and specialized file format built using Apache Avro, Apache Spark and Parquet. Apache 2 licensed.
* [H2O Sparkling Water](https://github.com/h2oai/sparkling-water) ⭐ 980 | 🐛 43 | 🌐 Scala | 📅 2025-11-05 - H2O and Spark interoperability.
...
* [Figaro](https://github.com/p2t2/figaro) ⭐ 757 | 🐛 122 | 🌐 HTML | 📅 2022-06-01 - a Scala library for constructing probabilistic models.
...
* [isolation-forest](https://github.com/linkedin/isolation-forest) ⭐ 264 | 🐛 1 | 🌐 Scala | 📅 2026-08-04 - A distributed Spark/Scala implementation of the isolation forest algorithm for unsupervised outlier detection, featuring support for scalable training and ONNX export for easy cross-platform inference.
...
* [ONNX-Scala](https://github.com/EmergentOrder/onnx-scala) ⭐ 149 | 🐛 8 | 🌐 Scala | 📅 2026-08-24 - An ONNX (Open Neural Network eXchange) API and backend for typeful, functional deep learning in Scala (3).
...
* [Saul](https://github.com/CogComp/saul) ⭐ 66 | 🐛 121 | 🌐 Scala | 📅 2020-01-16 - Flexible Declarative Learning-Based Programming.
...
* [layer](https://github.com/cloudkj/layer) ⭐ 560 | 🐛 0 | 🌐 Scheme | 📅 2019-04-21 - Neural network inference from the command line, implemented in [CHICKEN Scheme](https://www.call-cc.org/).
...
* [AIToolbox](https://github.com/KevinCoble/AIToolbox) ⭐ 807 | 🐛 6 | 🌐 Swift | 📅 2020-08-09 - A toolbox framework of AI modules written in Swift: Graphs/Trees, Linear Regression, Support Vector Machines, Neural Networks, PCA, KMeans, Genetic Algorithms, MDP, Mixture of Gaussians.
...
* [MLKit](https://github.com/Somnibyte/MLKit) ⭐ 154 | 🐛 4 | 🌐 Swift | 📅 2018-08-28 - A simple Machine Learning Framework written in Swift. Currently features Simple Linear Regression, Polynomial Regression, and Ridge Regression.
* [PredictionBuilder](https://github.com/denissimon/prediction-builder-swift) ⭐ 13 | 🐛 0 | 🌐 Swift | 📅 2025-09-18 - A library for machine learning that builds predictions using a linear regression.

<a name="swift-speech-recognition"></a>

#### Speech Recognition

* [VoxRT](https://github.com/VoxRT/voxrt-asr-ios) ⭐ 13 | 🐛 0 | 🌐 Swift | 📅 2026-07-02 - On-device streaming speech recognition SDK for iOS with Swift bindings (SPM). Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Companion Silero VAD, wake-word, and 14-command KWS via same runtime.
...
* [Awesome TensorFlow](https://github.com/jtoy/awesome-tensorflow) ⭐ 17,552 | 🐛 34 | 📅 2026-02-08 - A list of all things related to TensorFlow.
...
* [layer](https://github.com/cloudkj/layer) ⭐ 560 | 🐛 0 | 🌐 Scheme | 📅 2019-04-21 - Neural network inference from the command line
...
* [milvus](https://milvus.io) – Milvus is [open source](https://github.com/milvus-io/milvus) ⭐ 46,074 | 🐛 1,428 | 🌐 Go | 📅 2026-09-11 vector database for production AI, written in Go and C++, scalable and blazing fast for billions of embedding vectors.
* [Qdrant](https://qdrant.tech) – Qdrant is [open source](https://github.com/qdrant/qdrant) ⭐ 34,511 | 🐛 715 | 🌐 Rust | 📅 2026-09-12 vector similarity search engine with extended filtering support, written in Rust.
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,048 | 🐛 650 | 🌐 TypeScript | 📅 2026-09-12 - Open-source LLM evaluation and red teaming framework. Test prompts, models, agents, and RAG pipelines. Run adversarial attacks (jailbreaks, prompt injection) and integrate security testing into CI/CD.
* [Weaviate](https://www.semi.technology/developers/weaviate/current/) – Weaviate is an [open source](https://github.com/semi-technologies/weaviate) ⭐ 16,801 | 🐛 745 | 🌐 Go | 📅 2026-09-12 vector search engine and vector database. Weaviate uses machine learning to vectorize and store data, and to find answers to natural language queries. With Weaviate you can also bring your custom ML models to production scale.
* [DVC](https://github.com/iterative/dvc) ⭐ 15,868 | 🐛 209 | 🌐 Python | 📅 2026-09-07 - Data Science Version Control is an open-source version control system for machine learning projects with pipelines support. It makes ML projects reproducible and shareable.
* [txtai](https://github.com/neuml/txtai) ⭐ 12,946 | 🐛 10 | 🌐 Python | 📅 2026-09-11 - Build semantic search applications and workflows.
* [Kedro](https://github.com/quantumblacklabs/kedro/) ⭐ 10,994 | 🐛 137 | 🌐 Python | 📅 2026-09-11 - Kedro is a data and development workflow framework that implements best practices for data pipelines with an eye towards productionizing machine learning models.
* [RunAnywhere](https://github.com/RunanywhereAI/runanywhere-sdks) ⭐ 10,281 | 🐛 113 | 🌐 C++ | 📅 2026-09-11 - Open-source SDK for running LLMs and multimodal models on-device across iOS, Android, and cross-platform apps.
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,047 | 🐛 85 | 🌐 Python | 📅 2026-09-11 - Production-ready Multi-AI Agents framework with self-reflection. Fastest agent instantiation (3.77μs), 100+ LLM support via LiteLLM, MCP integration, agentic workflows (route/parallel/loop/repeat), built-in memory, Python & JS SDKs.
* [Infinity](https://github.com/infiniflow/infinity) ⭐ 4,706 | 🐛 126 | 🌐 C++ | 📅 2026-09-09 - The AI-native database built for LLM applications, providing incredibly fast vector and full-text search. Developed using C++20
* [Sacred](https://github.com/IDSIA/sacred) ⭐ 4,378 | 🐛 107 | 🌐 Python | 📅 2025-10-22 - Python tool to help  you configure, organize, log and reproduce experiments. Like a notebook lab in the context of Chemistry/Biology. The community has built multiple add-ons leveraging the proposed standard.
...
* More tools to improve the ML lifecycle: [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,383 | 🐛 5 | 🌐 Python | 📅 2026-07-08, [PachydermIO](https://www.pachyderm.io/). The following are GitHub-alike and targeting teams [Weights & Biases](https://www.wandb.com/), [Neptune.ai](https://neptune.ai/), [Comet.ml](https://www.comet.ml/), [Valohai.ai](https://valohai.com/), [DAGsHub](https://DAGsHub.com/).
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 3,002 | 🐛 62 | 🌐 Python | 📅 2024-08-03 - A tool that allows the conversion of ML models into native code (Java, C, Python, Go, JavaScript, Visual Basic, C#, R, PowerShell, PHP, Dart) with zero dependencies.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,590 | 🐛 173 | 🌐 Jupyter Notebook | 📅 2026-09-10 - a lightweight library to define data transformations as a directed-acyclic graph (DAG). It helps author reliable feature engineering and machine learning pipelines, and more.
* [Agentfield](https://github.com/Agent-Field/agentfield) ⭐ 2,561 | 🐛 46 | 🌐 Go | 📅 2026-09-12 - Open source Kubernetes-style control plane for deploying AI agents as distributed microservices, with built-in service discovery, durable workflows, and observability.
...
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 1,051 | 🐛 15 | 🌐 Python | 📅 2025-11-27 -  Open-source CLI security scanner for agentic workflows. Scans your workflow’s source code, detects vulnerabilities, and generates an interactive visualization along with a detailed security report. Supports LangGraph, CrewAI, n8n, OpenAI Agents, and more.
...
* [Localforge](https://localforge.dev/) – Is an [open source](https://github.com/rockbite/localforge) ⭐ 398 | 🐛 13 | 🌐 JavaScript | 📅 2025-05-18 on-prem AI coding autonomous assistant that lives inside your repo, edits and tests files at SSD speed. Think Claude Code but with UI. plug in any LLM (OpenAI, Gemini, Ollama, etc.) and let it work for you.
* [Awesome RAG Production](https://github.com/Yigtwxx/Awesome-RAG-Production) ⭐ 246 | 🐛 5 | 🌐 Python | 📅 2026-09-10 - A curated collection of battle-tested tools, frameworks, and best practices for building, scaling, and monitoring production-grade Retrieval-Augmented Generation (RAG) systems. Covers frameworks, vector databases, retrieval & reranking, evaluation, observability, deployment, and security.
* [DVClive](https://github.com/iterative/dvclive) ⭐ 196 | 🐛 33 | 🌐 Python | 📅 2026-09-07 - Python library for experiment metrics logging into simply formatted local files.
* [Agentic Signal](https://github.com/code-forge-temple/agentic-signal) ⭐ 163 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-05 - Visual AI agent workflow automation platform with local LLM integration. Build intelligent workflows using drag-and-drop, no cloud required.
...
* [DockerDL](https://github.com/matifali/dockerdl) ⭐ 86 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-31 - Ready to use deeplearning docker images.
* [Local LLM NPC](https://github.com/code-forge-temple/local-llm-npc) ⭐ 50 | 🐛 0 | 🌐 C# | 📅 2026-02-26 - Godot 4.x asset that enables NPCs to interact with players using local LLMs for structured, offline-first learning conversations in games.
...
* [HyperAgency](https://github.com/vuics/h9y) ⭐ 37 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-10 - agentic AI operating system (h9y.ai) that replaces brittle/fragmented automations with long-lived, self-improving systems. Open-source, self-hosted/cloud, visual workflow, omni-channel, decentralized, extensible.
...
* [ScribePal](https://github.com/code-forge-temple/scribe-pal) ⭐ 22 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10 - Chrome extension that uses local LLMs to assist with writing and drafting responses based on the context of your open tabs.
...
* Some of the python libraries were cut-and-pasted from [vinta](https://github.com/vinta/awesome-python) ⭐ 320,253 | 🐛 24 | 🌐 Python | 📅 2026-09-01
