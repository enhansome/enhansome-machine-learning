...
* For a list of free machine learning books available for download, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/books.md) ⭐ 74,030 | 🐛 25 | 🌐 Python | 📅 2026-08-11.

* For a list of professional machine learning events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/events.md) ⭐ 74,030 | 🐛 25 | 🌐 Python | 📅 2026-08-11.

* For a list of (mostly) free machine learning courses available online, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/courses.md) ⭐ 74,030 | 🐛 25 | 🌐 Python | 📅 2026-08-11.

* For a list of blogs and newsletters on data science and machine learning, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/blogs.md) ⭐ 74,030 | 🐛 25 | 🌐 Python | 📅 2026-08-11.

* For a list of free-to-attend meetups and local events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/meetups.md) ⭐ 74,030 | 🐛 25 | 🌐 Python | 📅 2026-08-11.
...
* [Darknet](https://github.com/pjreddie/darknet) ⭐ 26,488 | 🐛 1,975 | 🌐 C | 📅 2024-05-03 - Darknet is an open source neural network framework written in C and CUDA. It is fast, easy to install, and supports CPU and GPU computation.
* [libonnx](https://github.com/xboot/libonnx) ⭐ 653 | 🐛 16 | 🌐 C | 📅 2026-07-07 - A lightweight, portable pure C99 onnx inference engine for embedded devices with hardware acceleration support.
...
* [notorch](https://github.com/ariannamethod/notorch) ⭐ 20 | 🐛 0 | 🌐 C | 📅 2026-08-09 - Neural networks framework in pure C: training and inference, no dependencies.
...
* [YOLOv8](https://github.com/ultralytics/ultralytics) ⭐ 60,624 | 🐛 155 | 🌐 Python | 📅 2026-08-14 - Ultralytics' YOLOv8 implementation with C++ support for real-time object detection and tracking, optimized for edge devices.
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,238 | 🐛 80 | 🌐 C++ | 📅 2026-08-13 - C-based/Cached/Core Computer Vision Library, A Modern Computer Vision Library.
...
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,364 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,574 | 🐛 1,553 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind. \[DEEP LEARNING]
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,654 | 🐛 420 | 🌐 C++ | 📅 2026-08-14 - A parallelized optimized general purpose gradient boosting library.
* [Opik](https://www.comet.com/site/products/opik/) - Open source engineering platform to debug, evaluate, and monitor your LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards. ([Source Code](https://github.com/comet-ml/opik/) ⭐ 21,388 | 🐛 190 | 🌐 Python | 📅 2026-08-14)
...
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,683 | 🐛 512 | 🌐 C++ | 📅 2026-08-14 - Microsoft's fast, distributed, high performance gradient boosting (GBDT, GBRT, GBM or MART) framework based on decision tree algorithms, used for ranking, classification and many other machine learning tasks.
...
* [PyCaret](https://github.com/pycaret/pycaret) ⭐ 9,834 | 🐛 32 | 🌐 Python | 📅 2026-07-23 - An open-source, low-code machine learning library in Python that automates machine learning workflows.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,065 | 🐛 719 | 🌐 C++ | 📅 2026-08-14 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, contains fast inference implementation and supports CPU and GPU (even multi-GPU) computation.
* [Vowpal Wabbit (VW)](https://github.com/VowpalWabbit/vowpal_wabbit) ⭐ 8,701 | 🐛 3 | 🌐 C++ | 📅 2026-07-15 - A fast out-of-core learning system.
...
* [Featuretools](https://github.com/featuretools/featuretools) ⭐ 7,662 | 🐛 168 | 🌐 Python | 📅 2026-07-27 - A library for automated feature engineering. It excels at transforming transactional and relational datasets into feature matrices for machine learning using reusable feature engineering "primitives".
* [Feast](https://github.com/gojek/feast) ⭐ 7,208 | 🐛 399 | 🌐 Python | 📅 2026-08-14 - A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.
...
* [Warp-CTC](https://github.com/baidu-research/warp-ctc) ⭐ 4,069 | 🐛 90 | 🌐 Cuda | 📅 2024-03-04 - A fast parallel implementation of Connectionist Temporal Classification (CTC), on both CPU and GPU.
* [oneDNN](https://github.com/oneapi-src/oneDNN) ⭐ 4,037 | 🐛 194 | 🌐 C++ | 📅 2026-08-14 - An open-source cross-platform performance library for deep learning applications.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,718 | 🐛 126 | 🌐 MDX | 📅 2026-08-11 - A platform for reproducible and scalable machine learning and deep learning.
* [DyNet](https://github.com/clab/dynet) ⭐ 3,434 | 🐛 233 | 🌐 C++ | 📅 2023-12-01 - A dynamic neural network library working well with networks that have dynamic structures that change for every training instance. Written in C++ with bindings in Python.
* [xLearn](https://github.com/aksnzhy/xlearn) ⭐ 3,092 | 🐛 194 | 🌐 C++ | 📅 2023-08-28 - A high performance, easy-to-use, and scalable machine learning package, which can be used to solve large-scale machine learning problems. xLearn is especially useful for solving machine learning problems on large-scale sparse data, which is very common in Internet services such as online advertising and recommender systems.
* [Shogun](https://github.com/shogun-toolbox/shogun) ⭐ 3,080 | 🐛 424 | 🌐 C++ | 📅 2023-12-19 - The Shogun Machine Learning Toolbox.
* [DeepDetect](https://github.com/jolibrain/deepdetect) ⭐ 2,551 | 🐛 98 | 🌐 C++ | 📅 2026-08-13 - A machine learning API and server written in C++11. It makes state of the art machine learning easy to work with and integrate into existing applications.
* [nndeploy](https://github.com/nndeploy/nndeploy) ⭐ 1,861 | 🐛 24 | 🌐 C++ | 📅 2026-08-03 - An Easy-to-Use and High-Performance AI deployment framework.
...
* [Hopsworks](https://github.com/logicalclocks/hopsworks) ⭐ 1,302 | 🐛 16 | 🌐 Java | 📅 2025-02-10 - A data-intensive platform for AI with the industry's first open-source feature store. The Hopsworks Feature Store provides both a feature warehouse for training and batch based on Apache Hive and a feature serving database, based on MySQL Cluster, for online applications.
...
* [Intel® oneAPI Data Analytics Library](https://github.com/oneapi-src/oneDAL) ⭐ 651 | 🐛 92 | 🌐 C++ | 📅 2026-08-14 - A high performance software library developed by Intel and optimized for Intel's architectures. Library provides algorithmic building blocks for all stages of data analytics and allows to process data in batch, online and distributed modes.
...
* [XAD](https://github.com/auto-differentiation/XAD) ⭐ 426 | 🐛 8 | 🌐 C++ | 📅 2026-07-05 - Comprehensive backpropagation tool for C++.
...
* [MCGrad](https://github.com/facebookincubator/MCGrad/) ⭐ 44 | 🐛 14 | 🌐 Jupyter Notebook | 📅 2026-08-13 - A production-ready library for multicalibration, fairness, and bias correction in machine learning models.
...
* [Ombre](https://github.com/pypl0/Ombre) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-05-01 - Open source AI infrastructure layer. Eight agents run automatically: security, caching, memory, hallucination detection, and tamper-proof audit trail. Runs locally.
  * [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 305 | 🐛 20 | 🌐 Fortran | 📅 2026-06-25 - A general-purpose library with C/C++ interface for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* * [Agentic Context Engine](https://github.com/kayba-ai/agentic-context-engine) ⭐ 2,551 | 🐛 12 | 🌐 Python | 📅 2026-07-08 -In-context learning framework that allows agents to learn from execution feedback.
...
* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,025 | 🐛 4 | 🌐 C++ | 📅 2026-08-14 - A C++ library for unsupervised text tokenization and detokenization, widely used in modern NLP models.
...
* [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,458 | 🐛 261 | 🌐 Shell | 📅 2025-09-22 - Kaldi is a toolkit for speech recognition written in C++ and licensed under the Apache License v2.0. Kaldi is intended for use by speech recognition researchers.
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,056 | 🐛 600 | 🌐 Jupyter Notebook | 📅 2026-08-09 - An offline speech recognition toolkit with C++ support, designed for low-resource devices and multiple languages.
...
* [RLtools](https://github.com/rl-tools/rl-tools) ⭐ 1,023 | 🐛 20 | 🌐 C++ | 📅 2026-07-04 - The fastest deep reinforcement learning library for continuous control, implemented header-only in pure, dependency-free C++ (Python bindings available as well).
...
* [mgl](https://github.com/melisgl/mgl/) ⭐ 649 | 🐛 6 | 🌐 Common Lisp | 📅 2026-06-27 - Neural networks (boltzmann machines, feed-forward and recurrent nets), Gaussian Processes.
...
* [Deep Diamond](https://github.com/uncomplicate/deep-diamond) ⭐ 467 | 🐛 2 | 🌐 Clojure | 📅 2026-08-01 - A fast Clojure Tensor & Deep Learning library
...
* [tech.ml.dataset](https://github.com/techascent/tech.ml.dataset) ⭐ 757 | 🐛 32 | 🌐 Clojure | 📅 2026-06-11 - Clojure dataframe library and pipeline for data processing and machine learning
* [PigPen](https://github.com/Netflix/PigPen) ⭐ 564 | 🐛 19 | 🌐 Clojure | 📅 2023-04-10 - Map-Reduce for Clojure.
* [Tablecloth](https://github.com/scicloj/tablecloth) ⭐ 368 | 🐛 48 | 🌐 Clojure | 📅 2026-08-05 - A dataframe grammar wrapping tech.ml.dataset, inspired by several R libraries
...
* [Libpython-clj](https://github.com/clj-python/libpython-clj) ⭐ 1,205 | 🐛 37 | 🌐 Clojure | 📅 2026-08-10 - Interop with Python
...
* [fastmath](https://github.com/generateme/fastmath) ⭐ 286 | 🐛 34 | 🌐 Clojure | 📅 2026-07-20 - A collection of functions for mathematical and statistical computing, macine learning, etc., wrapping several JVM libraries
...
* [neural-fortran](https://github.com/modern-fortran/neural-fortran) ⭐ 473 | 🐛 41 | 🌐 Fortran | 📅 2026-03-04 - A parallel neural net microframework.
...
* [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 305 | 🐛 20 | 🌐 Fortran | 📅 2026-06-25 - A general-purpose Fortran library for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* [sentences](https://github.com/neurosnap/sentences) ⭐ 473 | 🐛 5 | 🌐 Go | 📅 2024-02-28 - Golang implementation of Punkt sentence tokenizer.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,922 | 🐛 124 | 🌐 Go | 📅 2024-08-12 - Deep learning in Go.
...
* [goml](https://github.com/cdipaolo/goml) ⭐ 1,614 | 🐛 4 | 🌐 Go | 📅 2022-07-15 - Machine learning library written in pure Go.
* [eaopt](https://github.com/MaxHalford/eaopt) ⭐ 906 | 🐛 8 | 🌐 Go | 📅 2025-01-27 - An evolutionary optimization library.
* [bayesian](https://github.com/jbrukh/bayesian) ⭐ 814 | 🐛 0 | 🌐 Go | 📅 2025-12-07 - Naive Bayesian Classification for Golang. **\[Deprecated]**
* [Cloudforest](https://github.com/ryanbressler/CloudForest) ⭐ 747 | 🐛 34 | 🌐 Go | 📅 2022-02-05 - Ensembles of decision trees in Go/Golang. **\[Deprecated]**
* [gobrain](https://github.com/goml/gobrain) ⭐ 568 | 🐛 1 | 🌐 Go | 📅 2020-12-12 - Neural Networks written in Go.
* [leaves](https://github.com/dmitryikh/leaves) ⭐ 482 | 🐛 37 | 🌐 Go | 📅 2024-07-03 - A pure Go implementation of the prediction part of GBRTs, including XGBoost and LightGBM.
...
* [go-ml-benchmarks](https://github.com/nikolaydubina/go-ml-benchmarks) ⭐ 34 | 🐛 6 | 🌐 Go | 📅 2026-08-02 — benchmarks of machine learning inference for Go.
...
* [gogeo](https://github.com/golang/geo) ⭐ 1,848 | 🐛 37 | 🌐 Go | 📅 2026-08-10 - Spherical geometry in Go.
* [go-geom](https://github.com/twpayne/go-geom) ⭐ 971 | 🐛 9 | 🌐 Go | 📅 2026-05-14 - Go library to handle geometries.
...
* [SVGo](https://github.com/ajstarks/svgo) ⭐ 2,248 | 🐛 16 | 🌐 Go | 📅 2022-12-09 - The Go Language library for SVG generation.
* [globe](https://github.com/mmcloughlin/globe) ⭐ 1,594 | 🐛 6 | 🌐 Go | 📅 2024-02-09 - Globe wireframe visualization.
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) ⭐ 1,290 | 🐛 18 | 🌐 Go | 📅 2022-04-02 - Dataframes for machine-learning and statistics (similar to pandas).
...
* [GoCV](https://github.com/hybridgroup/gocv) ⭐ 7,485 | 🐛 352 | 🌐 Go | 📅 2026-05-28 - Package for computer vision using OpenCV 4 and beyond.

<a name="go-reinforcement-learning"></a>

#### Reinforcement learning

* [stable-baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 13,690 | 🐛 88 | 🌐 Python | 📅 2026-07-25 - PyTorch implementations of Stable Baselines (deep) reinforcement learning algorithms.
...
* [HLearn](https://github.com/mikeizbicki/HLearn) ⭐ 1,661 | 🐛 23 | 🌐 Haskell | 📅 2016-05-29 - a suite of libraries for interpreting machine learning models according to their algebraic structure. **\[Deprecated]**
* [DNNGraph](https://github.com/ajtulloch/dnngraph) ⭐ 709 | 🐛 9 | 🌐 Haskell | 📅 2015-12-07 - A DSL for deep neural networks. **\[Deprecated]**
* [LambdaNet](https://github.com/jbarrow/LambdaNet) ⭐ 384 | 🐛 5 | 🌐 Haskell | 📅 2016-03-25 - Configurable Neural Networks in Haskell. **\[Deprecated]**
...
* [Twitter Text Java](https://github.com/twitter/twitter-text/tree/master/java) ⭐ 3,139 | 🐛 93 | 🌐 HTML | 📅 2024-04-26 - A Java implementation of Twitter's text processing library.
...
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,503 | 🐛 2,880 | 🌐 Jupyter Notebook | 📅 2026-08-14 - ML engine that supports distributed learning on Hadoop, Spark or your laptop via APIs in R, Python, Scala, REST/JSON.
* [aerosolve](https://github.com/airbnb/aerosolve) ⭐ 4,809 | 🐛 10 | 🌐 Scala | 📅 2025-11-06 - A machine learning library by Airbnb designed from the ground up to be human friendly.
* [Mahout](https://github.com/apache/mahout) ⭐ 2,301 | 🐛 91 | 🌐 Rust | 📅 2026-08-08 - Distributed machine learning.
...
* [SystemML](https://github.com/apache/systemml) ⭐ 1,098 | 🐛 92 | 🌐 Java | 📅 2026-08-14 - flexible, scalable machine learning (ML) language.
...
* [Chips-n-Salsa](https://github.com/cicirello/Chips-n-Salsa) ⭐ 77 | 🐛 2 | 🌐 Java | 📅 2026-08-11 - A Java library for genetic algorithms, evolutionary computation, and stochastic local search, with a focus on self-adaptation / self-tuning, as well as parallel execution.
...
* [Spark](https://github.com/apache/spark) ⭐ 43,873 | 🐛 452 | 🌐 Scala | 📅 2026-08-14 - Spark is a fast and general engine for large-scale data processing.
* [Hadoop](https://github.com/apache/hadoop) ⭐ 15,630 | 🐛 205 | 🌐 Java | 📅 2026-08-13 - Hadoop/HDFS.
...
* [Deeplearning4j](https://github.com/deeplearning4j/deeplearning4j) ⭐ 14,244 | 🐛 55 | 🌐 Java | 📅 2026-08-14 - Scalable deep learning for industry with parallel GPUs.
* [deepjavalibrary/djl](https://github.com/deepjavalibrary/djl) ⭐ 4,839 | 🐛 223 | 🌐 Java | 📅 2026-08-01 - Deep Java Library (DJL) is an open-source, high-level, engine-agnostic Java framework for deep learning, designed to be easy to get started with and simple to use for Java developers.
...
* [nlp.js](https://github.com/axa-group/nlp.js) ⭐ 6,582 | 🐛 114 | 🌐 JavaScript | 📅 2025-01-09 - An NLP library built in node over Natural, with entity extraction, sentiment analysis, automatic language identify, and so more.
* [Knwl.js](https://github.com/loadfive/Knwl.js) ⭐ 5,254 | 🐛 13 | 🌐 JavaScript | 📅 2023-09-28 - A Natural Language Processor in JS.
...
* [science.js](https://github.com/jasondavies/science.js/) ⭐ 898 | 🐛 13 | 🌐 JavaScript | 📅 2026-03-06 - Scientific and statistical computing in JavaScript. **\[Deprecated]**
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,351 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-14 - Visualizer for machine learning models.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Brain.js](https://github.com/BrainJS/brain.js) ⭐ 14,866 | 🐛 90 | 🌐 TypeScript | 📅 2024-09-26 - Neural networks in JavaScript - continued community fork of [Brain](https://github.com/harthur/brain) ⚠️ Archived.
* [Brain](https://github.com/harthur/brain) ⚠️ Archived - Neural networks in JavaScript **\[Deprecated]**
* [Synaptic](https://github.com/cazala/synaptic) ⭐ 6,914 | 🐛 162 | 🌐 JavaScript | 📅 2026-08-01 - Architecture-free neural network library for Node.js and the browser.
* [ml5](https://github.com/ml5js/ml5-library) ⭐ 6,587 | 🐛 287 | 🌐 JavaScript | 📅 2024-10-11 - Friendly machine learning for the web!
...
* [ml.js](https://github.com/mljs/ml) ⭐ 2,715 | 🐛 27 | 🌐 JavaScript | 📅 2024-10-21 - Machine learning and numerical analysis tools for Node.js and the Browser!
* [WebDNN](https://github.com/mil-tokyo/webdnn) ⭐ 1,999 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-28 - Fast Deep Neural Network JavaScript Framework. WebDNN uses next generation JavaScript API, WebGPU for GPU execution, and WebAssembly for CPU execution.
* [Auto ML](https://github.com/ClimbsRocks/auto_ml) ⭐ 1,654 | 🐛 187 | 🌐 Python | 📅 2021-02-10 - Automated machine learning, data formatting, ensembling, and hyperparameter optimization for competitions and exploration- just give it a .csv file! **\[Deprecated]**
* [machinelearn.js](https://github.com/machinelearnjs/machinelearnjs) ⭐ 539 | 🐛 33 | 🌐 TypeScript | 📅 2026-02-07 - Machine Learning library for the web, Node.js and developers
* [Pavlov.js](https://github.com/NathanEpstein/Pavlov.js) ⭐ 497 | 🐛 0 | 🌐 C++ | 📅 2018-04-14 - Reinforcement learning using Markov Decision Processes.
* [DN2A](https://github.com/antoniodeluca/dn2a.js) ⭐ 464 | 🐛 6 | 🌐 TypeScript | 📅 2023-10-07 - Digital Neural Networks Architecture. **\[Deprecated]**
...
* [tensor-js](https://github.com/Hoff97/tensorjs) ⭐ 37 | 🐛 3 | 🌐 TypeScript | 📅 2021-04-07 - A deep learning library for the browser, accelerated by WebGL and WebAssembly.
...
* [Creatify MCP](https://github.com/TSavo/creatify-mcp) ⭐ 22 | 🐛 3 | 🌐 TypeScript | 📅 2025-05-26 - Model Context Protocol server that exposes Creatify AI's video generation capabilities to AI assistants, enabling natural language video creation workflows.
...
* [Kandle](https://github.com/final-kk/kandle) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-30 - A JavaScript Native PyTorch-aligned Machine Learning Framework, built from scratch on WebGPU.
...
* [stdlib](https://github.com/stdlib-js/stdlib) ⭐ 5,929 | 🐛 1,329 | 🌐 JavaScript | 📅 2026-08-14 - A standard library for JavaScript and Node.js, with an emphasis on numeric computing. The library provides a collection of robust, high performance libraries for mathematics, statistics, streams, utilities, and more.
* [simple-statistics](https://github.com/simple-statistics/simple-statistics) ⭐ 3,517 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-14 - A JavaScript implementation of descriptive, regression, and inference statistics. Implemented in literate JavaScript with no dependencies, designed to work in all modern browsers (including IE) as well as in Node.js.
* [Pipcook](https://github.com/alibaba/pipcook) ⭐ 2,595 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-14 - A JavaScript application framework for machine learning and its engineering.
...
* [The Bot](https://github.com/sta-ger/TheBot) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2018-07-04 - Example of how the neural network learns to predict the angle between two points created with [Synaptic](https://github.com/cazala/synaptic) ⭐ 6,914 | 🐛 162 | 🌐 JavaScript | 📅 2026-08-01.
* [Half Beer](https://github.com/sta-ger/HalfBeer) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2018-06-26 - Beer glass classifier created with [Synaptic](https://github.com/cazala/synaptic) ⭐ 6,914 | 🐛 162 | 🌐 JavaScript | 📅 2026-08-01.
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [MLJ](https://github.com/alan-turing-institute/MLJ.jl) ⭐ 1,934 | 🐛 88 | 🌐 Julia | 📅 2026-08-03 - A Julia machine learning framework.
* [Knet](https://github.com/denizyuret/Knet.jl) ⭐ 1,433 | 🐛 153 | 🌐 Jupyter Notebook | 📅 2024-11-15 - Koç University Deep Learning Framework.
...
* [GLM](https://github.com/JuliaStats/GLM.jl) ⭐ 636 | 🐛 82 | 🌐 Julia | 📅 2026-06-23 - Generalized linear models in Julia.
...
* [Mixed Models](https://github.com/dmbates/MixedModels.jl) ⭐ 449 | 🐛 56 | 🌐 Julia | 📅 2026-08-13 - A Julia package for fitting (statistical) mixed-effects models.
* [MultivariateStats](https://github.com/JuliaStats/MultivariateStats.jl) ⭐ 387 | 🐛 56 | 🌐 Julia | 📅 2026-06-23 - Methods for dimensionality reduction.
...
* [Gaussian Processes](https://github.com/STOR-i/GaussianProcesses.jl) ⭐ 320 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2026-06-10 - Julia package for Gaussian processes.
* [XGBoost](https://github.com/dmlc/XGBoost.jl) ⭐ 306 | 🐛 32 | 🌐 Julia | 📅 2026-05-15 - eXtreme Gradient Boosting Package in Julia.
...
* [Kernel Density](https://github.com/JuliaStats/KernelDensity.jl) ⭐ 208 | 🐛 35 | 🌐 Julia | 📅 2026-06-22 - Kernel density estimators for Julia.
...
* [Word Tokenizers](https://github.com/JuliaText/WordTokenizers.jl) ⭐ 99 | 🐛 12 | 🌐 Julia | 📅 2021-12-30 - Tokenizers for Natural Language Processing in Julia
...
* [Languages](https://github.com/JuliaText/Languages.jl) ⭐ 58 | 🐛 7 | 🌐 Julia | 📅 2025-10-25 - Julia package for working with various human languages
...
* [Gadfly](https://github.com/GiovineItalia/Gadfly.jl) ⭐ 1,927 | 🐛 277 | 🌐 Julia | 📅 2025-10-04 - Crafty statistical graphics for Julia.
* [DataFrames](https://github.com/JuliaData/DataFrames.jl) ⭐ 1,831 | 🐛 160 | 🌐 Julia | 📅 2026-08-12 - library for working with tabular data in Julia.
* [Distributions](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,197 | 🐛 474 | 🌐 Julia | 📅 2026-08-03 - A Julia package for probability distributions and associated functions.
...
* [Hypothesis Tests](https://github.com/JuliaStats/HypothesisTests.jl) ⭐ 317 | 🐛 91 | 🌐 Julia | 📅 2026-06-23 - Hypothesis tests for Julia.
* [RDataSets](https://github.com/johnmyleswhite/RDatasets.jl) ⭐ 167 | 🐛 22 | 🌐 R | 📅 2026-06-24 - Julia package for loading many of the data sets available in R.
* [Stats](https://github.com/JuliaStats/StatsKit.jl) ⭐ 143 | 🐛 3 | 🌐 Julia | 📅 2022-10-17 - Statistical tests for Julia.
* [Data Read](https://github.com/queryverse/ReadStat.jl) ⭐ 79 | 🐛 11 | 🌐 Julia | 📅 2023-12-29 - Read files from Stata, SAS, and SPSS.
...
* [DSP](https://github.com/JuliaDSP/DSP.jl) ⭐ 422 | 🐛 83 | 🌐 Julia | 📅 2026-08-07 - Digital Signal Processing (filtering, periodograms, spectrograms, window functions).
* [SignalProcessing](https://github.com/JuliaDSP/DSP.jl) ⭐ 422 | 🐛 83 | 🌐 Julia | 📅 2026-08-07 - Signal Processing tools for Julia.
...
* [KotlinDL](https://github.com/JetBrains/KotlinDL) ⭐ 1,574 | 🐛 81 | 🌐 Kotlin | 📅 2024-05-31 - Deep learning framework written in Kotlin.
...
* [Torch7](http://torch.ch/)
  * [wav2letter](https://github.com/facebookresearch/wav2letter) ⭐ 6,439 | 🐛 107 | 🌐 C++ | 📅 2026-07-14 - a simple and efficient end-to-end Automatic Speech Recognition (ASR) system from Facebook AI Research.
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,574 | 🐛 1,553 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [MXNet](https://github.com/apache/incubator-mxnet/) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
...
* [Machine Learning in MatLab/Octave](https://github.com/trekhleb/machine-learning-octave) ⭐ 895 | 🐛 0 | 🌐 MATLAB | 📅 2025-11-23 - Examples of popular machine learning algorithms (neural networks, linear/logistic regressions, K-Means, etc.) with code examples and mathematics behind them being explained.
...
* [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 305 | 🐛 20 | 🌐 Fortran | 📅 2026-06-25 - A general-purpose MATLAB library for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,346 | 🐛 1,008 | 🌐 C# | 📅 2026-08-13 - ML.NET is a cross-platform open-source machine learning framework which makes machine learning accessible to .NET developers. ML.NET was originally developed in Microsoft Research and evolved into a significant framework over the last decade and is used across many product groups in Microsoft like Windows, Bing, PowerPoint, Excel and more.
* [GeneticSharp](https://github.com/giacomelli/GeneticSharp) ⭐ 1,370 | 🐛 12 | 🌐 C# | 📅 2025-11-13 - Multi-platform genetic algorithm library for .NET Core and .NET Framework. The library has several implementations of GA operators, like: selection, crossover, mutation, reinsertion and termination.
...
* [MLPNeuralNet](https://github.com/nikolaypavlov/MLPNeuralNet) ⭐ 899 | 🐛 1 | 🌐 Objective-C | 📅 2016-09-30 - Fast multilayer perceptron neural network library for iOS and Mac OS X. MLPNeuralNet predicts new examples by trained neural networks. It is built on top of the Apple's Accelerate Framework, using vectorized operations and hardware acceleration if available. **\[Deprecated]**
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,432 | 🐛 2,753 | 🌐 C++ | 📅 2026-08-14 - A OpenSource Computer Vision Library
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,652 | 🐛 830 | 🌐 Python | 📅 2026-06-25 - Face recognition library that recognizes and manipulates faces from Python or from the command line.
* [timm](https://github.com/rwightman/pytorch-image-models) ⭐ 37,066 | 🐛 61 | 🌐 Python | 📅 2026-08-11 - PyTorch image models, scripts, pretrained weights -- ResNet, ResNeXT, EfficientNet, EfficientNetV2, NFNet, Vision Transformer, MixNet, MobileNet-V3/V2, RegNet, DPN, CSPNet, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,665 | 🐛 586 | 🌐 Python | 📅 2026-07-24 - FAIR's next-generation research platform for object detection and segmentation. It is a ground-up rewrite of the previous version, Detectron, and is powered by the PyTorch deep learning framework.
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,364 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
* [MLX](https://github.com/ml-explore/mlx) ⭐ 27,951 | 🐛 177 | 🌐 C++ | 📅 2026-08-14- MLX is an array framework for machine learning on Apple silicon, developed by Apple machine learning research.
...
* [deepface](https://github.com/serengil/deepface) ⭐ 23,282 | 🐛 10 | 🌐 Python | 📅 2026-08-14 - A lightweight face recognition and facial attribute analysis (age, gender, emotion and race) framework for Python covering cutting-edge models such as VGG-Face, FaceNet, OpenFace, DeepFace, DeepID, Dlib and ArcFace.
...
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,691 | 🐛 81 | 🌐 Python | 📅 2026-08-14 - A PyTorch-based toolkit that offers pre-trained segmentation models for computer vision tasks. It simplifies the development of image segmentation applications by providing a collection of popular architecture implementations, such as UNet and PSPNet, along with pre-trained weights, making it easier for researchers and developers to achieve high-quality pixel-level object segmentation in images.
* [Exadel CompreFace](https://github.com/exadel-inc/CompreFace) ⭐ 8,231 | 🐛 235 | 🌐 Java | 📅 2024-10-05 - face recognition system that can be easily integrated into any system without prior machine learning skills. CompreFace provides REST API for face recognition, face verification, face detection, face mask detection, landmark detection, age, and gender recognition and is easily deployed with docker.
* [Scikit-Opt](https://github.com/guofei9987/scikit-opt) ⭐ 6,700 | 🐛 72 | 🌐 Python | 📅 2026-03-25 - Swarm Intelligence in Python (Genetic Algorithm, Particle Swarm Optimization, Simulated Annealing, Ant Colony Algorithm, Immune Algorithm, Artificial Fish Swarm Algorithm in Python)
* [Scikit-Image](https://github.com/scikit-image/scikit-image) ⭐ 6,573 | 🐛 939 | 🌐 Python | 📅 2026-08-04 - A collection of algorithms for image processing in Python.
* [pytessarct](https://github.com/madmaze/pytesseract) ⭐ 6,381 | 🐛 21 | 🌐 Python | 📅 2026-07-13 - Python-tesseract is an optical character recognition (OCR) tool for python. That is, it will recognize and "read" the text embedded in images. Python-tesseract is a wrapper for [Google's Tesseract-OCR Engine](https://github.com/tesseract-ocr/tesseract) ⭐ 75,918 | 🐛 486 | 🌐 C++ | 📅 2026-08-14.
* [segmentation\_models](https://github.com/qubvel/segmentation_models) ⭐ 4,927 | 🐛 274 | 🌐 Python | 📅 2024-08-21 - A TensorFlow Keras-based toolkit that offers pre-trained segmentation models for computer vision tasks. It simplifies the development of image segmentation applications by providing a collection of popular architecture implementations, such as UNet and PSPNet, along with pre-trained weights, making it easier for researchers and developers to achieve high-quality pixel-level object segmentation in images.
...
* [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,793 | 🐛 96 | 🌐 Python | 📅 2026-08-14 - Lightly is a computer vision framework for self-supervised learning.
* [computer-vision-in-action](https://github.com/Charmve/computer-vision-in-action) ⭐ 2,856 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-05-27 - as known as `L0CV`, is a new generation of computer vision open source online learning media, a cross-platform interactive learning framework integrating graphics, source code and HTML. the L0CV ecosystem — Notebook, Datasets, Source Code, and from Diving-in to Advanced — as well as the L0CV Hub.
* [retinaface](https://github.com/serengil/retinaface) ⭐ 2,023 | 🐛 1 | 🌐 Python | 📅 2026-06-01 - deep learning based cutting-edge facial detector for Python coming with facial landmarks
* [PCV](https://github.com/jesolem/PCV) ⭐ 1,960 | 🐛 26 | 🌐 Python | 📅 2020-12-28 - Open source Python module for computer vision. **\[Deprecated]**
* [LightlyTrain](https://github.com/lightly-ai/lightly-train) ⭐ 1,641 | 🐛 66 | 🌐 Python | 📅 2026-08-14 - Pretrain computer vision models on unlabeled data for industrial applications
...
* [Lucent](https://github.com/greentfrapp/lucent) ⭐ 664 | 🐛 22 | 🌐 Python | 📅 2025-03-21 - Tensorflow and OpenAI Clarity's Lucid adapted for PyTorch.
* [Detecto](https://github.com/alankbi/detecto) ⭐ 627 | 🐛 48 | 🌐 Python | 📅 2024-07-25 - Train and run a computer vision model with 5-10 lines of code.
* [Vigranumpy](https://github.com/ukoethe/vigra) ⭐ 442 | 🐛 99 | 🌐 C++ | 📅 2026-04-25 - Python bindings for the VIGRA C++ computer vision library.
* [joliGEN](https://github.com/jolibrain/joliGEN) ⭐ 288 | 🐛 38 | 🌐 Python | 📅 2026-08-11 - Generative AI Image Toolset with GANs and Diffusion for Real-World Applications.
...
* [neural-dream](https://github.com/ProGamerGov/neural-dream) ⭐ 146 | 🐛 10 | 🌐 Python | 📅 2021-09-29 - A PyTorch implementation of DeepDream.
* [Learnergy](https://github.com/gugarosa/learnergy) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2026-05-01 - Energy-based machine learning models built upon PyTorch.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,106 | 🐛 2,381 | 🌐 Python | 📅 2026-08-14 - A deep learning library containing thousands of pre-trained models on different tasks. The goto place for anything related to Large Language Models.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 35,112 | 🐛 700 | 🌐 Python | 📅 2024-08-21 - Chinese Words Segmentation Utilities.
* [spaCy](https://github.com/explosion/spaCy) ⭐ 33,819 | 🐛 232 | 🌐 Python | 📅 2026-08-07 - Industrial strength NLP with Python and Cython.
* [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,210 | 🐛 99 | 🌐 Python | 📅 2026-08-14 - A framework for building industrial-strength applications with Transformer models and LLMs.
* [CometLLM](https://github.com/comet-ml/comet-llm) ⭐ 21,388 | 🐛 190 | 🌐 Python | 📅 2026-08-14 - Track, log, visualize and evaluate your LLM prompts and prompt chains.
* [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,297 | 🐛 153 | 🌐 Python | 📅 2026-07-24 - A "machine learning framework to automate text-and voice-based conversations."
...
* [DeepPavlov](https://github.com/deepmipt/DeepPavlov/) ⭐ 6,993 | 🐛 57 | 🌐 Python | 📅 2025-08-06 - conversational AI library with many pre-trained Russian NLP models.
* [pkuseg-python](https://github.com/lancopku/pkuseg-python) ⭐ 6,711 | 🐛 135 | 🌐 Python | 📅 2022-11-05 - A better version of Jieba, developed by Peking University.
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,633 | 🐛 44 | 🌐 Python | 📅 2020-01-19 - A library for processing Chinese text.
* [Dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,499 | 🐛 90 | 🌐 Python | 📅 2025-07-29 - A python library for accurate and scalable fuzzy matching, record deduplication and entity-resolution.
* [DrQA](https://github.com/facebookresearch/DrQA) ⚠️ Archived - Reading Wikipedia to answer open-domain questions.
* [Snips NLU](https://github.com/snipsco/snips-nlu) ⭐ 3,972 | 🐛 67 | 🌐 Python | 📅 2023-05-22 - Natural Language Understanding library for intent classification and entity extraction
...
* [jellyfish](https://github.com/jamesturk/jellyfish) ⭐ 2,229 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-07-24 - a python library for doing approximate and phonetic matching of strings.
* [NeuroNER](https://github.com/Franck-Dernoncourt/NeuroNER) ⭐ 1,722 | 🐛 91 | 🌐 Python | 📅 2023-03-24 - Named-entity recognition using neural networks providing state-of-the-art-results
* [Quepy](https://github.com/machinalis/quepy) ⭐ 1,266 | 🐛 28 | 🌐 Python | 📅 2020-12-29 - A python framework to transform natural language questions to queries in a database query language.
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) ⭐ 1,046 | 🐛 22 | 🌐 Rust | 📅 2026-08-14 - The simplest way to run an LLM locally. Supports tool calling and grammar constrained sampling.
* [CLTK](https://github.com/cltk/cltk) ⭐ 916 | 🐛 5 | 🌐 Python | 📅 2026-08-01 - The Classical Language Toolkit.
* [BigARTM](https://github.com/bigartm/bigartm) ⭐ 675 | 🐛 136 | 🌐 C++ | 📅 2026-02-05 - topic modelling platform.
* [stanford-corenlp-python](https://github.com/dasmith/stanford-corenlp-python) ⭐ 610 | 🐛 47 | 🌐 Python | 📅 2018-03-14 - Python wrapper for [Stanford CoreNLP](https://github.com/stanfordnlp/CoreNLP) ⭐ 10,104 | 🐛 182 | 🌐 Java | 📅 2026-06-28 **\[Deprecated]**
* [DL Translate](https://github.com/xhlulu/dl-translate) ⭐ 500 | 🐛 3 | 🌐 Python | 📅 2024-09-02 - A deep learning-based translation library between 50 languages, built with `transformers`.
...
* [VeritasGraph](https://github.com/bibinprathap/VeritasGraph) ⭐ 311 | 🐛 1 | 🌐 Python | 📅 2026-08-13 - Enterprise-Grade Graph RAG for Secure, On-Premise AI with Verifiable Attribution.
...
* [colibri-core](https://github.com/proycon/colibri-core) ⭐ 132 | 🐛 9 | 🌐 C++ | 📅 2026-02-05 - Python binding to C++ library for extracting and working with basic linguistic constructions such as n-grams and skipgrams in a quick and memory-efficient way.
...
* [python-frog](https://github.com/proycon/python-frog) ⭐ 50 | 🐛 6 | 🌐 Cython | 📅 2026-02-02 - Python binding to Frog, an NLP suite for Dutch. (pos tagging, lemmatisation, dependency parsing, NER)
...
* [python-ucto](https://github.com/proycon/python-ucto) ⭐ 32 | 🐛 5 | 🌐 Cython | 📅 2026-02-02 - Python binding to ucto (a unicode-aware rule-based tokenizer for various languages).
* [NALP](https://github.com/gugarosa/nalp) ⭐ 25 | 🐛 2 | 🌐 Python | 📅 2026-01-01 - A Natural Adversarial Language Processing framework built over Tensorflow.
...
* [TensorFlow](https://github.com/tensorflow/tensorflow/) ⭐ 197,026 | 🐛 2,850 | 🌐 C++ | 📅 2026-08-14 - Open source software library for numerical computation using data flow graphs.
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,374 | 🐛 17,302 | 🌐 Python | 📅 2026-08-14 - Tensors and Dynamic neural networks in Python with strong GPU acceleration
* [keras](https://github.com/keras-team/keras) ⭐ 64,227 | 🐛 216 | 🌐 Python | 📅 2026-08-14 - High-level neural networks frontend for [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,026 | 🐛 2,850 | 🌐 C++ | 📅 2026-08-14, [CNTK](https://github.com/Microsoft/CNTK) ⚠️ Archived and [Theano](https://github.com/Theano/Theano) ⭐ 9,999 | 🐛 699 | 🌐 Python | 📅 2024-01-15.
* [Streamlit](https://github.com/streamlit/streamlit) ⭐ 45,547 | 🐛 1,209 | 🌐 Python | 📅 2026-08-14: Streamlit is an framework to create beautiful data apps in hours, not weeks.
* [Gradio](https://github.com/gradio-app/gradio) ⭐ 43,364 | 🐛 182 | 🌐 Python | 📅 2026-08-14 - A Python library for quickly creating and sharing demos of models. Debug models interactively in your browser, get feedback from collaborators, and generate public links without deploying anything.
* [Colossal-AI](https://github.com/hpcaitech/ColossalAI) ⭐ 41,434 | 🐛 504 | 🌐 Python | 📅 2026-08-10: An open-source deep learning system for large-scale model training and inference with high efficiency and low cost.
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,569 | 🐛 3 | 🌐 Makefile | 📅 2026-08-13 - Open Source framework to streamline use of neural networks.
* [JAX](https://github.com/google/jax) ⭐ 36,158 | 🐛 2,577 | 🌐 Python | 📅 2026-08-14 - JAX is Autograd and XLA, brought together for high-performance machine learning research.
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,574 | 🐛 1,553 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch) ⭐ 32,463 | 🐛 77 | 🌐 Python | 📅 2023-10-15 - Implementations of Machine Learning models from scratch in Python with a focus on transparency. Aims to showcase the nuts and bolts of ML in an accessible way.
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,286 | 🐛 1,071 | 🌐 Python | 📅 2026-08-09 - The lightweight PyTorch wrapper for high-performance AI research.
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,654 | 🐛 420 | 🌐 C++ | 📅 2026-08-14 - Python bindings for eXtreme Gradient Boosting (Tree) Library.
* [Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,195 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 - Book/iPython notebooks on Probabilistic Programming in Python.
* [Fastai](https://github.com/fastai/fastai) ⭐ 28,114 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-07-30 - High-level wrapper built on the top of Pytorch which supports vision, text, tabular data and collaborative filtering.
* [PyTorch Geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,008 | 🐛 1,305 | 🌐 Python | 📅 2026-07-31 -> Graph Neural Network Library for PyTorch.
* [Microsoft Recommenders](https://github.com/Microsoft/Recommenders) ⭐ 21,851 | 🐛 176 | 🌐 Python | 📅 2026-08-10: Examples and best practices for building recommendation systems, provided as Jupyter notebooks. The repo contains some of the latest state of the art algorithms from Microsoft Research as well as from other companies and institutions.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,388 | 🐛 190 | 🌐 Python | 📅 2026-08-14: Evaluate, trace, test, and ship LLM applications across your dev and production lifecycles.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Neural Networks and Deep Learning](https://github.com/mnielsen/neural-networks-and-deep-learning) ⭐ 17,870 | 🐛 8 | 🌐 Python | 📅 2024-06-02 - Code samples for my book "Neural Networks and Deep Learning" \[DEEP LEARNING].
...
* [gensim](https://github.com/RaRe-Technologies/gensim) ⭐ 16,480 | 🐛 436 | 🌐 Python | 📅 2025-11-01 - Topic Modelling for Humans.
* [numpy-ML](https://github.com/ddbourgin/numpy-ml) ⭐ 16,334 | 🐛 48 | 🌐 Python | 📅 2023-10-29: Reference implementations of ML models written in numpy
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,662 | 🐛 21 | 🌐 Python | 📅 2026-08-13: Optuna is an automatic hyperparameter optimization software framework, particularly designed for machine learning.
* [Annoy](https://github.com/spotify/annoy) ⭐ 14,285 | 🐛 84 | 🌐 C++ | 📅 2025-10-29 - Approximate nearest neighbours implementation.
...
* [Theano](https://github.com/Theano/Theano/) ⭐ 9,999 | 🐛 699 | 🌐 Python | 📅 2024-01-15 - Optimizing GPU-meta-programming code generating array oriented optimizing math compiler in Python.
* [PyOD](https://github.com/yzhao062/pyod) ⭐ 9,958 | 🐛 236 | 🌐 Python | 📅 2026-08-02 -> Python Outlier Detection, comprehensive and scalable Python toolkit for detecting outlying objects in multivariate data. Featured for Advanced models, including Neural Networks/Deep Learning and Outlier Ensembles.
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,937 | 🐛 21 | 🌐 Python | 📅 2026-08-14 - A Python library for secure and private Deep Learning built on PyTorch and TensorFlow.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 9,920 | 🐛 2,425 | 🌐 Python | 📅 2026-08-12 - A unified framework for machine learning with time series
...
* [einops](https://github.com/arogozhnikov/einops) ⭐ 9,573 | 🐛 39 | 🌐 Python | 📅 2026-07-05 - Deep learning operations reinvented (for pytorch, tensorflow, jax and others).
* [Hub](https://github.com/activeloopai/Hub) ⭐ 9,224 | 🐛 63 | 🌐 C++ | 📅 2026-05-21 - Fastest unstructured dataset management for TensorFlow/PyTorch. Stream & version-control data. Store even petabyte-scale data in a single numpy-like array on the cloud accessible on any machine. Visit [activeloop.ai](https://activeloop.ai) for more info.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,065 | 🐛 719 | 🌐 C++ | 📅 2026-08-14 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, well documented and supports CPU and GPU (even multi-GPU) computation.
* [pattern](https://github.com/clips/pattern) ⭐ 8,858 | 🐛 179 | 🌐 Python | 📅 2026-08-05 - Web mining module for Python.
* [BentoML](https://github.com/bentoml/bentoml) ⭐ 8,788 | 🐛 202 | 🌐 Python | 📅 2026-08-03: Toolkit for package and deploy machine learning models for serving in production
* [Cortex](https://github.com/cortexlabs/cortex) ⭐ 8,010 | 🐛 131 | 🌐 Go | 📅 2024-06-12 - Open source platform for deploying machine learning models in production.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,808 | 🐛 297 | 🌐 Jupyter Notebook | 📅 2026-08-05: Interactive reports to analyze machine learning models during validation or production monitoring.
...
* [ClearML](https://github.com/clearml/clearml) ⭐ 6,819 | 🐛 510 | 🌐 Python | 📅 2026-08-11 -  Auto-Magical CI/CD to streamline your AI workload. Experiment Management, Data Management, Pipeline, Orchestration, Scheduling & Serving in one MLOps/LLMOps solution.
* [deap](https://github.com/deap/deap) ⭐ 6,429 | 🐛 281 | 🌐 Python | 📅 2026-04-17 - Evolutionary algorithm framework.
* [NuPIC](https://github.com/numenta/nupic) ⭐ 6,351 | 🐛 465 | 🌐 Python | 📅 2024-12-03 - Numenta Platform for Intelligent Computing.
* [Aim](https://github.com/aimhubio/aim) ⭐ 6,231 | 🐛 468 | 🌐 Python | 📅 2026-08-13 -> An easy-to-use & supercharged open-source AI metadata tracker.
...
* [River](https://github.com/online-ml/river) ⭐ 5,916 | 🐛 70 | 🌐 Python | 📅 2026-08-12: A framework for general purpose online machine learning.
* [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) ⭐ 5,236 | 🐛 183 | 🌐 Scala | 📅 2026-08-14 -> A distributed machine learning framework Apache Spark
* [mlxtend](https://github.com/rasbt/mlxtend) ⭐ 5,167 | 🐛 138 | 🌐 Python | 📅 2026-08-05 - A library consisting of useful tools for data science and machine learning tasks.
...
* [Deepchecks](https://github.com/deepchecks/deepchecks) ⭐ 4,045 | 🐛 265 | 🌐 Python | 📅 2025-12-28: Validation & testing of machine learning models and data during model development, deployment, and production. This includes checks and suites related to various types of issues, such as model performance, data integrity, distribution mismatches, and more.
...
* [pomegranate](https://github.com/jmschrei/pomegranate) ⭐ 3,541 | 🐛 44 | 🌐 Python | 📅 2025-03-06 - Hidden Markov Models for Python, implemented in Cython for speed and efficiency.
* [PyBroker](https://github.com/edtechre/pybroker) ⭐ 3,504 | 🐛 2 | 🌐 Python | 📅 2026-08-11 - Algorithmic Trading with Machine Learning.
* [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,380 | 🐛 6 | 🌐 Python | 📅 2026-07-08 - High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing. Being able to research/develop something new, rather than write another regular train loop.
...
* [mljar-supervised](https://github.com/mljar/mljar-supervised) ⭐ 3,280 | 🐛 128 | 🌐 Python | 📅 2026-07-27 - An Automated Machine Learning (AutoML) python package for tabular data. It can handle: Binary Classification, MultiClass Classification and Regression. It provides explanations and markdown reports.
* [Shapash](https://github.com/MAIF/shapash) ⭐ 3,254 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-07-28 : Shapash is a Python library that provides several types of visualization that display explicit labels that everyone can understand.
* [Determined](https://github.com/determined-ai/determined) ⭐ 3,232 | 🐛 108 | 🌐 Go | 📅 2025-03-20 - Scalable deep learning training platform, including integrated support for distributed training, hyperparameter tuning, experiment tracking, and model management.
...
* [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) ⭐ 2,993 | 🐛 30 | 🌐 Python | 📅 2026-05-30 -> A temporal extension of PyTorch Geometric for dynamic graph representation learning.
* [PyBrain](https://github.com/pybrain/pybrain) ⭐ 2,857 | 🐛 156 | 🌐 Python | 📅 2024-06-27 - Another Python Machine Learning Library.
* [Pylearn2](https://github.com/lisa-lab/pylearn2) ⭐ 2,769 | 🐛 201 | 🌐 Python | 📅 2021-08-20 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano) ⭐ 9,999 | 🐛 699 | 🌐 Python | 📅 2024-01-15. **\[Deprecated]**
* [modAL](https://github.com/modAL-python/modAL) ⭐ 2,360 | 🐛 108 | 🌐 Python | 📅 2024-02-26 - A modular active learning framework for Python, built on top of scikit-learn.
* [Karate Club](https://github.com/benedekrozemberczki/karateclub) ⭐ 2,285 | 🐛 12 | 🌐 Python | 📅 2024-07-17 -> An unsupervised machine learning extension library for NetworkX with a Scikit-Learn like API.
* [Feature-engine](https://github.com/feature-engine/feature_engine) ⭐ 2,267 | 🐛 81 | 🌐 Python | 📅 2026-07-31 - Open source library with an exhaustive battery of feature engineering and selection methods based on pandas and scikit-learn.
...
* [skrub](https://github.com/skrub-data/skrub) ⭐ 1,647 | 🐛 152 | 🌐 Python | 📅 2026-08-12 - Skrub is a Python library that eases preprocessing and feature engineering for machine learning on dataframes.
...
* [skforecast](https://github.com/skforecast/skforecast) ⭐ 1,524 | 🐛 18 | 🌐 Python | 📅 2026-08-14 - Python library for time series forecasting using machine learning models. It works with any regressor compatible with the scikit-learn API, including popular options like LightGBM, XGBoost, CatBoost, Keras, and many others.
...
* [nilearn](https://github.com/nilearn/nilearn) ⭐ 1,424 | 🐛 288 | 🌐 Python | 📅 2026-08-14 - Machine learning for NeuroImaging in Python.
* [pydeep](https://github.com/andersbll/deeppy) ⭐ 1,370 | 🐛 22 | 🌐 Python | 📅 2020-12-28 - Deep Learning In Python. **\[Deprecated]**
* [Intel(R) Extension for Scikit-learn](https://github.com/intel/scikit-learn-intelex) ⭐ 1,355 | 🐛 81 | 🌐 Python | 📅 2026-08-12 - A seamless way to speed up your Scikit-learn applications with no accuracy loss and code changes.
...
* [dtaidistance](https://github.com/wannesm/dtaidistance) ⭐ 1,241 | 🐛 21 | 🌐 Python | 📅 2026-07-07 - High performance library for time series distances (DTW) and time series clustering.
...
* [Cornac](https://github.com/PreferredAI/cornac) ⭐ 1,051 | 🐛 25 | 🌐 Python | 📅 2026-08-11 - A comparative framework for multimodal recommender systems with a focus on models leveraging auxiliary data.
* [OpenMetricLearning](https://github.com/OML-Team/open-metric-learning) ⭐ 996 | 🐛 37 | 🌐 Python | 📅 2025-11-26 - A PyTorch-based framework to train and validate the models producing high-quality embeddings.
* [SimpleAI](https://github.com/simpleai-team/simpleai) ⭐ 994 | 🐛 14 | 🌐 Python | 📅 2023-11-06 Python implementation of many of the artificial intelligence algorithms described in the book "Artificial Intelligence, a Modern Approach". It focuses on providing an easy to use, well documented and tested library.
* [Restricted Boltzmann Machines](https://github.com/echen/restricted-boltzmann-machines) ⭐ 972 | 🐛 6 | 🌐 Python | 📅 2020-04-01 -Restricted Boltzmann Machines in Python. \[DEEP LEARNING]
* [Couler](https://github.com/couler-proj/couler) ⭐ 944 | 🐛 21 | 🌐 Python | 📅 2024-10-08 - Unified interface for constructing and managing machine learning workflows on different workflow engines, such as Argo Workflows, Tekton Pipelines, and Apache Airflow.
...
* [PyTorch Frame](https://github.com/pyg-team/pytorch-frame) ⭐ 796 | 🐛 23 | 🌐 Python | 📅 2026-08-03 -> A Modular Framework for Multi-Modal Tabular Learning.
* [ChemicalX](https://github.com/AstraZeneca/chemicalx) ⭐ 783 | 🐛 9 | 🌐 Python | 📅 2023-09-11 -> A PyTorch based deep learning library for drug pair scoring
...
* [FEDOT](https://github.com/nccr-itmo/FEDOT) ⭐ 709 | 🐛 81 | 🌐 Python | 📅 2026-08-14: An AutoML framework for the automated design of composite modelling pipelines. It can handle classification, regression, and time series forecasting tasks on different types of data (including multi-modal datasets).
...
* [Opytimizer](https://github.com/gugarosa/opytimizer) ⭐ 634 | 🐛 7 | 🌐 Python | 📅 2026-05-02 - Python-based meta-heuristic optimization techniques.
...
* [Neuraxle](https://github.com/Neuraxio/Neuraxle) ⭐ 614 | 🐛 2 | 🌐 Python | 📅 2026-02-20: A framework providing the right abstractions to ease research, development, and deployment of your ML pipelines.
...
* [SKLL](https://github.com/EducationalTestingService/skll) ⭐ 561 | 🐛 21 | 🌐 Python | 📅 2025-06-12 - A wrapper around scikit-learn that makes it simpler to conduct experiments.
* [Auto\_ViML](https://github.com/AutoViML/Auto_ViML) ⭐ 549 | 🐛 0 | 🌐 Python | 📅 2025-01-30 -> Automatically Build Variant Interpretable ML models fast! Auto\_ViML is pronounced "auto vimal", is a comprehensive and scalable Python AutoML toolkit with imbalanced handling, ensembling, stacking and built-in feature selection. Featured in <a href="https://towardsdatascience.com/why-automl-is-an-essential-new-tool-for-data-scientists-2d9ab4e25e46?source=friends_link&sk=d03a0cc55c23deb497d546d6b9be0653">Medium article</a>.
...
* [Lightwood](https://github.com/mindsdb/lightwood) ⭐ 508 | 🐛 17 | 🌐 Python | 📅 2026-02-21 - A Pytorch based framework that breaks down machine learning problems into smaller blocks that can be glued together seamlessly with objective to build predictive models with one line of code.
...
* [imbalanced-ensemble](https://github.com/ZhiningLiu1998/imbalanced-ensemble) ⭐ 430 | 🐛 4 | 🌐 Python | 📅 2026-03-05 - Python toolbox for quick implementation, modification, evaluation, and visualization of ensemble learning algorithms for class-imbalanced data. Supports out-of-the-box multi-class imbalanced (long-tailed) classification.
...
* [RexMex](https://github.com/AstraZeneca/rexmex) ⭐ 278 | 🐛 3 | 🌐 Python | 📅 2023-08-22 -> A general purpose recommender metrics library for fair evaluation.
* [evostra](https://github.com/alirezamika/evostra) ⭐ 272 | 🐛 8 | 🌐 Python | 📅 2020-04-27 - A fast Evolution Strategy implementation in Python.
* [Frouros](https://github.com/IFCA/frouros) ⭐ 259 | 🐛 16 | 🌐 Python | 📅 2026-04-23: Frouros is an open source Python library for drift detection in machine learning systems.
...
* [Eurybia](https://github.com/MAIF/eurybia) ⭐ 224 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2026-03-23: Eurybia monitors data and model drift over time and securizes model deployment with data validation.
...
* [neurolab](https://github.com/zueve/neurolab) ⭐ 168 | 🐛 16 | 🌐 Python | 📅 2020-06-02
...
* [Neurolink](https://github.com/juspay/neurolink) ⭐ 121 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-14 - Enterprise-grade LLM integration framework for building production-ready AI applications with built-in hallucination prevention, RAG, and MCP support.
...
* [neonrvm](https://github.com/siavashserver/neonrvm) ⚠️ Archived - neonrvm is an open source machine learning library based on RVM technique. It's written in C programming language and comes with Python programming language bindings.
* [OPFython](https://github.com/gugarosa/opfython) ⭐ 38 | 🐛 7 | 🌐 Python | 📅 2026-05-01 - A Python-inspired implementation of the Optimum-Path Forest classifier.
...
* [SKBEL](https://github.com/robinthibaut/skbel) ⭐ 29 | 🐛 1 | 🌐 Python | 📅 2026-04-25: A Python library for Bayesian Evidential Learning (BEL) in order to estimate the uncertainty of a prediction.
...
* [autobatcher](https://github.com/doublewordai/autobatcher) ⭐ 22 | 🐛 14 | 🌐 Python | 📅 2026-08-08 - Drop-in AsyncOpenAI replacement that transparently batches requests via the Batch API for cheaper LLM inference.
...
* [Leanpass](https://github.com/Terminay/LeanPass) ⭐ 15 | 🐛 11 | 🌐 Python | 📅 2026-08-14 - A lightweight, NumPy-only autodiff library for small ML projects and learning how backpropagation works. It is 700x times lighter than Pytorch and 900x times lighter than TensorFlow.
...
* [PhilanthroPy](https://github.com/PhilanthroPy-Project/PhilanthroPy) ⭐ 7 | 🐛 18 | 🌐 Python | 📅 2026-08-13 - A scikit-learn native toolkit for nonprofit and academic-medical-center fundraising analytics: leakage-safe donor propensity, lapse, planned-giving, wealth-screening and revenue-forecasting estimators.
...
* [Superset](https://github.com/apache/incubator-superset) ⭐ 74,257 | 🐛 569 | 🌐 Python | 📅 2026-08-14 - A data exploration platform designed to be visual, intuitive, and interactive.
* [Dash](https://github.com/plotly/dash) ⭐ 24,378 | 🐛 537 | 🌐 Python | 📅 2026-08-13 - A framework for creating analytical web applications built on top of Plotly.js, React, and Flask
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,431 | 🐛 856 | 🌐 TypeScript | 📅 2026-08-14 - Interactive Web Plotting for Python.
* [zipline](https://github.com/quantopian/zipline) ⭐ 20,034 | 🐛 370 | 🌐 Python | 📅 2024-02-13 - A Pythonic algorithmic trading library.
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,867 | 🐛 5,946 | 🌐 Python | 📅 2026-08-13 - A Python library for symbolic mathematics.
* [lime](https://github.com/marcotcr/lime) ⭐ 12,167 | 🐛 133 | 🌐 JavaScript | 📅 2024-07-25 - Lime is about explaining what machine learning classifiers (or models) are doing. It is able to explain any black box classifier, with two or more classes.
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,574 | 🐛 2,828 | 🌐 Python | 📅 2026-08-14 - Statistical modelling and econometrics in Python.
* [altair](https://github.com/altair-viz/altair) ⭐ 10,452 | 🐛 149 | 🌐 Python | 📅 2026-08-14 - A Python to Vega translator.
* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,710 | 🐛 476 | 🌐 Python | 📅 2026-08-13 - Markov Chain Monte Carlo sampling toolkit.
...
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) ⭐ 4,398 | 🐛 514 | 🌐 Python | 📅 2026-08-11 - A pure-python graphics and GUI library built on PyQt4 / PySide and NumPy.
* [bqplot](https://github.com/bloomberg/bqplot) ⭐ 3,694 | 🐛 278 | 🌐 TypeScript | 📅 2026-05-07 - An API for plotting in Jupyter (IPython).
* [ggplot](https://github.com/yhat/ggpy) ⚠️ Archived - Same API as ggplot2 for R. **\[Deprecated]**
* [vispy](https://github.com/vispy/vispy) ⭐ 3,582 | 🐛 395 | 🌐 Python | 📅 2026-08-13 - GPU-based high-performance interactive OpenGL 2D/3D data visualization library.
* [TensorWatch](https://github.com/microsoft/tensorwatch) ⭐ 3,470 | 🐛 54 | 🌐 Jupyter Notebook | 📅 2026-03-30 - Debugging and visualization tool for machine learning and data science. It extensively leverages Jupyter Notebook to show real-time visualizations of data in running processes such as machine learning training.
* [Blaze](https://github.com/blaze/blaze) ⭐ 3,188 | 🐛 268 | 🌐 Python | 📅 2023-09-29 - NumPy and Pandas interface to Big Data.
* [Mars](https://github.com/mars-project/mars) ⭐ 2,741 | 🐛 215 | 🌐 Python | 📅 2024-01-02 - A tensor-based framework for large-scale data computation which is often regarded as a parallel and distributed version of NumPy.
...
* [PyCM](https://github.com/sepandhaghighi/pycm) ⭐ 1,506 | 🐛 16 | 🌐 Python | 📅 2026-08-11 - PyCM is a multi-class confusion matrix library written in Python that supports both input data vectors and direct matrix, and a proper tool for post-classification model evaluation that supports most classes and overall statistics parameters
* [d3py](https://github.com/mikedewar/d3py) ⭐ 1,414 | 🐛 48 | 🌐 Python | 📅 2020-12-28 - A plotting library for Python, based on [D3.js](https://d3js.org/).
* [Open Mining](https://github.com/mining/mining) ⚠️ Archived - Business Intelligence (BI) in Python (Pandas web interface) **\[Deprecated]**
* [Kartograph.py](https://github.com/kartograph/kartograph.py) ⭐ 996 | 🐛 63 | 🌐 Python | 📅 2020-12-30 - Rendering beautiful SVG maps in Python.
...
* [ggfortify](https://github.com/sinhrks/ggfortify) ⭐ 541 | 🐛 21 | 🌐 R | 📅 2026-08-05 - Unified interface to ggplot2 popular R packages.
...
* [Flama](https://github.com/vortico/flama) ⭐ 296 | 🐛 5 | 🌐 Python | 📅 2026-08-01 - Ignite your models into blazing-fast machine learning APIs with a modern framework.
...
* [visualize\_ML](https://github.com/ayush1997/visualize_ML) ⭐ 207 | 🐛 0 | 🌐 Python | 📅 2016-09-28 - A python package for data exploration and data analysis. **\[Deprecated]**
...
* [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) ⭐ 29,305 | 🐛 48 | 🌐 Python | 📅 2024-03-20 - Continually updated Data Science Python Notebooks: Spark, Hadoop MapReduce, HDFS, AWS, Kaggle, scikit-learn, matplotlib, pandas, NumPy, SciPy, and various command lines.
...
* [Pydata book](https://github.com/wesm/pydata-book) ⭐ 24,813 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2025-10-17 - Materials and IPython notebooks for "Python for Data Analysis" by Wes McKinney, published by O'Reilly Media
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,752 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2025-11-23 - Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
* [A gallery of interesting IPython notebooks](https://github.com/jupyter/jupyter/wiki/A-gallery-of-interesting-Jupyter-Notebooks) ⭐ 15,349 | 🐛 43 | 🌐 Python | 📅 2026-07-09
...
* [Introduction to Machine Learning with Python](https://github.com/amueller/introduction_to_ml_with_python) ⭐ 8,145 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2024-03-14 - Notebooks and code for the book "Introduction to Machine Learning with Python"
* [pandas cookbook](https://github.com/jvns/pandas-cookbook) ⭐ 7,104 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-10-24 - Recipes for using Python's pandas library.
* [numpic](https://github.com/numenta/nupic) ⭐ 6,351 | 🐛 465 | 🌐 Python | 📅 2024-12-03
* [pattern\_classification](https://github.com/rasbt/pattern_classification) ⭐ 4,213 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-11-26
* [Introduction to machine learning with scikit-learn](https://github.com/justmarkham/scikit-learn-videos) ⭐ 3,806 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-03-05 - IPython notebooks from Data School's video tutorials on scikit-learn.
* [Keras Tuner](https://github.com/keras-team/keras-tuner) ⭐ 2,923 | 🐛 240 | 🌐 Python | 📅 2025-12-01 - An easy-to-use, scalable hyperparameter optimization framework that solves the pain points of hyperparameter search.
...
* [hyperopt](https://github.com/hyperopt/hyperopt-sklearn) ⭐ 1,649 | 🐛 78 | 🌐 Python | 📅 2025-04-15
...
* [Hyperparameter-Optimization-of-Machine-Learning-Algorithms](https://github.com/LiYangHart/Hyperparameter-Optimization-of-Machine-Learning-Algorithms) ⭐ 1,339 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-09-22 - Code for hyperparameter tuning/optimization of machine learning and deep learning algorithms.
* [Suiron](https://github.com/kendricktan/suiron/) ⭐ 711 | 🐛 3 | 🌐 Python | 📅 2016-10-08 - Machine Learning for RC Cars.
* [ipython-notebooks](https://github.com/ogrisel/notebooks) ⭐ 575 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-05-04
...
* [the-elements-of-statistical-learning](https://github.com/maitbayev/the-elements-of-statistical-learning) ⭐ 430 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-02-10 - This repository contains Jupyter notebooks implementing the algorithms found in the book and summary of the textbook.
...
* [scikit-learn tutorials](https://github.com/GaelVaroquaux/scikit-learn-tutorial) ⭐ 133 | 🐛 0 | 🌐 Python | 📅 2011-12-06 - Series of notebooks for learning scikit-learn.
...
* [minidiff](https://github.com/ahoynodnarb/minidiff) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-06-03 - A slightly larger, somewhat feature-complete, PyTorch-inspired, NumPy implementation of a tensor reverse-mode automatic differentiation engine.
...
* [NeuralTalk](https://github.com/karpathy/neuraltalk2) ⭐ 5,590 | 🐛 142 | 🌐 Jupyter Notebook | 📅 2017-11-07 - NeuralTalk is a Python+numpy project for learning Multimodal Recurrent Neural Networks that describe images with sentences. **\[Deprecated]**
* [NeuralTalk](https://github.com/karpathy/neuraltalk) ⭐ 5,499 | 🐛 30 | 🌐 Python | 📅 2020-12-22 - NeuralTalk is a Python+numpy project for learning Multimodal Recurrent Neural Networks that describe images with sentences.
* [TResNet: High Performance GPU-Dedicated Architecture](https://github.com/mrT23/TResNet) ⭐ 477 | 🐛 6 | 🌐 Python | 📅 2024-12-10 - TResNet models were designed and optimized to give the best speed-accuracy tradeoff out there on GPUs.
...
* [fenn](https://github.com/pyfenn/fenn) ⭐ 82 | 🐛 16 | 🌐 Python | 📅 2026-08-10 - A simple Python framework for building ML/DL workflows and LLM agents faster, with prebuilt trainers, agent templates, logging, configuration management, and much more.
...
* [zij](https://github.com/junaidaliop/zij) ⭐ 15 | 🐛 0 | 🌐 Python | 📅 2026-06-18 - A canon of deep learning optimization algorithms.
...
* [Tonic](https://github.com/neuromorphs/tonic) ⭐ 290 | 🐛 34 | 🌐 Python | 📅 2026-07-17 - A library that makes downloading publicly available neuromorphic datasets a breeze and provides event-based data transformation/augmentation pipelines.
* [Sinabs](https://github.com/synsense/sinabs) ⭐ 119 | 🐛 27 | 🌐 Python | 📅 2026-02-05 - A deep learning library for spiking neural networks which is based on PyTorch, focuses on fast training and supports inference on neuromorphic hardware.
* [Rockpool](https://github.com/synsense/rockpool) ⭐ 88 | 🐛 4 | 🌐 Python | 📅 2026-07-03 - A machine learning library for spiking neural networks. Supports training with both torch and jax pipelines, and deployment to neuromorphic hardware.

<a name="python-survival-analysis"></a>

#### Python Survival Analysis

* [lifelines](https://github.com/CamDavidsonPilon/lifelines) ⭐ 2,604 | 🐛 296 | 🌐 Python | 📅 2026-03-07 - lifelines is a complete survival analysis library, written in pure Python
* [Scikit-Survival](https://github.com/sebp/scikit-survival) ⭐ 1,316 | 🐛 32 | 🌐 Python | 📅 2026-08-14 - scikit-survival is a Python module for survival analysis built on top of scikit-learn. It allows doing survival analysis while utilizing the power of scikit-learn, e.g., for pre-processing or doing cross-validation.
...
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,937 | 🐛 21 | 🌐 Python | 📅 2026-08-14 - A Python library for secure and private Deep Learning.
...
* [RLlib](https://github.com/ray-project/ray) ⭐ 43,514 | 🐛 3,476 | 🌐 Python | 📅 2026-08-14 - RLlib is an industry level, highly scalable RL library for tf and torch, based on Ray. It's used by companies like Amazon and Microsoft to solve real-world decision making problems at scale.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 12,324 | 🐛 77 | 🌐 Python | 📅 2026-08-05 - A library for developing and comparing reinforcement learning algorithms (successor of \[gym])(<https://github.com/openai/gym> ⚠️ Archived).
* [DeepMind Lab](https://github.com/deepmind/lab) ⭐ 7,371 | 🐛 66 | 🌐 C | 📅 2023-01-04 - DeepMind Lab is a 3D learning environment based on id Software's Quake III Arena via ioquake3 and other open source software. Its primary purpose is to act as a testbed for research in artificial intelligence, especially deep reinforcement learning.
...
* [DI-engine](https://github.com/opendilab/DI-engine) ⭐ 3,638 | 🐛 27 | 🌐 Python | 📅 2025-12-07 - DI-engine is a generalized Decision Intelligence engine. It supports most basic deep reinforcement learning (DRL) algorithms, such as DQN, PPO, SAC, and domain-specific algorithms like QMIX in multi-agent RL, GAIL in inverse RL, and RND in exploration problems.
...
* [ViZDoom](https://github.com/mwydmuch/ViZDoom) ⭐ 2,059 | 🐛 39 | 🌐 C++ | 📅 2026-08-13 - ViZDoom allows developing AI bots that play Doom using only the visual information (the screen buffer). It is primarily intended for research in machine visual learning, and deep reinforcement learning, in particular.
* [metaworld](https://github.com/rlworkgroup/metaworld) ⭐ 1,866 | 🐛 11 | 🌐 Python | 📅 2026-08-10 - An open source robotics benchmark for meta- and multi-task reinforcement learning
...
* [EspNet](https://github.com/espnet/espnet) ⭐ 9,922 | 🐛 57 | 🌐 Python | 📅 2026-08-11 - ESPnet is an end-to-end speech processing toolkit for tasks like speech recognition, translation, and enhancement, using PyTorch and Kaldi-style data processing.
...
* [Twitter-text-rb](https://github.com/twitter/twitter-text/tree/master/rb) ⭐ 3,139 | 🐛 93 | 🌐 HTML | 📅 2024-04-26 - A library that does auto linking and extraction of usernames, lists and hashtags in tweets.
...
* [Awesome Machine Learning with Ruby](https://github.com/arbox/machine-learning-with-ruby) ⭐ 2,220 | 🐛 6 | 🌐 Ruby | 📅 2024-12-26 - Curated list of ML related resources for Ruby.
* [rumale](https://github.com/yoshoku/rumale) ⭐ 914 | 🐛 0 | 🌐 Ruby | 📅 2026-08-05 - Rumale is a machine learning library in Ruby
* [CardMagic-Classifier](https://github.com/cardmagic/classifier) ⭐ 741 | 🐛 11 | 🌐 Ruby | 📅 2026-08-09 - A general classifier module to allow Bayesian and other types of classifications.
...
* [Bioruby](https://github.com/bioruby/bioruby) ⭐ 383 | 🐛 15 | 🌐 Ruby | 📅 2026-07-02
* [rsruby](https://github.com/alexgutteridge/rsruby) ⭐ 334 | 🐛 15 | 🌐 Ruby | 📅 2018-10-06 - Ruby - R bridge.
...
* [candle](https://github.com/huggingface/candle) ⭐ 20,899 | 🐛 909 | 🌐 Rust | 📅 2026-08-14 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use.
...
* [linfa](https://github.com/rust-ml/linfa) ⭐ 4,730 | 🐛 76 | 🌐 Rust | 📅 2026-05-30 - a comprehensive toolkit to build Machine Learning applications with Rust
* [linfa](https://github.com/rust-ml/linfa) ⭐ 4,730 | 🐛 76 | 🌐 Rust | 📅 2026-05-30 - `linfa` aims to provide a comprehensive toolkit to build Machine Learning applications with Rust
* [rusty-machine](https://github.com/AtheMathmo/rusty-machine) ⚠️ Archived - a pure-rust machine learning library.
* [smartcore](https://github.com/smartcorelib/smartcore) ⭐ 947 | 🐛 52 | 🌐 Rust | 📅 2026-08-10 - "The Most Advanced Machine Learning Library In Rust."
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,754 | 🐛 291 | 🌐 Rust | 📅 2026-08-14 - Burn is a new comprehensive dynamic Deep Learning Framework built using Rust with extreme flexibility, compute efficiency and portability as its primary goals
* [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,474 | 🐛 245 | 🌐 Rust | 📅 2026-07-17 - Rust bindings for the C++ API of PyTorch
* [dfdx](https://github.com/coreylowman/dfdx) ⭐ 1,927 | 🐛 91 | 🌐 Rust | 📅 2024-07-23 - Deep learning in Rust, with shape checked tensors and neural networks

#### Natural Language Processing

* [huggingface/tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,967 | 🐛 254 | 🌐 Rust | 📅 2026-08-13 - Fast State-of-the-Art Tokenizers optimized for Research and Production
* [shimmy](https://github.com/Michael-A-Kuykendall/shimmy) ⭐ 5,748 | 🐛 11 | 🌐 Rust | 📅 2026-08-06 - Python-free Rust inference server for NLP models with OpenAI API compatibility and hot model swapping.
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,065 | 🐛 719 | 🌐 C++ | 📅 2026-08-14 - General purpose gradient boosting on decision trees library with categorical features support out of the box for R.
* [Machine Learning For Hackers](https://github.com/johnmyleswhite/ML_for_Hackers) ⭐ 3,734 | 🐛 36 | 🌐 R | 📅 2019-05-26
...
* [SuperLearner](https://github.com/ecpolley/SuperLearner) ⭐ 294 | 🐛 20 | 🌐 R | 📅 2025-12-15 - Multi-algorithm ensemble learning packages.
...
* [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,155 | 🐛 29 | 🌐 Scala | 📅 2026-08-13 - Natural language processing library built on top of Apache Spark ML to provide simple, performant, and accurate NLP annotations for machine learning pipelines, that scale easily in a distributed environment.
* [Breeze](https://github.com/scalanlp/breeze) ⭐ 3,455 | 🐛 89 | 🌐 Scala | 📅 2025-10-04 - Breeze is a numerical processing library for Scala.
* [FACTORIE](https://github.com/factorie/factorie) ⭐ 553 | 🐛 26 | 🌐 Scala | 📅 2017-12-19 - FACTORIE is a toolkit for deployable probabilistic modelling, implemented as a software library in Scala. It provides its users with a succinct language for creating relational factor graphs, estimating parameters and performing inference.
* [Chalk](https://github.com/scalanlp/chalk) ⚠️ Archived - Chalk is a natural language processing library. **\[Deprecated]**
* [Montague](https://github.com/Workday/upshot-montague) ⭐ 60 | 🐛 1 | 🌐 Scala | 📅 2022-08-06 - Montague is a semantic parsing library for Scala with an easy-to-use DSL.
...
* [Algebird](https://github.com/twitter/algebird) ⭐ 2,298 | 🐛 117 | 🌐 Scala | 📅 2025-11-21 - Abstract Algebra for Scala.
...
* [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) ⭐ 5,236 | 🐛 183 | 🌐 Scala | 📅 2026-08-14 -> A distributed machine learning framework Apache Spark
* [adam](https://github.com/bigdatagenomics/adam) ⭐ 1,056 | 🐛 43 | 🌐 Scala | 📅 2026-03-17 - A genomics processing engine and specialized file format built using Apache Avro, Apache Spark and Parquet. Apache 2 licensed.
* [H2O Sparkling Water](https://github.com/h2oai/sparkling-water) ⭐ 979 | 🐛 43 | 🌐 Scala | 📅 2025-11-05 - H2O and Spark interoperability.
* [TensorFlow Scala](https://github.com/eaplatanios/tensorflow_scala) ⭐ 939 | 🐛 29 | 🌐 Scala | 📅 2022-06-22 - Strongly-typed Scala API for TensorFlow.
...
* [ONNX-Scala](https://github.com/EmergentOrder/onnx-scala) ⭐ 149 | 🐛 16 | 🌐 Scala | 📅 2026-02-17 - An ONNX (Open Neural Network eXchange) API and backend for typeful, functional deep learning in Scala (3).
...
* [Saul](https://github.com/CogComp/saul) ⭐ 65 | 🐛 121 | 🌐 Scala | 📅 2020-01-16 - Flexible Declarative Learning-Based Programming.
...
* [Awesome Core ML Models](https://github.com/likedan/Awesome-CoreML-Models) ⭐ 7,037 | 🐛 15 | 🌐 Python | 📅 2025-06-17 - A curated list of machine learning models in CoreML format.
...
* [Swift AI](https://github.com/Swift-AI/Swift-AI) ⭐ 6,038 | 🐛 13 | 🌐 Swift | 📅 2017-05-03 - Highly optimized artificial intelligence and machine learning library written in Swift.
...
* [AIToolbox](https://github.com/KevinCoble/AIToolbox) ⭐ 805 | 🐛 6 | 🌐 Swift | 📅 2020-08-09 - A toolbox framework of AI modules written in Swift: Graphs/Trees, Linear Regression, Support Vector Machines, Neural Networks, PCA, KMeans, Genetic Algorithms, MDP, Mixture of Gaussians.
* [Awesome CoreML](https://github.com/SwiftBrain/awesome-CoreML-models) ⭐ 587 | 🐛 4 | 📅 2019-12-07 - A curated list of pretrained CoreML models.
...
* [Awesome TensorFlow](https://github.com/jtoy/awesome-tensorflow) ⭐ 17,559 | 🐛 34 | 📅 2026-02-08 - A list of all things related to TensorFlow.
...
* [milvus](https://milvus.io) – Milvus is [open source](https://github.com/milvus-io/milvus) ⭐ 45,637 | 🐛 1,292 | 🌐 Go | 📅 2026-08-14 vector database for production AI, written in Go and C++, scalable and blazing fast for billions of embedding vectors.
* [Qdrant](https://qdrant.tech) – Qdrant is [open source](https://github.com/qdrant/qdrant) ⭐ 33,975 | 🐛 689 | 🌐 Rust | 📅 2026-08-14 vector similarity search engine with extended filtering support, written in Rust.
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,235 | 🐛 497 | 🌐 TypeScript | 📅 2026-08-14 - Open-source LLM evaluation and red teaming framework. Test prompts, models, agents, and RAG pipelines. Run adversarial attacks (jailbreaks, prompt injection) and integrate security testing into CI/CD.
* [Weaviate](https://www.semi.technology/developers/weaviate/current/) – Weaviate is an [open source](https://github.com/semi-technologies/weaviate) ⭐ 16,729 | 🐛 683 | 🌐 Go | 📅 2026-08-14 vector search engine and vector database. Weaviate uses machine learning to vectorize and store data, and to find answers to natural language queries. With Weaviate you can also bring your custom ML models to production scale.
* [DVC](https://github.com/iterative/dvc) ⭐ 15,818 | 🐛 195 | 🌐 Python | 📅 2026-08-10 - Data Science Version Control is an open-source version control system for machine learning projects with pipelines support. It makes ML projects reproducible and shareable.
* [txtai](https://github.com/neuml/txtai) ⭐ 12,889 | 🐛 6 | 🌐 Python | 📅 2026-08-12 - Build semantic search applications and workflows.
* [Kedro](https://github.com/quantumblacklabs/kedro/) ⭐ 10,953 | 🐛 152 | 🌐 Python | 📅 2026-08-14 - Kedro is a data and development workflow framework that implements best practices for data pipelines with an eye towards productionizing machine learning models.
* [RunAnywhere](https://github.com/RunanywhereAI/runanywhere-sdks) ⭐ 10,300 | 🐛 21 | 🌐 C++ | 📅 2026-08-14 - Open-source SDK for running LLMs and multimodal models on-device across iOS, Android, and cross-platform apps.
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 8,856 | 🐛 64 | 🌐 Python | 📅 2026-08-14 - Production-ready Multi-AI Agents framework with self-reflection. Fastest agent instantiation (3.77μs), 100+ LLM support via LiteLLM, MCP integration, agentic workflows (route/parallel/loop/repeat), built-in memory, Python & JS SDKs.
* [Infinity](https://github.com/infiniflow/infinity) ⭐ 4,671 | 🐛 64 | 🌐 C++ | 📅 2026-08-06 - The AI-native database built for LLM applications, providing incredibly fast vector and full-text search. Developed using C++20
...
* More tools to improve the ML lifecycle: [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,380 | 🐛 6 | 🌐 Python | 📅 2026-07-08, [PachydermIO](https://www.pachyderm.io/). The following are GitHub-alike and targeting teams [Weights & Biases](https://www.wandb.com/), [Neptune.ai](https://neptune.ai/), [Comet.ml](https://www.comet.ml/), [Valohai.ai](https://valohai.com/), [DAGsHub](https://DAGsHub.com/).
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,996 | 🐛 62 | 🌐 Python | 📅 2024-08-03 - A tool that allows the conversion of ML models into native code (Java, C, Python, Go, JavaScript, Visual Basic, C#, R, PowerShell, PHP, Dart) with zero dependencies.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,562 | 🐛 148 | 🌐 Jupyter Notebook | 📅 2026-08-13 - a lightweight library to define data transformations as a directed-acyclic graph (DAG). It helps author reliable feature engineering and machine learning pipelines, and more.
* [Agentfield](https://github.com/Agent-Field/agentfield) ⭐ 2,511 | 🐛 63 | 🌐 Go | 📅 2026-08-14 - Open source Kubernetes-style control plane for deploying AI agents as distributed microservices, with built-in service discovery, durable workflows, and observability.
* [VDP](https://github.com/instill-ai/vdp) ⭐ 2,319 | 🐛 40 | 🌐 Python | 📅 2026-06-01 - open source visual data ETL to streamline the end-to-end visual data processing pipeline: extract unstructured visual data from pre-built data sources, transform it into analysable structured insights by Vision AI models imported from various ML platforms, and load the insights into warehouses or applications.
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 1,030 | 🐛 15 | 🌐 Python | 📅 2025-11-27 -  Open-source CLI security scanner for agentic workflows. Scans your workflow’s source code, detects vulnerabilities, and generates an interactive visualization along with a detailed security report. Supports LangGraph, CrewAI, n8n, OpenAI Agents, and more.
...
* [Localforge](https://localforge.dev/) – Is an [open source](https://github.com/rockbite/localforge) ⭐ 396 | 🐛 13 | 🌐 JavaScript | 📅 2025-05-18 on-prem AI coding autonomous assistant that lives inside your repo, edits and tests files at SSD speed. Think Claude Code but with UI. plug in any LLM (OpenAI, Gemini, Ollama, etc.) and let it work for you.
* [DVClive](https://github.com/iterative/dvclive) ⭐ 196 | 🐛 33 | 🌐 Python | 📅 2026-08-10 - Python library for experiment metrics logging into simply formatted local files.
* [Awesome RAG Production](https://github.com/Yigtwxx/Awesome-RAG-Production) ⭐ 196 | 🐛 4 | 🌐 Python | 📅 2026-08-07 - A curated collection of battle-tested tools, frameworks, and best practices for building, scaling, and monitoring production-grade Retrieval-Augmented Generation (RAG) systems. Covers frameworks, vector databases, retrieval & reranking, evaluation, observability, deployment, and security.
...
* [ClawMoat](https://github.com/darfaz/clawmoat) ⭐ 42 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-02 - Open-source runtime security scanner for AI agents. Detects prompt injection, jailbreak, PII leakage, memory poisoning, and tool misuse. Zero deps, MIT licensed.
* [HyperAgency](https://github.com/vuics/h9y) ⭐ 36 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-12 - agentic AI operating system (h9y.ai) that replaces brittle/fragmented automations with long-lived, self-improving systems. Open-source, self-hosted/cloud, visual workflow, omni-channel, decentralized, extensible.
...
* [Awesome Hugging Face Models](https://github.com/JehoshuaM/awesome-huggingface-models) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2026-07-04 - Curated list of top Hugging Face models for NLP, vision, and audio tasks with demos and benchmarks.
...
* [Distributed Machine Learning Patterns](https://github.com/terrytangyuan/distributed-ml-patterns) ⭐ 533 | 🐛 0 | 🌐 Python | 📅 2026-01-06  - This book teaches you how to take machine learning models from your personal laptop to large distributed clusters. You’ll explore key concepts and patterns behind successful distributed machine learning systems, and learn technologies like TensorFlow, Kubernetes, Kubeflow, and Argo Workflows directly from a key maintainer and contributor, with real-world scenarios and hands-on projects.
...
* Some of the python libraries were cut-and-pasted from [vinta](https://github.com/vinta/awesome-python) ⭐ 313,975 | 🐛 26 | 🌐 Python | 📅 2026-08-05
