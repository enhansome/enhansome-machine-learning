...
* For a list of free machine learning books available for download, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/books.md) ⭐ 74,041 | 🐛 24 | 🌐 Python | 📅 2026-08-11.

* For a list of professional machine learning events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/events.md) ⭐ 74,041 | 🐛 24 | 🌐 Python | 📅 2026-08-11.

* For a list of (mostly) free machine learning courses available online, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/courses.md) ⭐ 74,041 | 🐛 24 | 🌐 Python | 📅 2026-08-11.

* For a list of blogs and newsletters on data science and machine learning, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/blogs.md) ⭐ 74,041 | 🐛 24 | 🌐 Python | 📅 2026-08-11.

* For a list of free-to-attend meetups and local events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/meetups.md) ⭐ 74,041 | 🐛 24 | 🌐 Python | 📅 2026-08-11.
...
* [YOLOv8](https://github.com/ultralytics/ultralytics) ⭐ 60,692 | 🐛 164 | 🌐 Python | 📅 2026-08-17 - Ultralytics' YOLOv8 implementation with C++ support for real-time object detection and tracking, optimized for edge devices.
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,240 | 🐛 80 | 🌐 C++ | 📅 2026-08-17 - C-based/Cached/Core Computer Vision Library, A Modern Computer Vision Library.
...
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,368 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,563 | 🐛 1,566 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind. \[DEEP LEARNING]
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,662 | 🐛 417 | 🌐 C++ | 📅 2026-08-17 - A parallelized optimized general purpose gradient boosting library.
* [Opik](https://www.comet.com/site/products/opik/) - Open source engineering platform to debug, evaluate, and monitor your LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards. ([Source Code](https://github.com/comet-ml/opik/) ⭐ 21,430 | 🐛 202 | 🌐 Python | 📅 2026-08-17)
...
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,690 | 🐛 513 | 🌐 C++ | 📅 2026-08-14 - Microsoft's fast, distributed, high performance gradient boosting (GBDT, GBRT, GBM or MART) framework based on decision tree algorithms, used for ranking, classification and many other machine learning tasks.
...
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,068 | 🐛 720 | 🌐 C++ | 📅 2026-08-17 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, contains fast inference implementation and supports CPU and GPU (even multi-GPU) computation.
* [Vowpal Wabbit (VW)](https://github.com/VowpalWabbit/vowpal_wabbit) ⭐ 8,703 | 🐛 3 | 🌐 C++ | 📅 2026-07-15 - A fast out-of-core learning system.
...
* [Feast](https://github.com/gojek/feast) ⭐ 7,215 | 🐛 401 | 🌐 Python | 📅 2026-08-17 - A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.
...
* [oneDNN](https://github.com/oneapi-src/oneDNN) ⭐ 4,036 | 🐛 190 | 🌐 C++ | 📅 2026-08-17 - An open-source cross-platform performance library for deep learning applications.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,719 | 🐛 126 | 🌐 MDX | 📅 2026-08-17 - A platform for reproducible and scalable machine learning and deep learning.
...
* [DeepDetect](https://github.com/jolibrain/deepdetect) ⭐ 2,550 | 🐛 99 | 🌐 C++ | 📅 2026-08-17 - A machine learning API and server written in C++11. It makes state of the art machine learning easy to work with and integrate into existing applications.
...
* [Intel® oneAPI Data Analytics Library](https://github.com/oneapi-src/oneDAL) ⭐ 651 | 🐛 90 | 🌐 C++ | 📅 2026-08-16 - A high performance software library developed by Intel and optimized for Intel's architectures. Library provides algorithmic building blocks for all stages of data analytics and allows to process data in batch, online and distributed modes.
...
* [MCGrad](https://github.com/facebookincubator/MCGrad/) ⭐ 44 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-08-17 - A production-ready library for multicalibration, fairness, and bias correction in machine learning models.
...
* * [Agentic Context Engine](https://github.com/kayba-ai/agentic-context-engine) ⭐ 2,548 | 🐛 12 | 🌐 Python | 📅 2026-07-08 -In-context learning framework that allows agents to learn from execution feedback.
...
* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 12,026 | 🐛 4 | 🌐 C++ | 📅 2026-08-16 - A C++ library for unsupervised text tokenization and detokenization, widely used in modern NLP models.
...
* [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,459 | 🐛 261 | 🌐 Shell | 📅 2025-09-22 - Kaldi is a toolkit for speech recognition written in C++ and licensed under the Apache License v2.0. Kaldi is intended for use by speech recognition researchers.
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,063 | 🐛 601 | 🌐 Jupyter Notebook | 📅 2026-08-09 - An offline speech recognition toolkit with C++ support, designed for low-resource devices and multiple languages.
...
* [Libpython-clj](https://github.com/clj-python/libpython-clj) ⭐ 1,206 | 🐛 37 | 🌐 Clojure | 📅 2026-08-10 - Interop with Python
...
* [gogeo](https://github.com/golang/geo) ⭐ 1,848 | 🐛 38 | 🌐 Go | 📅 2026-08-17 - Spherical geometry in Go.
...
* [stable-baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 13,701 | 🐛 86 | 🌐 Python | 📅 2026-08-17 - PyTorch implementations of Stable Baselines (deep) reinforcement learning algorithms.
...
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,494 | 🐛 2,882 | 🌐 Jupyter Notebook | 📅 2026-08-17 - ML engine that supports distributed learning on Hadoop, Spark or your laptop via APIs in R, Python, Scala, REST/JSON.
...
* [Spark](https://github.com/apache/spark) ⭐ 43,826 | 🐛 460 | 🌐 Scala | 📅 2026-08-17 - Spark is a fast and general engine for large-scale data processing.
* [Hadoop](https://github.com/apache/hadoop) ⭐ 15,632 | 🐛 201 | 🌐 Java | 📅 2026-08-17 - Hadoop/HDFS.
...
* [Deeplearning4j](https://github.com/deeplearning4j/deeplearning4j) ⭐ 14,245 | 🐛 55 | 🌐 Java | 📅 2026-08-17 - Scalable deep learning for industry with parallel GPUs.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,363 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-17 - Visualizer for machine learning models.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
...
* [stdlib](https://github.com/stdlib-js/stdlib) ⭐ 5,928 | 🐛 1,322 | 🌐 JavaScript | 📅 2026-08-17 - A standard library for JavaScript and Node.js, with an emphasis on numeric computing. The library provides a collection of robust, high performance libraries for mathematics, statistics, streams, utilities, and more.
...
* [Pipcook](https://github.com/alibaba/pipcook) ⭐ 2,595 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-17 - A JavaScript application framework for machine learning and its engineering.
...
* [Mixed Models](https://github.com/dmbates/MixedModels.jl) ⭐ 449 | 🐛 55 | 🌐 Julia | 📅 2026-08-17 - A Julia package for fitting (statistical) mixed-effects models.
...
* [Hypothesis Tests](https://github.com/JuliaStats/HypothesisTests.jl) ⭐ 317 | 🐛 93 | 🌐 Julia | 📅 2026-06-23 - Hypothesis tests for Julia.
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,563 | 🐛 1,566 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [MXNet](https://github.com/apache/incubator-mxnet/) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,347 | 🐛 1,008 | 🌐 C# | 📅 2026-08-17 - ML.NET is a cross-platform open-source machine learning framework which makes machine learning accessible to .NET developers. ML.NET was originally developed in Microsoft Research and evolved into a significant framework over the last decade and is used across many product groups in Microsoft like Windows, Bing, PowerPoint, Excel and more.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,466 | 🐛 2,744 | 🌐 C++ | 📅 2026-08-17 - A OpenSource Computer Vision Library
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,663 | 🐛 830 | 🌐 Python | 📅 2026-06-25 - Face recognition library that recognizes and manipulates faces from Python or from the command line.
* [timm](https://github.com/rwightman/pytorch-image-models) ⭐ 37,069 | 🐛 61 | 🌐 Python | 📅 2026-08-11 - PyTorch image models, scripts, pretrained weights -- ResNet, ResNeXT, EfficientNet, EfficientNetV2, NFNet, Vision Transformer, MixNet, MobileNet-V3/V2, RegNet, DPN, CSPNet, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,668 | 🐛 586 | 🌐 Python | 📅 2026-07-24 - FAIR's next-generation research platform for object detection and segmentation. It is a ground-up rewrite of the previous version, Detectron, and is powered by the PyTorch deep learning framework.
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,368 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
* [MLX](https://github.com/ml-explore/mlx) ⭐ 28,012 | 🐛 160 | 🌐 C++ | 📅 2026-08-17- MLX is an array framework for machine learning on Apple silicon, developed by Apple machine learning research.
...
* [deepface](https://github.com/serengil/deepface) ⭐ 23,295 | 🐛 11 | 🌐 Python | 📅 2026-08-14 - A lightweight face recognition and facial attribute analysis (age, gender, emotion and race) framework for Python covering cutting-edge models such as VGG-Face, FaceNet, OpenFace, DeepFace, DeepID, Dlib and ArcFace.
...
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,698 | 🐛 81 | 🌐 Python | 📅 2026-08-17 - A PyTorch-based toolkit that offers pre-trained segmentation models for computer vision tasks. It simplifies the development of image segmentation applications by providing a collection of popular architecture implementations, such as UNet and PSPNet, along with pre-trained weights, making it easier for researchers and developers to achieve high-quality pixel-level object segmentation in images.
* [Exadel CompreFace](https://github.com/exadel-inc/CompreFace) ⭐ 8,256 | 🐛 234 | 🌐 Java | 📅 2024-10-05 - face recognition system that can be easily integrated into any system without prior machine learning skills. CompreFace provides REST API for face recognition, face verification, face detection, face mask detection, landmark detection, age, and gender recognition and is easily deployed with docker.
* [Scikit-Opt](https://github.com/guofei9987/scikit-opt) ⭐ 6,703 | 🐛 72 | 🌐 Python | 📅 2026-03-25 - Swarm Intelligence in Python (Genetic Algorithm, Particle Swarm Optimization, Simulated Annealing, Ant Colony Algorithm, Immune Algorithm, Artificial Fish Swarm Algorithm in Python)
* [Scikit-Image](https://github.com/scikit-image/scikit-image) ⭐ 6,573 | 🐛 938 | 🌐 Python | 📅 2026-08-17 - A collection of algorithms for image processing in Python.
* [pytessarct](https://github.com/madmaze/pytesseract) ⭐ 6,379 | 🐛 21 | 🌐 Python | 📅 2026-07-13 - Python-tesseract is an optical character recognition (OCR) tool for python. That is, it will recognize and "read" the text embedded in images. Python-tesseract is a wrapper for [Google's Tesseract-OCR Engine](https://github.com/tesseract-ocr/tesseract) ⭐ 75,966 | 🐛 484 | 🌐 C++ | 📅 2026-08-17.
...
* [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,794 | 🐛 103 | 🌐 Python | 📅 2026-08-17 - Lightly is a computer vision framework for self-supervised learning.
* [computer-vision-in-action](https://github.com/Charmve/computer-vision-in-action) ⭐ 2,857 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-05-27 - as known as `L0CV`, is a new generation of computer vision open source online learning media, a cross-platform interactive learning framework integrating graphics, source code and HTML. the L0CV ecosystem — Notebook, Datasets, Source Code, and from Diving-in to Advanced — as well as the L0CV Hub.
...
* [LightlyTrain](https://github.com/lightly-ai/lightly-train) ⭐ 1,645 | 🐛 65 | 🌐 Python | 📅 2026-08-14 - Pretrain computer vision models on unlabeled data for industrial applications
...
* [joliGEN](https://github.com/jolibrain/joliGEN) ⭐ 288 | 🐛 39 | 🌐 Python | 📅 2026-08-17 - Generative AI Image Toolset with GANs and Diffusion for Real-World Applications.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,191 | 🐛 2,386 | 🌐 Python | 📅 2026-08-17 - A deep learning library containing thousands of pre-trained models on different tasks. The goto place for anything related to Large Language Models.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 35,117 | 🐛 700 | 🌐 Python | 📅 2024-08-21 - Chinese Words Segmentation Utilities.
* [spaCy](https://github.com/explosion/spaCy) ⭐ 33,826 | 🐛 234 | 🌐 Python | 📅 2026-08-07 - Industrial strength NLP with Python and Cython.
* [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,234 | 🐛 104 | 🌐 Python | 📅 2026-08-17 - A framework for building industrial-strength applications with Transformer models and LLMs.
* [CometLLM](https://github.com/comet-ml/comet-llm) ⭐ 21,430 | 🐛 202 | 🌐 Python | 📅 2026-08-17 - Track, log, visualize and evaluate your LLM prompts and prompt chains.
...
* [DeepPavlov](https://github.com/deepmipt/DeepPavlov/) ⭐ 6,991 | 🐛 57 | 🌐 Python | 📅 2025-08-06 - conversational AI library with many pre-trained Russian NLP models.
...
* [Quepy](https://github.com/machinalis/quepy) ⭐ 1,265 | 🐛 28 | 🌐 Python | 📅 2020-12-29 - A python framework to transform natural language questions to queries in a database query language.
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) ⭐ 1,047 | 🐛 22 | 🌐 Rust | 📅 2026-08-17 - The simplest way to run an LLM locally. Supports tool calling and grammar constrained sampling.
...
* [VeritasGraph](https://github.com/bibinprathap/VeritasGraph) ⭐ 311 | 🐛 2 | 🌐 Python | 📅 2026-08-16 - Enterprise-Grade Graph RAG for Secure, On-Premise AI with Verifiable Attribution.
...
* [python-frog](https://github.com/proycon/python-frog) ⭐ 50 | 🐛 6 | 🌐 Cython | 📅 2026-08-17 - Python binding to Frog, an NLP suite for Dutch. (pos tagging, lemmatisation, dependency parsing, NER)
...
* [python-ucto](https://github.com/proycon/python-ucto) ⭐ 32 | 🐛 6 | 🌐 Cython | 📅 2026-08-17 - Python binding to ucto (a unicode-aware rule-based tokenizer for various languages).
...
* [TensorFlow](https://github.com/tensorflow/tensorflow/) ⭐ 196,986 | 🐛 2,916 | 🌐 C++ | 📅 2026-08-17 - Open source software library for numerical computation using data flow graphs.
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,435 | 🐛 17,365 | 🌐 Python | 📅 2026-08-17 - Tensors and Dynamic neural networks in Python with strong GPU acceleration
* [keras](https://github.com/keras-team/keras) ⭐ 64,234 | 🐛 221 | 🌐 Python | 📅 2026-08-14 - High-level neural networks frontend for [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 196,986 | 🐛 2,916 | 🌐 C++ | 📅 2026-08-17, [CNTK](https://github.com/Microsoft/CNTK) ⚠️ Archived and [Theano](https://github.com/Theano/Theano) ⭐ 9,997 | 🐛 699 | 🌐 Python | 📅 2024-01-15.
* [Streamlit](https://github.com/streamlit/streamlit) ⭐ 45,557 | 🐛 1,200 | 🌐 Python | 📅 2026-08-17: Streamlit is an framework to create beautiful data apps in hours, not weeks.
* [Gradio](https://github.com/gradio-app/gradio) ⭐ 43,376 | 🐛 182 | 🌐 Python | 📅 2026-08-17 - A Python library for quickly creating and sharing demos of models. Debug models interactively in your browser, get feedback from collaborators, and generate public links without deploying anything.
* [Colossal-AI](https://github.com/hpcaitech/ColossalAI) ⭐ 41,437 | 🐛 503 | 🌐 Python | 📅 2026-08-17: An open-source deep learning system for large-scale model training and inference with high efficiency and low cost.
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,597 | 🐛 2 | 🌐 Makefile | 📅 2026-08-13 - Open Source framework to streamline use of neural networks.
* [JAX](https://github.com/google/jax) ⭐ 36,169 | 🐛 2,584 | 🌐 Python | 📅 2026-08-17 - JAX is Autograd and XLA, brought together for high-performance machine learning research.
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,563 | 🐛 1,566 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch) ⭐ 32,483 | 🐛 78 | 🌐 Python | 📅 2023-10-15 - Implementations of Machine Learning models from scratch in Python with a focus on transparency. Aims to showcase the nuts and bolts of ML in an accessible way.
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,290 | 🐛 1,075 | 🌐 Python | 📅 2026-08-09 - The lightweight PyTorch wrapper for high-performance AI research.
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,662 | 🐛 417 | 🌐 C++ | 📅 2026-08-17 - Python bindings for eXtreme Gradient Boosting (Tree) Library.
...
* [Fastai](https://github.com/fastai/fastai) ⭐ 28,117 | 🐛 266 | 🌐 Jupyter Notebook | 📅 2026-08-15 - High-level wrapper built on the top of Pytorch which supports vision, text, tabular data and collaborative filtering.
* [PyTorch Geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,015 | 🐛 1,308 | 🌐 Python | 📅 2026-08-17 -> Graph Neural Network Library for PyTorch.
* [Microsoft Recommenders](https://github.com/Microsoft/Recommenders) ⭐ 21,859 | 🐛 175 | 🌐 Python | 📅 2026-08-17: Examples and best practices for building recommendation systems, provided as Jupyter notebooks. The repo contains some of the latest state of the art algorithms from Microsoft Research as well as from other companies and institutions.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,430 | 🐛 202 | 🌐 Python | 📅 2026-08-17: Evaluate, trace, test, and ship LLM applications across your dev and production lifecycles.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Neural Networks and Deep Learning](https://github.com/mnielsen/neural-networks-and-deep-learning) ⭐ 17,878 | 🐛 8 | 🌐 Python | 📅 2024-06-02 - Code samples for my book "Neural Networks and Deep Learning" \[DEEP LEARNING].
...
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,669 | 🐛 17 | 🌐 Python | 📅 2026-08-17: Optuna is an automatic hyperparameter optimization software framework, particularly designed for machine learning.
* [Annoy](https://github.com/spotify/annoy) ⭐ 14,289 | 🐛 84 | 🌐 C++ | 📅 2025-10-29 - Approximate nearest neighbours implementation.
...
* [Theano](https://github.com/Theano/Theano/) ⭐ 9,997 | 🐛 699 | 🌐 Python | 📅 2024-01-15 - Optimizing GPU-meta-programming code generating array oriented optimizing math compiler in Python.
* [PyOD](https://github.com/yzhao062/pyod) ⭐ 9,969 | 🐛 231 | 🌐 Python | 📅 2026-08-17 -> Python Outlier Detection, comprehensive and scalable Python toolkit for detecting outlying objects in multivariate data. Featured for Advanced models, including Neural Networks/Deep Learning and Outlier Ensembles.
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,939 | 🐛 21 | 🌐 Python | 📅 2026-08-14 - A Python library for secure and private Deep Learning built on PyTorch and TensorFlow.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 9,931 | 🐛 2,404 | 🌐 Python | 📅 2026-08-16 - A unified framework for machine learning with time series
...
* [einops](https://github.com/arogozhnikov/einops) ⭐ 9,574 | 🐛 39 | 🌐 Python | 📅 2026-07-05 - Deep learning operations reinvented (for pytorch, tensorflow, jax and others).
...
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,068 | 🐛 720 | 🌐 C++ | 📅 2026-08-17 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, well documented and supports CPU and GPU (even multi-GPU) computation.
...
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,813 | 🐛 298 | 🌐 Jupyter Notebook | 📅 2026-08-05: Interactive reports to analyze machine learning models during validation or production monitoring.
...
* [ClearML](https://github.com/clearml/clearml) ⭐ 6,826 | 🐛 512 | 🌐 Python | 📅 2026-08-14 -  Auto-Magical CI/CD to streamline your AI workload. Experiment Management, Data Management, Pipeline, Orchestration, Scheduling & Serving in one MLOps/LLMOps solution.
...
* [Aim](https://github.com/aimhubio/aim) ⭐ 6,234 | 🐛 468 | 🌐 Python | 📅 2026-08-16 -> An easy-to-use & supercharged open-source AI metadata tracker.
...
* [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) ⭐ 5,237 | 🐛 177 | 🌐 Scala | 📅 2026-08-17 -> A distributed machine learning framework Apache Spark
...
* [PyBroker](https://github.com/edtechre/pybroker) ⭐ 3,508 | 🐛 8 | 🌐 Python | 📅 2026-08-17 - Algorithmic Trading with Machine Learning.
* [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,381 | 🐛 6 | 🌐 Python | 📅 2026-07-08 - High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing. Being able to research/develop something new, rather than write another regular train loop.
...
* [Pylearn2](https://github.com/lisa-lab/pylearn2) ⭐ 2,767 | 🐛 201 | 🌐 Python | 📅 2021-08-20 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano) ⭐ 9,997 | 🐛 699 | 🌐 Python | 📅 2024-01-15. **\[Deprecated]**
...
* [skrub](https://github.com/skrub-data/skrub) ⭐ 1,648 | 🐛 153 | 🌐 Python | 📅 2026-08-12 - Skrub is a Python library that eases preprocessing and feature engineering for machine learning on dataframes.
...
* [skforecast](https://github.com/skforecast/skforecast) ⭐ 1,525 | 🐛 15 | 🌐 Python | 📅 2026-08-17 - Python library for time series forecasting using machine learning models. It works with any regressor compatible with the scikit-learn API, including popular options like LightGBM, XGBoost, CatBoost, Keras, and many others.
...
* [nilearn](https://github.com/nilearn/nilearn) ⭐ 1,423 | 🐛 288 | 🌐 Python | 📅 2026-08-17 - Machine learning for NeuroImaging in Python.
* [pydeep](https://github.com/andersbll/deeppy) ⭐ 1,370 | 🐛 22 | 🌐 Python | 📅 2020-12-28 - Deep Learning In Python. **\[Deprecated]**
* [Intel(R) Extension for Scikit-learn](https://github.com/intel/scikit-learn-intelex) ⭐ 1,355 | 🐛 82 | 🌐 Python | 📅 2026-08-17 - A seamless way to speed up your Scikit-learn applications with no accuracy loss and code changes.
...
* [SimpleAI](https://github.com/simpleai-team/simpleai) ⭐ 995 | 🐛 14 | 🌐 Python | 📅 2023-11-06 Python implementation of many of the artificial intelligence algorithms described in the book "Artificial Intelligence, a Modern Approach". It focuses on providing an easy to use, well documented and tested library.
...
* [PyTorch Frame](https://github.com/pyg-team/pytorch-frame) ⭐ 798 | 🐛 23 | 🌐 Python | 📅 2026-08-03 -> A Modular Framework for Multi-Modal Tabular Learning.
...
* [Neurolink](https://github.com/juspay/neurolink) ⭐ 121 | 🐛 66 | 🌐 TypeScript | 📅 2026-08-17 - Enterprise-grade LLM integration framework for building production-ready AI applications with built-in hallucination prevention, RAG, and MCP support.
...
* [Leanpass](https://github.com/Terminay/LeanPass) ⭐ 16 | 🐛 16 | 🌐 Python | 📅 2026-08-14 - A lightweight, NumPy-only autodiff library for small ML projects and learning how backpropagation works. It is 700x times lighter than Pytorch and 900x times lighter than TensorFlow.
...
* [Superset](https://github.com/apache/incubator-superset) ⭐ 74,288 | 🐛 611 | 🌐 Python | 📅 2026-08-17 - A data exploration platform designed to be visual, intuitive, and interactive.
* [Dash](https://github.com/plotly/dash) ⭐ 24,373 | 🐛 537 | 🌐 Python | 📅 2026-08-17 - A framework for creating analytical web applications built on top of Plotly.js, React, and Flask
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,429 | 🐛 851 | 🌐 Python | 📅 2026-08-17 - Interactive Web Plotting for Python.
* [zipline](https://github.com/quantopian/zipline) ⭐ 20,043 | 🐛 370 | 🌐 Python | 📅 2024-02-13 - A Pythonic algorithmic trading library.
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,872 | 🐛 5,952 | 🌐 Python | 📅 2026-08-17 - A Python library for symbolic mathematics.
...
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,579 | 🐛 2,828 | 🌐 Python | 📅 2026-08-17 - Statistical modelling and econometrics in Python.
* [altair](https://github.com/altair-viz/altair) ⭐ 10,454 | 🐛 143 | 🌐 Python | 📅 2026-08-16 - A Python to Vega translator.
* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,710 | 🐛 478 | 🌐 Python | 📅 2026-08-16 - Markov Chain Monte Carlo sampling toolkit.
...
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) ⭐ 4,399 | 🐛 516 | 🌐 Python | 📅 2026-08-17 - A pure-python graphics and GUI library built on PyQt4 / PySide and NumPy.
...
* [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) ⭐ 29,302 | 🐛 48 | 🌐 Python | 📅 2024-03-20 - Continually updated Data Science Python Notebooks: Spark, Hadoop MapReduce, HDFS, AWS, Kaggle, scikit-learn, matplotlib, pandas, NumPy, SciPy, and various command lines.
...
* [Pydata book](https://github.com/wesm/pydata-book) ⭐ 24,826 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2025-10-17 - Materials and IPython notebooks for "Python for Data Analysis" by Wes McKinney, published by O'Reilly Media
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,759 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2025-11-23 - Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
* [A gallery of interesting IPython notebooks](https://github.com/jupyter/jupyter/wiki/A-gallery-of-interesting-Jupyter-Notebooks) ⭐ 15,350 | 🐛 45 | 🌐 Python | 📅 2026-07-09
...
* [Introduction to Machine Learning with Python](https://github.com/amueller/introduction_to_ml_with_python) ⭐ 8,147 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2024-03-14 - Notebooks and code for the book "Introduction to Machine Learning with Python"
* [pandas cookbook](https://github.com/jvns/pandas-cookbook) ⭐ 7,106 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-10-24 - Recipes for using Python's pandas library.
* [numpic](https://github.com/numenta/nupic) ⭐ 6,351 | 🐛 465 | 🌐 Python | 📅 2024-12-03
* [pattern\_classification](https://github.com/rasbt/pattern_classification) ⭐ 4,212 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-11-26
...
* [Keras Tuner](https://github.com/keras-team/keras-tuner) ⭐ 2,924 | 🐛 240 | 🌐 Python | 📅 2025-12-01 - An easy-to-use, scalable hyperparameter optimization framework that solves the pain points of hyperparameter search.
...
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,939 | 🐛 21 | 🌐 Python | 📅 2026-08-14 - A Python library for secure and private Deep Learning.
...
* [RLlib](https://github.com/ray-project/ray) ⭐ 43,537 | 🐛 3,506 | 🌐 Python | 📅 2026-08-17 - RLlib is an industry level, highly scalable RL library for tf and torch, based on Ray. It's used by companies like Amazon and Microsoft to solve real-world decision making problems at scale.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 12,332 | 🐛 79 | 🌐 Python | 📅 2026-08-16 - A library for developing and comparing reinforcement learning algorithms (successor of \[gym])(<https://github.com/openai/gym> ⚠️ Archived).
...
* [ViZDoom](https://github.com/mwydmuch/ViZDoom) ⭐ 2,060 | 🐛 39 | 🌐 C++ | 📅 2026-08-13 - ViZDoom allows developing AI bots that play Doom using only the visual information (the screen buffer). It is primarily intended for research in machine visual learning, and deep reinforcement learning, in particular.
* [metaworld](https://github.com/rlworkgroup/metaworld) ⭐ 1,868 | 🐛 11 | 🌐 Python | 📅 2026-08-10 - An open source robotics benchmark for meta- and multi-task reinforcement learning
...
* [candle](https://github.com/huggingface/candle) ⭐ 20,916 | 🐛 880 | 🌐 Rust | 📅 2026-08-15 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use.
...
* [smartcore](https://github.com/smartcorelib/smartcore) ⭐ 948 | 🐛 52 | 🌐 Rust | 📅 2026-08-10 - "The Most Advanced Machine Learning Library In Rust."
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,761 | 🐛 296 | 🌐 Rust | 📅 2026-08-17 - Burn is a new comprehensive dynamic Deep Learning Framework built using Rust with extreme flexibility, compute efficiency and portability as its primary goals
...
* [huggingface/tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,974 | 🐛 257 | 🌐 Rust | 📅 2026-08-17 - Fast State-of-the-Art Tokenizers optimized for Research and Production
* [shimmy](https://github.com/Michael-A-Kuykendall/shimmy) ⭐ 5,756 | 🐛 12 | 🌐 Rust | 📅 2026-08-06 - Python-free Rust inference server for NLP models with OpenAI API compatibility and hot model swapping.
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,068 | 🐛 720 | 🌐 C++ | 📅 2026-08-17 - General purpose gradient boosting on decision trees library with categorical features support out of the box for R.
...
* [milvus](https://milvus.io) – Milvus is [open source](https://github.com/milvus-io/milvus) ⭐ 45,666 | 🐛 1,281 | 🌐 Go | 📅 2026-08-17 vector database for production AI, written in Go and C++, scalable and blazing fast for billions of embedding vectors.
* [Qdrant](https://qdrant.tech) – Qdrant is [open source](https://github.com/qdrant/qdrant) ⭐ 34,029 | 🐛 705 | 🌐 Rust | 📅 2026-08-17 vector similarity search engine with extended filtering support, written in Rust.
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,314 | 🐛 513 | 🌐 TypeScript | 📅 2026-08-17 - Open-source LLM evaluation and red teaming framework. Test prompts, models, agents, and RAG pipelines. Run adversarial attacks (jailbreaks, prompt injection) and integrate security testing into CI/CD.
* [Weaviate](https://www.semi.technology/developers/weaviate/current/) – Weaviate is an [open source](https://github.com/semi-technologies/weaviate) ⭐ 16,734 | 🐛 693 | 🌐 Go | 📅 2026-08-17 vector search engine and vector database. Weaviate uses machine learning to vectorize and store data, and to find answers to natural language queries. With Weaviate you can also bring your custom ML models to production scale.
* [DVC](https://github.com/iterative/dvc) ⭐ 15,823 | 🐛 198 | 🌐 Python | 📅 2026-08-17 - Data Science Version Control is an open-source version control system for machine learning projects with pipelines support. It makes ML projects reproducible and shareable.
* [txtai](https://github.com/neuml/txtai) ⭐ 12,895 | 🐛 11 | 🌐 Python | 📅 2026-08-12 - Build semantic search applications and workflows.
* [Kedro](https://github.com/quantumblacklabs/kedro/) ⭐ 10,955 | 🐛 151 | 🌐 Python | 📅 2026-08-17 - Kedro is a data and development workflow framework that implements best practices for data pipelines with an eye towards productionizing machine learning models.
* [RunAnywhere](https://github.com/RunanywhereAI/runanywhere-sdks) ⭐ 10,294 | 🐛 19 | 🌐 C++ | 📅 2026-08-17 - Open-source SDK for running LLMs and multimodal models on-device across iOS, Android, and cross-platform apps.
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 8,907 | 🐛 52 | 🌐 Python | 📅 2026-08-17 - Production-ready Multi-AI Agents framework with self-reflection. Fastest agent instantiation (3.77μs), 100+ LLM support via LiteLLM, MCP integration, agentic workflows (route/parallel/loop/repeat), built-in memory, Python & JS SDKs.
* [Infinity](https://github.com/infiniflow/infinity) ⭐ 4,673 | 🐛 63 | 🌐 C++ | 📅 2026-08-17 - The AI-native database built for LLM applications, providing incredibly fast vector and full-text search. Developed using C++20
...
* More tools to improve the ML lifecycle: [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,381 | 🐛 6 | 🌐 Python | 📅 2026-07-08, [PachydermIO](https://www.pachyderm.io/). The following are GitHub-alike and targeting teams [Weights & Biases](https://www.wandb.com/), [Neptune.ai](https://neptune.ai/), [Comet.ml](https://www.comet.ml/), [Valohai.ai](https://valohai.com/), [DAGsHub](https://DAGsHub.com/).
...
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,567 | 🐛 151 | 🌐 Jupyter Notebook | 📅 2026-08-17 - a lightweight library to define data transformations as a directed-acyclic graph (DAG). It helps author reliable feature engineering and machine learning pipelines, and more.
* [Agentfield](https://github.com/Agent-Field/agentfield) ⭐ 2,520 | 🐛 60 | 🌐 Go | 📅 2026-08-17 - Open source Kubernetes-style control plane for deploying AI agents as distributed microservices, with built-in service discovery, durable workflows, and observability.
...
* [Awesome RAG Production](https://github.com/Yigtwxx/Awesome-RAG-Production) ⭐ 198 | 🐛 6 | 🌐 Python | 📅 2026-08-07 - A curated collection of battle-tested tools, frameworks, and best practices for building, scaling, and monitoring production-grade Retrieval-Augmented Generation (RAG) systems. Covers frameworks, vector databases, retrieval & reranking, evaluation, observability, deployment, and security.
...
* [HyperAgency](https://github.com/vuics/h9y) ⭐ 36 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-17 - agentic AI operating system (h9y.ai) that replaces brittle/fragmented automations with long-lived, self-improving systems. Open-source, self-hosted/cloud, visual workflow, omni-channel, decentralized, extensible.
...
* Some of the python libraries were cut-and-pasted from [vinta](https://github.com/vinta/awesome-python) ⭐ 314,473 | 🐛 16 | 🌐 Python | 📅 2026-08-16
